...
<html>
	<head>
		...
		<title>WILD MX® | Competiciones</title>
	...
	<body>
		...
		<header>
			<nav>
				...
				<a href="#" id="seleccionado">COMPETICIONES</a>
		...
		<img src="imagenes/banner/motocross4.jpg" alt="Motocross" id="banner"/>
		<div id="div_tiempo">
            <table id="tiempo">
                <?php
                    $doc = new DOMDocument();
		...
		<div id="principal">
			<div id="div_productos">
				<h1>Competiciones</h1>
				<p class="p">
					En el mundo del motocross hay muchas competiciones, profesionales, semiprofesionales, 
					amateurs... Pero aquí destacamos las 3, a nuestro parecer más importantes:
				</p>
					<ul>
						<li>Campeonato Mundial de Motocross</li>
						<li>AMA Supercross Championship</li>
						<li>Freestyle</li>
					</ul>
				<a href="cmm.html" class="productos">
					<div>
						<img src="imagenes/productos/logos/cmm.jpg" alt="CMM"/>
						<p>CMM</p>
					</div>
				</a>
				<a href="ama.html" class="productos">
					<div>
						<img src="imagenes/productos/logos/ama.jpg" alt="AMA"/>
						<p>AMA</p>
					</div>
				</a>
				<a href="freestyle.html" class="productos">
					<div>
						<img src="imagenes/productos/logos/freestyle.jpg" alt="Freestyle"/>
						<p>FREESTYLE</p>
					</div>
				</a>
			</div>
