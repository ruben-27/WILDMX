<?php
    ...
    $datos = $doc->getElementsByTagName("beta1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | BETA RR 125 2T 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $beta1 )
                    {
                        $titulo = $beta1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $beta1 )
                            {
                                $portada = $beta1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $beta1 )
                                        {
                                            $precio = $beta1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $beta1 )
                                        {
                                            $valoracion = $beta1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/beta/rr-125-2t-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $beta1 )
                                {
                                    $imagenpr1 = $beta1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $beta1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $beta1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta1 )
                                {
                                    $imagenpr2 = $beta1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $beta1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $beta1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta1 )
                                {
                                    $imagenpr3 = $beta1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $beta1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $beta1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta1 )
                                {
                                    $imagenpr4 = $beta1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $beta1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $beta1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $beta1 )
                            {
                                $descripcion = $beta1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
