<?php
    ...
    $datos = $doc->getElementsByTagName("beta2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | BETA RR 50 2018</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $beta2 )
                    {
                        $titulo = $beta2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $beta2 )
                            {
                                $portada = $beta2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $beta2 )
                                        {
                                            $precio = $beta2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $beta2 )
                                        {
                                            $valoracion = $beta2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/beta/rr-50-enduro-sport-racing-2018" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $beta2 )
                                {
                                    $imagenpr1 = $beta2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $beta2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $beta2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta2 )
                                {
                                    $imagenpr2 = $beta2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $beta2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $beta2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta2 )
                                {
                                    $imagenpr3 = $beta2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $beta2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $beta2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta2 )
                                {
                                    $imagenpr4 = $beta2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $beta2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $beta2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $beta2 )
                            {
                                $descripcion = $beta2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
