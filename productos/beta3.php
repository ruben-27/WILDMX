<?php
    ...
    $datos = $doc->getElementsByTagName("beta3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | BETA RR 125 4T LC 2018</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $beta3 )
                    {
                        $titulo = $beta3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $beta3 )
                            {
                                $portada = $beta3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $beta3 )
                                        {
                                            $precio = $beta3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $beta3 )
                                        {
                                            $valoracion = $beta3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/beta/rr-125-4t-lc-2017" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $beta3 )
                                {
                                    $imagenpr1 = $beta3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $beta3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $beta3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta3 )
                                {
                                    $imagenpr2 = $beta3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $beta3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $beta3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta3 )
                                {
                                    $imagenpr3 = $beta3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $beta3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $beta3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta3 )
                                {
                                    $imagenpr4 = $beta3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $beta3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $beta3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $beta3 )
                            {
                                $descripcion = $beta3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
