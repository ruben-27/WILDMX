<?php
    ...
    $datos = $doc->getElementsByTagName("beta4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | BETA RR 125 SM LC 4T 2018</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $beta4 )
                    {
                        $titulo = $beta4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $beta4 )
                            {
                                $portada = $beta4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $beta4 )
                                        {
                                            $precio = $beta4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $beta4 )
                                        {
                                            $valoracion = $beta4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/beta/rr-125-sm-lc-4t-2017" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $beta4 )
                                {
                                    $imagenpr1 = $beta4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $beta4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $beta4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta4 )
                                {
                                    $imagenpr2 = $beta4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $beta4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $beta4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta4 )
                                {
                                    $imagenpr3 = $beta4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $beta4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $beta4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta4 )
                                {
                                    $imagenpr4 = $beta4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $beta4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $beta4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $beta4 )
                            {
                                $descripcion = $beta4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
