<?php
    ...
    $datos = $doc->getElementsByTagName("beta5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | BETA XTRAINER 2018-2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $beta5 )
                    {
                        $titulo = $beta5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $beta5 )
                            {
                                $portada = $beta5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $beta5 )
                                        {
                                            $precio = $beta5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $beta5 )
                                        {
                                            $valoracion = $beta5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/beta/xtrainer-2018" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $beta5 )
                                {
                                    $imagenpr1 = $beta5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $beta5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $beta5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta5 )
                                {
                                    $imagenpr2 = $beta5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $beta5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $beta5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta5 )
                                {
                                    $imagenpr3 = $beta5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $beta5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $beta5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $beta5 )
                                {
                                    $imagenpr4 = $beta5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $beta5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $beta5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $beta5 )
                            {
                                $descripcion = $beta5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
