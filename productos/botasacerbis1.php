<?php
    ...
    $datos = $doc->getElementsByTagName("botasacerbis1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS X-PRO BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasacerbis1 )
                    {
                        $titulo = $botasacerbis1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasacerbis1 )
                            {
                                $portada = $botasacerbis1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasacerbis1 )
                                        {
                                            $precio = $botasacerbis1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasacerbis1 )
                                        {
                                            $valoracion = $botasacerbis1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/394293-botas-acerbis-x-pro-v-color-blanco-0021596030.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis1 )
                                {
                                    $imagenpr1 = $botasacerbis1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasacerbis1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasacerbis1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis1 )
                                {
                                    $imagenpr2 = $botasacerbis1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasacerbis1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasacerbis1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis1 )
                                {
                                    $imagenpr3 = $botasacerbis1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasacerbis1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasacerbis1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis1 )
                                {
                                    $imagenpr4 = $botasacerbis1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasacerbis1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasacerbis1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasacerbis1 )
                            {
                                $descripcion = $botasacerbis1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
