<?php
    ...
    $datos = $doc->getElementsByTagName("botasacerbis2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS X-PRO VERDE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasacerbis2 )
                    {
                        $titulo = $botasacerbis2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasacerbis2 )
                            {
                                $portada = $botasacerbis2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasacerbis2 )
                                        {
                                            $precio = $botasacerbis2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasacerbis2 )
                                        {
                                            $valoracion = $botasacerbis2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/394295-botas-acerbis-x-pro-v-color-rojo-verde-0021596379.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis2 )
                                {
                                    $imagenpr1 = $botasacerbis2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasacerbis2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasacerbis2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis2 )
                                {
                                    $imagenpr2 = $botasacerbis2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasacerbis2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasacerbis2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis2 )
                                {
                                    $imagenpr3 = $botasacerbis2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasacerbis2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasacerbis2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis2 )
                                {
                                    $imagenpr4 = $botasacerbis2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasacerbis2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasacerbis2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasacerbis2 )
                            {
                                $descripcion = $botasacerbis2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
