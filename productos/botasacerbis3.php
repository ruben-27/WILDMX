<?php
    ...
    $datos = $doc->getElementsByTagName("botasacerbis3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS X-PRO ROJO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasacerbis3 )
                    {
                        $titulo = $botasacerbis3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasacerbis3 )
                            {
                                $portada = $botasacerbis3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasacerbis3 )
                                        {
                                            $precio = $botasacerbis3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasacerbis3 )
                                        {
                                            $valoracion = $botasacerbis3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/394291-botas-acerbis-x-pro-v-color-rojo-0021596110.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis3 )
                                {
                                    $imagenpr1 = $botasacerbis3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasacerbis3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasacerbis3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis3 )
                                {
                                    $imagenpr2 = $botasacerbis3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasacerbis3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasacerbis3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis3 )
                                {
                                    $imagenpr3 = $botasacerbis3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasacerbis3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasacerbis3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis3 )
                                {
                                    $imagenpr4 = $botasacerbis3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasacerbis3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasacerbis3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasacerbis3 )
                            {
                                $descripcion = $botasacerbis3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
