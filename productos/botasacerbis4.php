<?php
    ...
    $datos = $doc->getElementsByTagName("botasacerbis4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS X-MOVE AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasacerbis4 )
                    {
                        $titulo = $botasacerbis4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasacerbis4 )
                            {
                                $portada = $botasacerbis4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasacerbis4 )
                                        {
                                            $precio = $botasacerbis4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasacerbis4 )
                                        {
                                            $valoracion = $botasacerbis4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/394289-botas-acerbis-x-move-20-color-azul-fluor-0017719274.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis4 )
                                {
                                    $imagenpr1 = $botasacerbis4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasacerbis4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasacerbis4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis4 )
                                {
                                    $imagenpr2 = $botasacerbis4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasacerbis4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasacerbis4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis4 )
                                {
                                    $imagenpr3 = $botasacerbis4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasacerbis4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasacerbis4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis4 )
                                {
                                    $imagenpr4 = $botasacerbis4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasacerbis4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasacerbis4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasacerbis4 )
                            {
                                $descripcion = $botasacerbis4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
