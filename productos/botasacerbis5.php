<?php
    ...
    $datos = $doc->getElementsByTagName("botasacerbis5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS X-MOVE NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasacerbis5 )
                    {
                        $titulo = $botasacerbis5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasacerbis5 )
                            {
                                $portada = $botasacerbis5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasacerbis5 )
                                        {
                                            $precio = $botasacerbis5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasacerbis5 )
                                        {
                                            $valoracion = $botasacerbis5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/394287-botas-acerbis-x-move-20-color-naranja-0017719010.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis5 )
                                {
                                    $imagenpr1 = $botasacerbis5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasacerbis5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasacerbis5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis5 )
                                {
                                    $imagenpr2 = $botasacerbis5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasacerbis5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasacerbis5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis5 )
                                {
                                    $imagenpr3 = $botasacerbis5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasacerbis5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasacerbis5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasacerbis5 )
                                {
                                    $imagenpr4 = $botasacerbis5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasacerbis5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasacerbis5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasacerbis5 )
                            {
                                $descripcion = $botasacerbis5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
