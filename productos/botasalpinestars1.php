<?php
    ...
    $datos = $doc->getElementsByTagName("botasalpinestars1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasalpinestars1 )
                    {
                        $titulo = $botasalpinestars1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasalpinestars1 )
                            {
                                $portada = $botasalpinestars1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasalpinestars1 )
                                        {
                                            $precio = $botasalpinestars1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasalpinestars1 )
                                        {
                                            $valoracion = $botasalpinestars1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/198229-botas-alpinestars-tech-5-blancas-198229.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars1 )
                                {
                                    $imagenpr1 = $botasalpinestars1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasalpinestars1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasalpinestars1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars1 )
                                {
                                    $imagenpr2 = $botasalpinestars1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasalpinestars1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasalpinestars1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars1 )
                                {
                                    $imagenpr3 = $botasalpinestars1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasalpinestars1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasalpinestars1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars1 )
                                {
                                    $imagenpr4 = $botasalpinestars1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasalpinestars1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasalpinestars1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasalpinestars1 )
                            {
                                $descripcion = $botasalpinestars1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
