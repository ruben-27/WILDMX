<?php
    ...
    $datos = $doc->getElementsByTagName("botasalpinestars2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS TECH 5 NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasalpinestars2 )
                    {
                        $titulo = $botasalpinestars2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasalpinestars2 )
                            {
                                $portada = $botasalpinestars2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasalpinestars2 )
                                        {
                                            $precio = $botasalpinestars2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasalpinestars2 )
                                        {
                                            $valoracion = $botasalpinestars2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/198215-botas-alpinestars-tech-5-2020-color-negro-198215.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars2 )
                                {
                                    $imagenpr1 = $botasalpinestars2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasalpinestars2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasalpinestars2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars2 )
                                {
                                    $imagenpr2 = $botasalpinestars2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasalpinestars2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasalpinestars2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars2 )
                                {
                                    $imagenpr3 = $botasalpinestars2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasalpinestars2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasalpinestars2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars2 )
                                {
                                    $imagenpr4 = $botasalpinestars2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasalpinestars2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasalpinestars2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasalpinestars2 )
                            {
                                $descripcion = $botasalpinestars2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
