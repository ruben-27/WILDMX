<?php
    ...
    $datos = $doc->getElementsByTagName("botasalpinestars3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS TECH 5 ROJO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasalpinestars3 )
                    {
                        $titulo = $botasalpinestars3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasalpinestars3 )
                            {
                                $portada = $botasalpinestars3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasalpinestars3 )
                                        {
                                            $precio = $botasalpinestars3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasalpinestars3 )
                                        {
                                            $valoracion = $botasalpinestars3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/373081-botas-alpinestars-tech-5-2020-color-rojo-fluor-azul-blanco-alp34102069.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars3 )
                                {
                                    $imagenpr1 = $botasalpinestars3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasalpinestars3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasalpinestars3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars3 )
                                {
                                    $imagenpr2 = $botasalpinestars3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasalpinestars3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasalpinestars3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars3 )
                                {
                                    $imagenpr3 = $botasalpinestars3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasalpinestars3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasalpinestars3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars3 )
                                {
                                    $imagenpr4 = $botasalpinestars3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasalpinestars3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasalpinestars3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasalpinestars3 )
                            {
                                $descripcion = $botasalpinestars3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
