<?php
    ...
    $datos = $doc->getElementsByTagName("botasalpinestars4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS TECH 5 BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasalpinestars4 )
                    {
                        $titulo = $botasalpinestars4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasalpinestars4 )
                            {
                                $portada = $botasalpinestars4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasalpinestars4 )
                                        {
                                            $precio = $botasalpinestars4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasalpinestars4 )
                                        {
                                            $valoracion = $botasalpinestars4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/386082-botas-alpinestars-tech-5-2020-color-blanco-negro-naranja-fluor-alp34102393.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars4 )
                                {
                                    $imagenpr1 = $botasalpinestars4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasalpinestars4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasalpinestars4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars4 )
                                {
                                    $imagenpr2 = $botasalpinestars4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasalpinestars4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasalpinestars4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars4 )
                                {
                                    $imagenpr3 = $botasalpinestars4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasalpinestars4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasalpinestars4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars4 )
                                {
                                    $imagenpr4 = $botasalpinestars4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasalpinestars4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasalpinestars4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasalpinestars4 )
                            {
                                $descripcion = $botasalpinestars4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
