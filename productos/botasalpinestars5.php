<?php
    ...
    $datos = $doc->getElementsByTagName("botasalpinestars5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS TECH 7 NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasalpinestars5 )
                    {
                        $titulo = $botasalpinestars5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasalpinestars5 )
                            {
                                $portada = $botasalpinestars5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasalpinestars5 )
                                        {
                                            $precio = $botasalpinestars5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasalpinestars5 )
                                        {
                                            $valoracion = $botasalpinestars5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/198196-botas-alpinestars-tech-7-negras-rojas-amarillas-198196.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars5 )
                                {
                                    $imagenpr1 = $botasalpinestars5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasalpinestars5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasalpinestars5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars5 )
                                {
                                    $imagenpr2 = $botasalpinestars5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasalpinestars5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasalpinestars5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars5 )
                                {
                                    $imagenpr3 = $botasalpinestars5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasalpinestars5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasalpinestars5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasalpinestars5 )
                                {
                                    $imagenpr4 = $botasalpinestars5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasalpinestars5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasalpinestars5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasalpinestars5 )
                            {
                                $descripcion = $botasalpinestars5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
