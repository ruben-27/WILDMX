<?php
    ...
    $datos = $doc->getElementsByTagName("botasfox1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX COMP 5</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasfox1 )
                    {
                        $titulo = $botasfox1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasfox1 )
                            {
                                $portada = $botasfox1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasfox1 )
                                        {
                                            $precio = $botasfox1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasfox1 )
                                        {
                                            $valoracion = $botasfox1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/393708-outlet-botas-fox-comp-5-2019-negro-rosa-talla-11-usa-16450-285-11.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasfox1 )
                                {
                                    $imagenpr1 = $botasfox1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasfox1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasfox1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox1 )
                                {
                                    $imagenpr2 = $botasfox1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasfox1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasfox1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox1 )
                                {
                                    $imagenpr3 = $botasfox1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasfox1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasfox1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox1 )
                                {
                                    $imagenpr4 = $botasfox1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasfox1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasfox1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasfox1 )
                            {
                                $descripcion = $botasfox1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
