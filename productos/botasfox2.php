<?php
    ...
    $datos = $doc->getElementsByTagName("botasfox2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX INSTINCT AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasfox2 )
                    {
                        $titulo = $botasfox2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasfox2 )
                            {
                                $portada = $botasfox2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasfox2 )
                                        {
                                            $precio = $botasfox2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasfox2 )
                                        {
                                            $valoracion = $botasfox2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/380592-botas-fox-instinct-2020-color-amarillo-fluor-24448-130.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasfox2 )
                                {
                                    $imagenpr1 = $botasfox2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasfox2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasfox2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox2 )
                                {
                                    $imagenpr2 = $botasfox2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasfox2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasfox2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox2 )
                                {
                                    $imagenpr3 = $botasfox2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasfox2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasfox2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox2 )
                                {
                                    $imagenpr4 = $botasfox2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasfox2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasfox2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasfox2 )
                            {
                                $descripcion = $botasfox2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
