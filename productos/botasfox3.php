<?php
    ...
    $datos = $doc->getElementsByTagName("botasfox3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX INSTINCT NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasfox3 )
                    {
                        $titulo = $botasfox3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasfox3 )
                            {
                                $portada = $botasfox3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasfox3 )
                                        {
                                            $precio = $botasfox3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasfox3 )
                                        {
                                            $valoracion = $botasfox3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/380593-botas-fox-instinct-2020-color-naranja-fluor-24448-824.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasfox3 )
                                {
                                    $imagenpr1 = $botasfox3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasfox3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasfox3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox3 )
                                {
                                    $imagenpr2 = $botasfox3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasfox3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasfox3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox3 )
                                {
                                    $imagenpr3 = $botasfox3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasfox3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasfox3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox3 )
                                {
                                    $imagenpr4 = $botasfox3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasfox3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasfox3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasfox3 )
                            {
                                $descripcion = $botasfox3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
