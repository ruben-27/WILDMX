<?php
    ...
    $datos = $doc->getElementsByTagName("botasfox4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX INSTINCT AZUL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasfox4 )
                    {
                        $titulo = $botasfox4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasfox4 )
                            {
                                $portada = $botasfox4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasfox4 )
                                        {
                                            $precio = $botasfox4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasfox4 )
                                        {
                                            $valoracion = $botasfox4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/274463-botas-fox-instinct-off-road-color-azul-17802-002.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasfox4 )
                                {
                                    $imagenpr1 = $botasfox4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasfox4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasfox4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox4 )
                                {
                                    $imagenpr2 = $botasfox4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasfox4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasfox4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox4 )
                                {
                                    $imagenpr3 = $botasfox4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasfox4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasfox4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox4 )
                                {
                                    $imagenpr4 = $botasfox4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasfox4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasfox4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasfox4 )
                            {
                                $descripcion = $botasfox4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
