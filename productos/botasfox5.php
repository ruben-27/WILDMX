<?php
    ...
    $datos = $doc->getElementsByTagName("botasfox5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX COMP R</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasfox5 )
                    {
                        $titulo = $botasfox5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasfox5 )
                            {
                                $portada = $botasfox5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasfox5 )
                                        {
                                            $precio = $botasfox5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasfox5 )
                                        {
                                            $valoracion = $botasfox5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/380518-botas-fox-comp-r-2020-color-azul-rojo-24011-149.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasfox5 )
                                {
                                    $imagenpr1 = $botasfox5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasfox5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasfox5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox5 )
                                {
                                    $imagenpr2 = $botasfox5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasfox5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasfox5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox5 )
                                {
                                    $imagenpr3 = $botasfox5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasfox5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasfox5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasfox5 )
                                {
                                    $imagenpr4 = $botasfox5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasfox5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasfox5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasfox5 )
                            {
                                $descripcion = $botasfox5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
