<?php
    ...
    $datos = $doc->getElementsByTagName("botasgaerne1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAERNE SG-12 AQUA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasgaerne1 )
                    {
                        $titulo = $botasgaerne1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasgaerne1 )
                            {
                                $portada = $botasgaerne1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasgaerne1 )
                                        {
                                            $precio = $botasgaerne1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasgaerne1 )
                                        {
                                            $valoracion = $botasgaerne1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/376392-botas-gaerne-sg-12-edicion-limitada-agua-negro-2174-075.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne1 )
                                {
                                    $imagenpr1 = $botasgaerne1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasgaerne1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasgaerne1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne1 )
                                {
                                    $imagenpr2 = $botasgaerne1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasgaerne1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasgaerne1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne1 )
                                {
                                    $imagenpr3 = $botasgaerne1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasgaerne1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasgaerne1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne1 )
                                {
                                    $imagenpr4 = $botasgaerne1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasgaerne1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasgaerne1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasgaerne1 )
                            {
                                $descripcion = $botasgaerne1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
