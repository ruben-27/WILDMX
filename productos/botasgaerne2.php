<?php
    ...
    $datos = $doc->getElementsByTagName("botasgaerne2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAERNE SG-12 BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasgaerne2 )
                    {
                        $titulo = $botasgaerne2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasgaerne2 )
                            {
                                $portada = $botasgaerne2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasgaerne2 )
                                        {
                                            $precio = $botasgaerne2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasgaerne2 )
                                        {
                                            $valoracion = $botasgaerne2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/366240-botas-gaerne-sg12-blancorojonegro-2174-053.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne2 )
                                {
                                    $imagenpr1 = $botasgaerne2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasgaerne2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasgaerne2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne2 )
                                {
                                    $imagenpr2 = $botasgaerne2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasgaerne2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasgaerne2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne2 )
                                {
                                    $imagenpr3 = $botasgaerne2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasgaerne2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasgaerne2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne2 )
                                {
                                    $imagenpr4 = $botasgaerne2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasgaerne2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasgaerne2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasgaerne2 )
                            {
                                $descripcion = $botasgaerne2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
