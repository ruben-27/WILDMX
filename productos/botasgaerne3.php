<?php
    ...
    $datos = $doc->getElementsByTagName("botasgaerne3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAERNE SG-12 NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasgaerne3 )
                    {
                        $titulo = $botasgaerne3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasgaerne3 )
                            {
                                $portada = $botasgaerne3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasgaerne3 )
                                        {
                                            $precio = $botasgaerne3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasgaerne3 )
                                        {
                                            $valoracion = $botasgaerne3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/373471-botas-gaerne-sg-12-naranjanegrablanca-2174-078.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne3 )
                                {
                                    $imagenpr1 = $botasgaerne3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasgaerne3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasgaerne3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne3 )
                                {
                                    $imagenpr2 = $botasgaerne3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasgaerne3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasgaerne3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne3 )
                                {
                                    $imagenpr3 = $botasgaerne3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasgaerne3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasgaerne3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne3 )
                                {
                                    $imagenpr4 = $botasgaerne3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasgaerne3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasgaerne3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasgaerne3 )
                            {
                                $descripcion = $botasgaerne3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
