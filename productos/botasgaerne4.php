<?php
    ...
    $datos = $doc->getElementsByTagName("botasgaerne4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAERNE SG-12 ROJO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasgaerne4 )
                    {
                        $titulo = $botasgaerne4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasgaerne4 )
                            {
                                $portada = $botasgaerne4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasgaerne4 )
                                        {
                                            $precio = $botasgaerne4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasgaerne4 )
                                        {
                                            $valoracion = $botasgaerne4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/389823-botas-gaerne-sg-12-rojo-2174-085.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne4 )
                                {
                                    $imagenpr1 = $botasgaerne4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasgaerne4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasgaerne4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne4 )
                                {
                                    $imagenpr2 = $botasgaerne4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasgaerne4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasgaerne4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne4 )
                                {
                                    $imagenpr3 = $botasgaerne4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasgaerne4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasgaerne4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne4 )
                                {
                                    $imagenpr4 = $botasgaerne4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasgaerne4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasgaerne4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasgaerne4 )
                            {
                                $descripcion = $botasgaerne4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
