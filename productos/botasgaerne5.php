<?php
    ...
    $datos = $doc->getElementsByTagName("botasgaerne5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAERNE SG-12 AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasgaerne5 )
                    {
                        $titulo = $botasgaerne5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasgaerne5 )
                            {
                                $portada = $botasgaerne5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasgaerne5 )
                                        {
                                            $precio = $botasgaerne5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasgaerne5 )
                                        {
                                            $valoracion = $botasgaerne5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/274231-botas-gaerne-sg12-blancogrisamarillo-flour-2174-051.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne5 )
                                {
                                    $imagenpr1 = $botasgaerne5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasgaerne5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasgaerne5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne5 )
                                {
                                    $imagenpr2 = $botasgaerne5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasgaerne5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasgaerne5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne5 )
                                {
                                    $imagenpr3 = $botasgaerne5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasgaerne5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasgaerne5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasgaerne5 )
                                {
                                    $imagenpr4 = $botasgaerne5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasgaerne5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasgaerne5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasgaerne5 )
                            {
                                $descripcion = $botasgaerne5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
