<?php
    ...
    $datos3 = $doc->getElementsByTagName("botasshotracegear1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT X10 2.0 BLANCAS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $botasshotracegear1 )
                    {
                        $titulo = $botasshotracegear1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $botasshotracegear1 )
                            {
                                $portada = $botasshotracegear1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $botasshotracegear1 )
                                        {
                                            $precio = $botasshotracegear1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $botasshotracegear1 )
                                        {
                                            $valoracion = $botasshotracegear1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/botas-de-cross--trial_c312/botas-de-cross_c313/botas-de-cross-shot-x10-20-blancas_pid-PM-4905224" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear1 )
                                {
                                    $imagenpr1 = $botasshotracegear1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasshotracegear1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasshotracegear1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear1 )
                                {
                                    $imagenpr2 = $botasshotracegear1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasshotracegear1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasshotracegear1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear1 )
                                {
                                    $imagenpr3 = $botasshotracegear1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasshotracegear1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasshotracegear1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear1 )
                                {
                                    $imagenpr4 = $botasshotracegear1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasshotracegear1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasshotracegear1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $botasshotracegear1 )
                            {
                                $descripcion = $botasshotracegear1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
