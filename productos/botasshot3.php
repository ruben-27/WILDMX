<?php
    ...
    $datos3 = $doc->getElementsByTagName("botasshotracegear3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT X10 2.0 AZUL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $botasshotracegear3 )
                    {
                        $titulo = $botasshotracegear3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $botasshotracegear3 )
                            {
                                $portada = $botasshotracegear3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $botasshotracegear3 )
                                        {
                                            $precio = $botasshotracegear3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $botasshotracegear3 )
                                        {
                                            $valoracion = $botasshotracegear3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/botas-de-cross--trial_c312/botas-de-cross_c313/botas-de-cross-shot-x10-20-negro-azul_pid-PM-4910887" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear3 )
                                {
                                    $imagenpr1 = $botasshotracegear3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasshotracegear3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasshotracegear3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear3 )
                                {
                                    $imagenpr2 = $botasshotracegear3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasshotracegear3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasshotracegear3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear3 )
                                {
                                    $imagenpr3 = $botasshotracegear3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasshotracegear3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasshotracegear3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear3 )
                                {
                                    $imagenpr4 = $botasshotracegear3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasshotracegear3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasshotracegear3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $botasshotracegear3 )
                            {
                                $descripcion = $botasshotracegear3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
