<?php
    ...
    $datos3 = $doc->getElementsByTagName("botasshotracegear4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT ATV 2.0 NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $botasshotracegear4 )
                    {
                        $titulo = $botasshotracegear4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $botasshotracegear4 )
                            {
                                $portada = $botasshotracegear4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $botasshotracegear4 )
                                        {
                                            $precio = $botasshotracegear4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $botasshotracegear4 )
                                        {
                                            $valoracion = $botasshotracegear4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/botas-de-cross--trial_c312/botas-de-cross_c313/botas-de-cross-shot-atv-20-negras_pid-PM-4910904" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear4 )
                                {
                                    $imagenpr1 = $botasshotracegear4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasshotracegear4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasshotracegear4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear4 )
                                {
                                    $imagenpr2 = $botasshotracegear4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasshotracegear4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasshotracegear4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear4 )
                                {
                                    $imagenpr3 = $botasshotracegear4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasshotracegear4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasshotracegear4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear4 )
                                {
                                    $imagenpr4 = $botasshotracegear4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasshotracegear4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasshotracegear4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $botasshotracegear4 )
                            {
                                $descripcion = $botasshotracegear4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
