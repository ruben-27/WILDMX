<?php
    ...
    $datos3 = $doc->getElementsByTagName("botasshotracegear5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT K10 2.0 NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $botasshotracegear5 )
                    {
                        $titulo = $botasshotracegear5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $botasshotracegear5 )
                            {
                                $portada = $botasshotracegear5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $botasshotracegear5 )
                                        {
                                            $precio = $botasshotracegear5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $botasshotracegear5 )
                                        {
                                            $valoracion = $botasshotracegear5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/botas-de-cross-nino_c314/botas-de-cross-shot-k10-20-nino-negro-blanco-amarillo-fluo_pid-PM-4910864" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear5 )
                                {
                                    $imagenpr1 = $botasshotracegear5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasshotracegear5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasshotracegear5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear5 )
                                {
                                    $imagenpr2 = $botasshotracegear5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasshotracegear5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasshotracegear5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear5 )
                                {
                                    $imagenpr3 = $botasshotracegear5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasshotracegear5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasshotracegear5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $botasshotracegear5 )
                                {
                                    $imagenpr4 = $botasshotracegear5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasshotracegear5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasshotracegear5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $botasshotracegear5 )
                            {
                                $descripcion = $botasshotracegear5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
