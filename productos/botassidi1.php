<?php
    ...
    $datos = $doc->getElementsByTagName("botassidi1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SIDI CROSSFIRE 3 SRS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botassidi1 )
                    {
                        $titulo = $botassidi1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botassidi1 )
                            {
                                $portada = $botassidi1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botassidi1 )
                                        {
                                            $precio = $botassidi1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botassidi1 )
                                        {
                                            $valoracion = $botassidi1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/387310-botas-sidi-crossfire-3-srs-edicion-limitada-prado-61-naranja-fluor-negro-bosof61000x.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botassidi1 )
                                {
                                    $imagenpr1 = $botassidi1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botassidi1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botassidi1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi1 )
                                {
                                    $imagenpr2 = $botassidi1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botassidi1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botassidi1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi1 )
                                {
                                    $imagenpr3 = $botassidi1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botassidi1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botassidi1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi1 )
                                {
                                    $imagenpr4 = $botassidi1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botassidi1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botassidi1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botassidi1 )
                            {
                                $descripcion = $botassidi1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
