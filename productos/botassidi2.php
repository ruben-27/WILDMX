<?php
    ...
    $datos = $doc->getElementsByTagName("botassidi2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SIDI SIDI CROSSFIRE 2 LIGHT</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botassidi2 )
                    {
                        $titulo = $botassidi2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botassidi2 )
                            {
                                $portada = $botassidi2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botassidi2 )
                                        {
                                            $precio = $botassidi2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botassidi2 )
                                        {
                                            $valoracion = $botassidi2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/195982-botas-sidi-crossfire-2-light-azul-negro-bosof22042.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botassidi2 )
                                {
                                    $imagenpr1 = $botassidi2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botassidi2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botassidi2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi2 )
                                {
                                    $imagenpr2 = $botassidi2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botassidi2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botassidi2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi2 )
                                {
                                    $imagenpr3 = $botassidi2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botassidi2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botassidi2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi2 )
                                {
                                    $imagenpr4 = $botassidi2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botassidi2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botassidi2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botassidi2 )
                            {
                                $descripcion = $botassidi2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
