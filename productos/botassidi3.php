<?php
    ...
    $datos = $doc->getElementsByTagName("botassidi3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SIDI CROSSFIRE 2 SRS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botassidi3 )
                    {
                        $titulo = $botassidi3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botassidi3 )
                            {
                                $portada = $botassidi3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botassidi3 )
                                        {
                                            $precio = $botassidi3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botassidi3 )
                                        {
                                            $valoracion = $botassidi3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/17620-outlet-botas-sidi-crossfire-2-srs-blanco-blanco-bosof22111.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botassidi3 )
                                {
                                    $imagenpr1 = $botassidi3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botassidi3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botassidi3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi3 )
                                {
                                    $imagenpr2 = $botassidi3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botassidi3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botassidi3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi3 )
                                {
                                    $imagenpr3 = $botassidi3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botassidi3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botassidi3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi3 )
                                {
                                    $imagenpr4 = $botassidi3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botassidi3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botassidi3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botassidi3 )
                            {
                                $descripcion = $botassidi3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
