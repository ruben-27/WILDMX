<?php
    ...
    $datos = $doc->getElementsByTagName("botassidi4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botassidi4 )
                    {
                        $titulo = $botassidi4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botassidi4 )
                            {
                                $portada = $botassidi4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botassidi4 )
                                        {
                                            $precio = $botassidi4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botassidi4 )
                                        {
                                            $valoracion = $botassidi4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/387113-botas-sidi-crossfire-3-srs-rojo-negro-bosof32163x.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botassidi4 )
                                {
                                    $imagenpr1 = $botassidi4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botassidi4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botassidi4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi4 )
                                {
                                    $imagenpr2 = $botassidi4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botassidi4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botassidi4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi4 )
                                {
                                    $imagenpr3 = $botassidi4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botassidi4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botassidi4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi4 )
                                {
                                    $imagenpr4 = $botassidi4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botassidi4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botassidi4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botassidi4 )
                            {
                                $descripcion = $botassidi4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
