<?php
    ...
    $datos = $doc->getElementsByTagName("botassidi5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botassidi5 )
                    {
                        $titulo = $botassidi5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botassidi5 )
                            {
                                $portada = $botassidi5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botassidi5 )
                                        {
                                            $precio = $botassidi5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botassidi5 )
                                        {
                                            $valoracion = $botassidi5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/248628-botas-sidi-crossfire-3-srs-blanco-negro-amarillo-fluor-bosof321126xx.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botassidi5 )
                                {
                                    $imagenpr1 = $botassidi5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botassidi5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botassidi5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi5 )
                                {
                                    $imagenpr2 = $botassidi5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botassidi5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botassidi5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi5 )
                                {
                                    $imagenpr3 = $botassidi5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botassidi5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botassidi5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botassidi5 )
                                {
                                    $imagenpr4 = $botassidi5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botassidi5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botassidi5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botassidi5 )
                            {
                                $descripcion = $botassidi5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
