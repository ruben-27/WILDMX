<?php
    ...
    $datos = $doc->getElementsByTagName("botastcx1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | TCX X-BLAST</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botastcx1 )
                    {
                        $titulo = $botastcx1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botastcx1 )
                            {
                                $portada = $botastcx1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botastcx1 )
                                        {
                                            $precio = $botastcx1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botastcx1 )
                                        {
                                            $valoracion = $botastcx1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/377825-outlet-botas-tcx-x-blast-color-negro-amarillo-fluor-9670-yefl.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botastcx1 )
                                {
                                    $imagenpr1 = $botastcx1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botastcx1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botastcx1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx1 )
                                {
                                    $imagenpr2 = $botastcx1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botastcx1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botastcx1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx1 )
                                {
                                    $imagenpr3 = $botastcx1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botastcx1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botastcx1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx1 )
                                {
                                    $imagenpr4 = $botastcx1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botastcx1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botastcx1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botastcx1 )
                            {
                                $descripcion = $botastcx1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
