<?php
    ...
    $datos = $doc->getElementsByTagName("botastcx2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | TCX COMP-KID</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botastcx2 )
                    {
                        $titulo = $botastcx2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botastcx2 )
                            {
                                $portada = $botastcx2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botastcx2 )
                                        {
                                            $precio = $botastcx2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botastcx2 )
                                        {
                                            $valoracion = $botastcx2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/377181-liquidacion-botas-tcx-infantiles-comp-kid-azul-royal-amarillo-fluor-tcx9103royf.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botastcx2 )
                                {
                                    $imagenpr1 = $botastcx2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botastcx2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botastcx2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx2 )
                                {
                                    $imagenpr2 = $botastcx2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botastcx2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botastcx2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx2 )
                                {
                                    $imagenpr3 = $botastcx2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botastcx2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botastcx2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx2 )
                                {
                                    $imagenpr4 = $botastcx2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botastcx2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botastcx2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botastcx2 )
                            {
                                $descripcion = $botastcx2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
