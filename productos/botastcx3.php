<?php
    ...
    $datos = $doc->getElementsByTagName("botastcx3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | TCX COMP EVO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botastcx3 )
                    {
                        $titulo = $botastcx3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botastcx3 )
                            {
                                $portada = $botastcx3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botastcx3 )
                                        {
                                            $precio = $botastcx3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botastcx3 )
                                        {
                                            $valoracion = $botastcx3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/377819-botas-tcx-comp-evo-color-blanco-9660-bian.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botastcx3 )
                                {
                                    $imagenpr1 = $botastcx3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botastcx3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botastcx3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx3 )
                                {
                                    $imagenpr2 = $botastcx3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botastcx3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botastcx3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx3 )
                                {
                                    $imagenpr3 = $botastcx3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botastcx3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botastcx3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx3 )
                                {
                                    $imagenpr4 = $botastcx3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botastcx3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botastcx3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botastcx3 )
                            {
                                $descripcion = $botastcx3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
