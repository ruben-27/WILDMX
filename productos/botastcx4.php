<?php
    ...
    $datos = $doc->getElementsByTagName("botastcx4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | TCX COMP EVO NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botastcx4 )
                    {
                        $titulo = $botastcx4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botastcx4 )
                            {
                                $portada = $botastcx4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botastcx4 )
                                        {
                                            $precio = $botastcx4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botastcx4 )
                                        {
                                            $valoracion = $botastcx4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/377820-outlet-botas-tcx-comp-evo-color-blanco-naranja-9660-bior.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botastcx4 )
                                {
                                    $imagenpr1 = $botastcx4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botastcx4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botastcx4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx4 )
                                {
                                    $imagenpr2 = $botastcx4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botastcx4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botastcx4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx4 )
                                {
                                    $imagenpr3 = $botastcx4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botastcx4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botastcx4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx4 )
                                {
                                    $imagenpr4 = $botastcx4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botastcx4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botastcx4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botastcx4 )
                            {
                                $descripcion = $botastcx4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
