<?php
    ...
    $datos = $doc->getElementsByTagName("botastcx5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | TCX TCS SPEEDWAY</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botastcx5 )
                    {
                        $titulo = $botastcx5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botastcx5 )
                            {
                                $portada = $botastcx5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botastcx5 )
                                        {
                                            $precio = $botastcx5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botastcx5 )
                                        {
                                            $valoracion = $botastcx5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/274991-botas-tcx-tcs-speedway-color-blanco-7801bian.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botastcx5 )
                                {
                                    $imagenpr1 = $botastcx5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botastcx5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botastcx5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx5 )
                                {
                                    $imagenpr2 = $botastcx5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botastcx5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botastcx5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx5 )
                                {
                                    $imagenpr3 = $botastcx5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botastcx5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botastcx5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botastcx5 )
                                {
                                    $imagenpr4 = $botastcx5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botastcx5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botastcx5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botastcx5 )
                            {
                                $descripcion = $botastcx5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
