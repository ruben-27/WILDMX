<?php
    ...
    $datos = $doc->getElementsByTagName("botasthor1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR BLITZ XP BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasthor1 )
                    {
                        $titulo = $botasthor1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasthor1 )
                            {
                                $portada = $botasthor1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasthor1 )
                                        {
                                            $precio = $botasthor1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasthor1 )
                                        {
                                            $valoracion = $botasthor1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/379813-botas-thor-blitz-xp-2020-color-blanco-negro-thor34102173.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasthor1 )
                                {
                                    $imagenpr1 = $botasthor1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasthor1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasthor1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor1 )
                                {
                                    $imagenpr2 = $botasthor1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasthor1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasthor1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor1 )
                                {
                                    $imagenpr3 = $botasthor1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasthor1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasthor1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor1 )
                                {
                                    $imagenpr4 = $botasthor1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasthor1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasthor1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasthor1 )
                            {
                                $descripcion = $botasthor1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
