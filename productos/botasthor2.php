<?php
    ...
    $datos = $doc->getElementsByTagName("botasthor2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR RATCHET</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasthor2 )
                    {
                        $titulo = $botasthor2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasthor2 )
                            {
                                $portada = $botasthor2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasthor2 )
                                        {
                                            $precio = $botasthor2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasthor2 )
                                        {
                                            $valoracion = $botasthor2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/201890-botas-trial-thor-ratchet-boots-2017-color-negro-34100xxx.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasthor2 )
                                {
                                    $imagenpr1 = $botasthor2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasthor2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasthor2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor2 )
                                {
                                    $imagenpr2 = $botasthor2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasthor2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasthor2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor2 )
                                {
                                    $imagenpr3 = $botasthor2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasthor2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasthor2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor2 )
                                {
                                    $imagenpr4 = $botasthor2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasthor2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasthor2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasthor2 )
                            {
                                $descripcion = $botasthor2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
