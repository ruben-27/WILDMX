<?php
    ...
    $datos = $doc->getElementsByTagName("botasthor3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR RADIAL MX</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasthor3 )
                    {
                        $titulo = $botasthor3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasthor3 )
                            {
                                $portada = $botasthor3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasthor3 )
                                        {
                                            $precio = $botasthor3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasthor3 )
                                        {
                                            $valoracion = $botasthor3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/375218-botas-thor-radial-mx-2020-color-naranja-fluor-amarillo-fluor-thor34102262.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasthor3 )
                                {
                                    $imagenpr1 = $botasthor3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasthor3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasthor3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor3 )
                                {
                                    $imagenpr2 = $botasthor3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasthor3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasthor3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor3 )
                                {
                                    $imagenpr3 = $botasthor3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasthor3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasthor3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor3 )
                                {
                                    $imagenpr4 = $botasthor3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasthor3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasthor3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasthor3 )
                            {
                                $descripcion = $botasthor3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
