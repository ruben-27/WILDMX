<?php
    ...
    $datos = $doc->getElementsByTagName("botasthor4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR BLITZ XP AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasthor4 )
                    {
                        $titulo = $botasthor4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasthor4 )
                            {
                                $portada = $botasthor4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasthor4 )
                                        {
                                            $precio = $botasthor4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasthor4 )
                                        {
                                            $valoracion = $botasthor4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/379815-botas-thor-blitz-xp-2020-color-acido-fluor-negro-thor34102191.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasthor4 )
                                {
                                    $imagenpr1 = $botasthor4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasthor4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasthor4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor4 )
                                {
                                    $imagenpr2 = $botasthor4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasthor4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasthor4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor4 )
                                {
                                    $imagenpr3 = $botasthor4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasthor4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasthor4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor4 )
                                {
                                    $imagenpr4 = $botasthor4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasthor4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasthor4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasthor4 )
                            {
                                $descripcion = $botasthor4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
