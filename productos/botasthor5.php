<?php
    ...
    $datos = $doc->getElementsByTagName("botasthor5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR BLITZ XP ROSA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $botasthor5 )
                    {
                        $titulo = $botasthor5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $botasthor5 )
                            {
                                $portada = $botasthor5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $botasthor5 )
                                        {
                                            $precio = $botasthor5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $botasthor5 )
                                        {
                                            $valoracion = $botasthor5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/botas/379817-botas-mujer-thor-blitz-xp-2020-color-negro-rosa-thor34102227.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $botasthor5 )
                                {
                                    $imagenpr1 = $botasthor5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $botasthor5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $botasthor5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor5 )
                                {
                                    $imagenpr2 = $botasthor5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $botasthor5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $botasthor5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor5 )
                                {
                                    $imagenpr3 = $botasthor5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $botasthor5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $botasthor5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $botasthor5 )
                                {
                                    $imagenpr4 = $botasthor5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $botasthor5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $botasthor5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $botasthor5 )
                            {
                                $descripcion = $botasthor5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
