<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosacerbis2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS PROFILE 4 AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosacerbis2 )
                    {
                        $titulo = $cascosacerbis2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosacerbis2 )
                            {
                                $portada = $cascosacerbis2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosacerbis2 )
                                        {
                                            $precio = $cascosacerbis2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosacerbis2 )
                                        {
                                            $valoracion = $cascosacerbis2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-acerbis-profile-4-amarillo-negro_pid-PM-0088152" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis2 )
                                {
                                    $imagenpr1 = $cascosacerbis2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosacerbis2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosacerbis2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis2 )
                                {
                                    $imagenpr2 = $cascosacerbis2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosacerbis2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosacerbis2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis2 )
                                {
                                    $imagenpr3 = $cascosacerbis2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosacerbis2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosacerbis2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis2 )
                                {
                                    $imagenpr4 = $cascosacerbis2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosacerbis2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosacerbis2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosacerbis2 )
                            {
                                $descripcion = $cascosacerbis2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
