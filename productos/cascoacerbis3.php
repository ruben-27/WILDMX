<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosacerbis3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS PROFILE 4 NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosacerbis3 )
                    {
                        $titulo = $cascosacerbis3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosacerbis3 )
                            {
                                $portada = $cascosacerbis3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosacerbis3 )
                                        {
                                            $precio = $cascosacerbis3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosacerbis3 )
                                        {
                                            $valoracion = $cascosacerbis3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-acerbis-profile-4-negro-naranja_pid-PM-4905730" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis3 )
                                {
                                    $imagenpr1 = $cascosacerbis3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosacerbis3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosacerbis3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis3 )
                                {
                                    $imagenpr2 = $cascosacerbis3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosacerbis3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosacerbis3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis3 )
                                {
                                    $imagenpr3 = $cascosacerbis3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosacerbis3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosacerbis3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis3 )
                                {
                                    $imagenpr4 = $cascosacerbis3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosacerbis3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosacerbis3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosacerbis3 )
                            {
                                $descripcion = $cascosacerbis3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
