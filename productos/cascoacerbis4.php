<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosacerbis4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS PROFILE 4 BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosacerbis4 )
                    {
                        $titulo = $cascosacerbis4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosacerbis4 )
                            {
                                $portada = $cascosacerbis4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosacerbis4 )
                                        {
                                            $precio = $cascosacerbis4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosacerbis4 )
                                        {
                                            $valoracion = $cascosacerbis4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-acerbis-profile-4-camuflaje-blanco_pid-PM-3123914" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis4 )
                                {
                                    $imagenpr1 = $cascosacerbis4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosacerbis4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosacerbis4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis4 )
                                {
                                    $imagenpr2 = $cascosacerbis4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosacerbis4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosacerbis4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis4 )
                                {
                                    $imagenpr3 = $cascosacerbis4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosacerbis4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosacerbis4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis4 )
                                {
                                    $imagenpr4 = $cascosacerbis4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosacerbis4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosacerbis4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosacerbis4 )
                            {
                                $descripcion = $cascosacerbis4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
