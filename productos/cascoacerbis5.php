<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosacerbis5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS IMPACT 3.0</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosacerbis5 )
                    {
                        $titulo = $cascosacerbis5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosacerbis5 )
                            {
                                $portada = $cascosacerbis5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosacerbis5 )
                                        {
                                            $precio = $cascosacerbis5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosacerbis5 )
                                        {
                                            $valoracion = $cascosacerbis5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-acerbis-impact-30-negro-azul_pid-PM-0088132" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis5 )
                                {
                                    $imagenpr1 = $cascosacerbis5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosacerbis5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosacerbis5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis5 )
                                {
                                    $imagenpr2 = $cascosacerbis5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosacerbis5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosacerbis5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis5 )
                                {
                                    $imagenpr3 = $cascosacerbis5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosacerbis5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosacerbis5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosacerbis5 )
                                {
                                    $imagenpr4 = $cascosacerbis5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosacerbis5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosacerbis5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosacerbis5 )
                            {
                                $descripcion = $cascosacerbis5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
