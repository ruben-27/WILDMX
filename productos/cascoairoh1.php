<?php
    ...
    $datos = $doc->getElementsByTagName("cascosairoh1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | AIROH TWIST RACER</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $cascosairoh1 )
                    {
                        $titulo = $cascosairoh1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $cascosairoh1 )
                            {
                                $portada = $cascosairoh1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $cascosairoh1 )
                                        {
                                            $precio = $cascosairoh1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $cascosairoh1 )
                                        {
                                            $valoracion = $cascosairoh1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/374335-outlet-casco-airoh-twist-racr-2019-brillo-twra17.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh1 )
                                {
                                    $imagenpr1 = $cascosairoh1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosairoh1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosairoh1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh1 )
                                {
                                    $imagenpr2 = $cascosairoh1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosairoh1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosairoh1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh1 )
                                {
                                    $imagenpr3 = $cascosairoh1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosairoh1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosairoh1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh1 )
                                {
                                    $imagenpr4 = $cascosairoh1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosairoh1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosairoh1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $cascosairoh1 )
                            {
                                $descripcion = $cascosairoh1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
