<?php
    ...
    $datos = $doc->getElementsByTagName("cascosairoh2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | AIROH AVIATOR 2.3 AMS2</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $cascosairoh2 )
                    {
                        $titulo = $cascosairoh2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $cascosairoh2 )
                            {
                                $portada = $cascosairoh2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $cascosairoh2 )
                                        {
                                            $precio = $cascosairoh2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $cascosairoh2 )
                                        {
                                            $valoracion = $cascosairoh2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/380750-outlet-casco-airoh-aviator-23-ams2-edicion-limitada-six-days-2020-portugal-av23sdp55.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh2 )
                                {
                                    $imagenpr1 = $cascosairoh2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosairoh2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosairoh2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh2 )
                                {
                                    $imagenpr2 = $cascosairoh2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosairoh2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosairoh2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh2 )
                                {
                                    $imagenpr3 = $cascosairoh2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosairoh2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosairoh2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh2 )
                                {
                                    $imagenpr4 = $cascosairoh2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosairoh2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosairoh2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $cascosairoh2 )
                            {
                                $descripcion = $cascosairoh2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
