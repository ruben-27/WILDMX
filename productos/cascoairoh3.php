<?php
    ...
    $datos = $doc->getElementsByTagName("cascosairoh3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | AIROH TWIST 2.0 ROCKSTAR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $cascosairoh3 )
                    {
                        $titulo = $cascosairoh3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $cascosairoh3 )
                            {
                                $portada = $cascosairoh3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $cascosairoh3 )
                                        {
                                            $precio = $cascosairoh3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $cascosairoh3 )
                                        {
                                            $valoracion = $cascosairoh3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/389406-casco-airoh-twist-20-rockstar-2020-color-mate-tw2rk35.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh3 )
                                {
                                    $imagenpr1 = $cascosairoh3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosairoh3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosairoh3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh3 )
                                {
                                    $imagenpr2 = $cascosairoh3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosairoh3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosairoh3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh3 )
                                {
                                    $imagenpr3 = $cascosairoh3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosairoh3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosairoh3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh3 )
                                {
                                    $imagenpr4 = $cascosairoh3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosairoh3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosairoh3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $cascosairoh3 )
                            {
                                $descripcion = $cascosairoh3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
