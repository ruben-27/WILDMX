<?php
    ...
    $datos = $doc->getElementsByTagName("cascosairoh4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | AIROH TWIST 2.0 FRAME</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $cascosairoh4 )
                    {
                        $titulo = $cascosairoh4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $cascosairoh4 )
                            {
                                $portada = $cascosairoh4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $cascosairoh4 )
                                        {
                                            $precio = $cascosairoh4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $cascosairoh4 )
                                        {
                                            $valoracion = $cascosairoh4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/386696-casco-airoh-twist-20-frame-2020-color-amarillo-antracita-mate-tw2f21.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh4 )
                                {
                                    $imagenpr1 = $cascosairoh4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosairoh4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosairoh4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh4 )
                                {
                                    $imagenpr2 = $cascosairoh4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosairoh4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosairoh4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh4 )
                                {
                                    $imagenpr3 = $cascosairoh4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosairoh4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosairoh4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh4 )
                                {
                                    $imagenpr4 = $cascosairoh4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosairoh4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosairoh4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $cascosairoh4 )
                            {
                                $descripcion = $cascosairoh4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
