<?php
    ...
    $datos = $doc->getElementsByTagName("cascosairoh5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | AIROH TWIST 2.0 CAIROLI</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $cascosairoh5 )
                    {
                        $titulo = $cascosairoh5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $cascosairoh5 )
                            {
                                $portada = $cascosairoh5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $cascosairoh5 )
                                        {
                                            $precio = $cascosairoh5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $cascosairoh5 )
                                        {
                                            $valoracion = $cascosairoh5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/386695-casco-airoh-twist-20-cairoli-2020-color-brillo-tw2rc31.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh5 )
                                {
                                    $imagenpr1 = $cascosairoh5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosairoh5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosairoh5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh5 )
                                {
                                    $imagenpr2 = $cascosairoh5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosairoh5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosairoh5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh5 )
                                {
                                    $imagenpr3 = $cascosairoh5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosairoh5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosairoh5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $cascosairoh5 )
                                {
                                    $imagenpr4 = $cascosairoh5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosairoh5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosairoh5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $cascosairoh5 )
                            {
                                $descripcion = $cascosairoh5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
