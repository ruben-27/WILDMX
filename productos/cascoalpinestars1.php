<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosalpinestars1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS SUPERTECH M8 RADIUM</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosalpinestars1 )
                    {
                        $titulo = $cascosalpinestars1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosalpinestars1 )
                            {
                                $portada = $cascosalpinestars1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosalpinestars1 )
                                        {
                                            $precio = $cascosalpinestars1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosalpinestars1 )
                                        {
                                            $valoracion = $cascosalpinestars1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/379342-casco-alpinestars-supertech-m8-radium-2020-color-negro-mate-gris-medio-amarillo-fluor-alp8301419-1305.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars1 )
                                {
                                    $imagenpr1 = $cascosalpinestars1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosalpinestars1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosalpinestars1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars1 )
                                {
                                    $imagenpr2 = $cascosalpinestars1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosalpinestars1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosalpinestars1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars1 )
                                {
                                    $imagenpr3 = $cascosalpinestars1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosalpinestars1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosalpinestars1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars1 )
                                {
                                    $imagenpr4 = $cascosalpinestars1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosalpinestars1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosalpinestars1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosalpinestars1 )
                            {
                                $descripcion = $cascosalpinestars1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
