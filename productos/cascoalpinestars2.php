<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosalpinestars2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS SUPERTECH M8 TRIPLE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosalpinestars2 )
                    {
                        $titulo = $cascosalpinestars2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosalpinestars2 )
                            {
                                $portada = $cascosalpinestars2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosalpinestars2 )
                                        {
                                            $precio = $cascosalpinestars2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosalpinestars2 )
                                        {
                                            $valoracion = $cascosalpinestars2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/386019-casco-alpinestars-supertech-m8-triple-2020-color-naranja-gris-negro-brillo-alp01106180.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars2 )
                                {
                                    $imagenpr1 = $cascosalpinestars2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosalpinestars2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosalpinestars2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars2 )
                                {
                                    $imagenpr2 = $cascosalpinestars2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosalpinestars2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosalpinestars2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars2 )
                                {
                                    $imagenpr3 = $cascosalpinestars2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosalpinestars2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosalpinestars2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars2 )
                                {
                                    $imagenpr4 = $cascosalpinestars2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosalpinestars2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosalpinestars2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosalpinestars2 )
                            {
                                $descripcion = $cascosalpinestars2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
