<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosalpinestars4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS SUPERTECH M10 DYNO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosalpinestars4 )
                    {
                        $titulo = $cascosalpinestars4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosalpinestars4 )
                            {
                                $portada = $cascosalpinestars4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosalpinestars4 )
                                        {
                                            $precio = $cascosalpinestars4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosalpinestars4 )
                                        {
                                            $valoracion = $cascosalpinestars4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/386008-casco-alpinestars-supertech-m10-dyno-2020-color-negro-carbon-mate-naranja-brillo-alp01106282.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars4 )
                                {
                                    $imagenpr1 = $cascosalpinestars4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosalpinestars4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosalpinestars4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars4 )
                                {
                                    $imagenpr2 = $cascosalpinestars4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosalpinestars4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosalpinestars4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars4 )
                                {
                                    $imagenpr3 = $cascosalpinestars4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosalpinestars4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosalpinestars4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars4 )
                                {
                                    $imagenpr4 = $cascosalpinestars4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosalpinestars4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosalpinestars4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosalpinestars4 )
                            {
                                $descripcion = $cascosalpinestars4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
