<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosalpinestars5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS SUPERTECH M8 SOLID</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosalpinestars5 )
                    {
                        $titulo = $cascosalpinestars5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosalpinestars5 )
                            {
                                $portada = $cascosalpinestars5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosalpinestars5 )
                                        {
                                            $precio = $cascosalpinestars5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosalpinestars5 )
                                        {
                                            $valoracion = $cascosalpinestars5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/386012-casco-alpinestars-supertech-m8-solid-2020-color-blanco-brillo-alp01106150.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars5 )
                                {
                                    $imagenpr1 = $cascosalpinestars5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosalpinestars5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosalpinestars5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars5 )
                                {
                                    $imagenpr2 = $cascosalpinestars5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosalpinestars5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosalpinestars5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars5 )
                                {
                                    $imagenpr3 = $cascosalpinestars5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosalpinestars5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosalpinestars5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosalpinestars5 )
                                {
                                    $imagenpr4 = $cascosalpinestars5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosalpinestars5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosalpinestars5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosalpinestars5 )
                            {
                                $descripcion = $cascosalpinestars5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
