<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosflyracing1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING FORMULA VECTOR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosflyracing1 )
                    {
                        $titulo = $cascosflyracing1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosflyracing1 )
                            {
                                $portada = $cascosflyracing1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosflyracing1 )
                                        {
                                            $precio = $cascosflyracing1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosflyracing1 )
                                        {
                                            $valoracion = $cascosflyracing1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-fly-racing-formula-vector-azul-blanco-negro_pid-PM-4900685" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing1 )
                                {
                                    $imagenpr1 = $cascosflyracing1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosflyracing1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosflyracing1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing1 )
                                {
                                    $imagenpr2 = $cascosflyracing1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosflyracing1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosflyracing1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing1 )
                                {
                                    $imagenpr3 = $cascosflyracing1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosflyracing1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosflyracing1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing1 )
                                {
                                    $imagenpr4 = $cascosflyracing1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosflyracing1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosflyracing1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosflyracing1 )
                            {
                                $descripcion = $cascosflyracing1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
