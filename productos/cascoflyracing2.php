<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosflyracing2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING FORMULA SOLID</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosflyracing2 )
                    {
                        $titulo = $cascosflyracing2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosflyracing2 )
                            {
                                $portada = $cascosflyracing2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosflyracing2 )
                                        {
                                            $precio = $cascosflyracing2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosflyracing2 )
                                        {
                                            $valoracion = $cascosflyracing2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-fly-racing-formula-solid-blanco_pid-PM-4900691" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing2 )
                                {
                                    $imagenpr1 = $cascosflyracing2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosflyracing2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosflyracing2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing2 )
                                {
                                    $imagenpr2 = $cascosflyracing2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosflyracing2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosflyracing2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing2 )
                                {
                                    $imagenpr3 = $cascosflyracing2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosflyracing2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosflyracing2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing2 )
                                {
                                    $imagenpr4 = $cascosflyracing2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosflyracing2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosflyracing2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosflyracing2 )
                            {
                                $descripcion = $cascosflyracing2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
