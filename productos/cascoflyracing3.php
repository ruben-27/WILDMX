<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosflyracing3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING F2 MIPS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosflyracing3 )
                    {
                        $titulo = $cascosflyracing3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosflyracing3 )
                            {
                                $portada = $cascosflyracing3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosflyracing3 )
                                        {
                                            $precio = $cascosflyracing3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosflyracing3 )
                                        {
                                            $valoracion = $cascosflyracing3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-fly-racing-f2-mips-negro-mate_pid-PM-4900759" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing3 )
                                {
                                    $imagenpr1 = $cascosflyracing3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosflyracing3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosflyracing3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing3 )
                                {
                                    $imagenpr2 = $cascosflyracing3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosflyracing3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosflyracing3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing3 )
                                {
                                    $imagenpr3 = $cascosflyracing3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosflyracing3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosflyracing3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing3 )
                                {
                                    $imagenpr4 = $cascosflyracing3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosflyracing3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosflyracing3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosflyracing3 )
                            {
                                $descripcion = $cascosflyracing3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
