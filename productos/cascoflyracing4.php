<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosflyracing4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING F2 MIPS ROCKSTAR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosflyracing4 )
                    {
                        $titulo = $cascosflyracing4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosflyracing4 )
                            {
                                $portada = $cascosflyracing4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosflyracing4 )
                                        {
                                            $precio = $cascosflyracing4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosflyracing4 )
                                        {
                                            $valoracion = $cascosflyracing4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-fly-racing-f2-mips-rockstar_pid-PM-4900761" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing4 )
                                {
                                    $imagenpr1 = $cascosflyracing4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosflyracing4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosflyracing4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing4 )
                                {
                                    $imagenpr2 = $cascosflyracing4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosflyracing4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosflyracing4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing4 )
                                {
                                    $imagenpr3 = $cascosflyracing4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosflyracing4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosflyracing4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing4 )
                                {
                                    $imagenpr4 = $cascosflyracing4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosflyracing4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosflyracing4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosflyracing4 )
                            {
                                $descripcion = $cascosflyracing4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
