<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosflyracing5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING F2 GRANITE MIPS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosflyracing5 )
                    {
                        $titulo = $cascosflyracing5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosflyracing5 )
                            {
                                $portada = $cascosflyracing5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosflyracing5 )
                                        {
                                            $precio = $cascosflyracing5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosflyracing5 )
                                        {
                                            $valoracion = $cascosflyracing5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-fly-racing-f2-granite-mips-verde-negro_pid-PM-4900753" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing5 )
                                {
                                    $imagenpr1 = $cascosflyracing5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosflyracing5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosflyracing5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing5 )
                                {
                                    $imagenpr2 = $cascosflyracing5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosflyracing5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosflyracing5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing5 )
                                {
                                    $imagenpr3 = $cascosflyracing5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosflyracing5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosflyracing5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosflyracing5 )
                                {
                                    $imagenpr4 = $cascosflyracing5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosflyracing5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosflyracing5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosflyracing5 )
                            {
                                $descripcion = $cascosflyracing5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
