<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosfox1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX V1 GAMA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosfox1 )
                    {
                        $titulo = $cascosfox1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosfox1 )
                            {
                                $portada = $cascosfox1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosfox1 )
                                        {
                                            $precio = $cascosfox1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosfox1 )
                                        {
                                            $valoracion = $cascosfox1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/380727-casco-fox-v1-gama-2020-multicolor-25472-922.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox1 )
                                {
                                    $imagenpr1 = $cascosfox1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosfox1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosfox1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox1 )
                                {
                                    $imagenpr2 = $cascosfox1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosfox1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosfox1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox1 )
                                {
                                    $imagenpr3 = $cascosfox1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosfox1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosfox1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox1 )
                                {
                                    $imagenpr4 = $cascosfox1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosfox1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosfox1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosfox1 )
                            {
                                $descripcion = $cascosfox1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
