<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosfox2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX V1 YORR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosfox2 )
                    {
                        $titulo = $cascosfox2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosfox2 )
                            {
                                $portada = $cascosfox2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosfox2 )
                                        {
                                            $precio = $cascosfox2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosfox2 )
                                        {
                                            $valoracion = $cascosfox2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/380737-casco-fox-v1-yorr-2020-multicolor-25476-922.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox2 )
                                {
                                    $imagenpr1 = $cascosfox2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosfox2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosfox2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox2 )
                                {
                                    $imagenpr2 = $cascosfox2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosfox2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosfox2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox2 )
                                {
                                    $imagenpr3 = $cascosfox2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosfox2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosfox2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox2 )
                                {
                                    $imagenpr4 = $cascosfox2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosfox2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosfox2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosfox2 )
                            {
                                $descripcion = $cascosfox2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
