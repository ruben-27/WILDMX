<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosfox3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX V2 KRESA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosfox3 )
                    {
                        $titulo = $cascosfox3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosfox3 )
                            {
                                $portada = $cascosfox3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosfox3 )
                                        {
                                            $precio = $cascosfox3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosfox3 )
                                        {
                                            $valoracion = $cascosfox3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/380476-casco-fox-v2-kresa-2020-multicolor-23975-922.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox3 )
                                {
                                    $imagenpr1 = $cascosfox3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosfox3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosfox3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox3 )
                                {
                                    $imagenpr2 = $cascosfox3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosfox3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosfox3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox3 )
                                {
                                    $imagenpr3 = $cascosfox3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosfox3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosfox3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox3 )
                                {
                                    $imagenpr4 = $cascosfox3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosfox3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosfox3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosfox3 )
                            {
                                $descripcion = $cascosfox3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
