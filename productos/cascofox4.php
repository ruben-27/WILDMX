<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosfox4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX V2 VLAR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosfox4 )
                    {
                        $titulo = $cascosfox4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosfox4 )
                            {
                                $portada = $cascosfox4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosfox4 )
                                        {
                                            $precio = $cascosfox4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosfox4 )
                                        {
                                            $valoracion = $cascosfox4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/380566-casco-fox-v2-vlar-2020-color-azul-24264-002.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox4 )
                                {
                                    $imagenpr1 = $cascosfox4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosfox4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosfox4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox4 )
                                {
                                    $imagenpr2 = $cascosfox4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosfox4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosfox4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox4 )
                                {
                                    $imagenpr3 = $cascosfox4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosfox4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosfox4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox4 )
                                {
                                    $imagenpr4 = $cascosfox4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosfox4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosfox4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosfox4 )
                            {
                                $descripcion = $cascosfox4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
