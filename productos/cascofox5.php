<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosfox5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX V1 PRIX</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosfox5 )
                    {
                        $titulo = $cascosfox5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosfox5 )
                            {
                                $portada = $cascosfox5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosfox5 )
                                        {
                                            $precio = $cascosfox5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosfox5 )
                                        {
                                            $valoracion = $cascosfox5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/380725-casco-fox-v1-prix-2020-color-naranja-fluor-25471-824.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox5 )
                                {
                                    $imagenpr1 = $cascosfox5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosfox5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosfox5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox5 )
                                {
                                    $imagenpr2 = $cascosfox5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosfox5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosfox5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox5 )
                                {
                                    $imagenpr3 = $cascosfox5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosfox5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosfox5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosfox5 )
                                {
                                    $imagenpr4 = $cascosfox5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosfox5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosfox5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosfox5 )
                            {
                                $descripcion = $cascosfox5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
