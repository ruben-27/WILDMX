<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosjust11");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | JUST1 J12 UNIT</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosjust11 )
                    {
                        $titulo = $cascosjust11->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosjust11 )
                            {
                                $portada = $cascosjust11->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosjust11 )
                                        {
                                            $precio = $cascosjust11->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosjust11 )
                                        {
                                            $valoracion = $cascosjust11->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/370665-casco-just1-j12-unit-amarillo-623911.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust11 )
                                {
                                    $imagenpr1 = $cascosjust11->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosjust11->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosjust11->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust11 )
                                {
                                    $imagenpr2 = $cascosjust11->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosjust11->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosjust11->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust11 )
                                {
                                    $imagenpr3 = $cascosjust11->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosjust11->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosjust11->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust11 )
                                {
                                    $imagenpr4 = $cascosjust11->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosjust11->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosjust11->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosjust11 )
                            {
                                $descripcion = $cascosjust11->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
