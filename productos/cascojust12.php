<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosjust12");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | JUST1 12 DOMINATOR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosjust12 )
                    {
                        $titulo = $cascosjust12->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosjust12 )
                            {
                                $portada = $cascosjust12->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosjust12 )
                                        {
                                            $precio = $cascosjust12->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosjust12 )
                                        {
                                            $valoracion = $cascosjust12->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/370681-casco-just1-j12-dominator-rojo-lima-fluor-430196.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust12 )
                                {
                                    $imagenpr1 = $cascosjust12->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosjust12->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosjust12->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust12 )
                                {
                                    $imagenpr2 = $cascosjust12->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosjust12->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosjust12->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust12 )
                                {
                                    $imagenpr3 = $cascosjust12->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosjust12->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosjust12->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust12 )
                                {
                                    $imagenpr4 = $cascosjust12->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosjust12->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosjust12->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosjust12 )
                            {
                                $descripcion = $cascosjust12->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
