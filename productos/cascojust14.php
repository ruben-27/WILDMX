<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosjust14");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | JUST1 J32 MOTO X VERDE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosjust14 )
                    {
                        $titulo = $cascosjust14->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosjust14 )
                            {
                                $portada = $cascosjust14->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosjust14 )
                                        {
                                            $precio = $cascosjust14->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosjust14 )
                                        {
                                            $valoracion = $cascosjust14->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/370685-casco-just1-j32-moto-x-verde-433524.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust14 )
                                {
                                    $imagenpr1 = $cascosjust14->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosjust14->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosjust14->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust14 )
                                {
                                    $imagenpr2 = $cascosjust14->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosjust14->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosjust14->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust14 )
                                {
                                    $imagenpr3 = $cascosjust14->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosjust14->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosjust14->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust14 )
                                {
                                    $imagenpr4 = $cascosjust14->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosjust14->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosjust14->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosjust14 )
                            {
                                $descripcion = $cascosjust14->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
