<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosjust15");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | JUST1 J32 MOTO X NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosjust15 )
                    {
                        $titulo = $cascosjust15->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosjust15 )
                            {
                                $portada = $cascosjust15->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosjust15 )
                                        {
                                            $precio = $cascosjust15->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosjust15 )
                                        {
                                            $valoracion = $cascosjust15->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/370691-casco-infantil-just1-j32-moto-x-naranja-433527y.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust15 )
                                {
                                    $imagenpr1 = $cascosjust15->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosjust15->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosjust15->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust15 )
                                {
                                    $imagenpr2 = $cascosjust15->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosjust15->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosjust15->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust15 )
                                {
                                    $imagenpr3 = $cascosjust15->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosjust15->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosjust15->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosjust15 )
                                {
                                    $imagenpr4 = $cascosjust15->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosjust15->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosjust15->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosjust15 )
                            {
                                $descripcion = $cascosjust15->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
