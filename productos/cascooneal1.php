<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosoneal1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL ATTACK 2.0 Serie 3</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosoneal1 )
                    {
                        $titulo = $cascosoneal1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosoneal1 )
                            {
                                $portada = $cascosoneal1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosoneal1 )
                                        {
                                            $precio = $cascosoneal1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosoneal1 )
                                        {
                                            $valoracion = $cascosoneal1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-oneal-attack-20-serie-3-negro-amarillo-fluo_pid-PM-4822931" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal1 )
                                {
                                    $imagenpr1 = $cascosoneal1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosoneal1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosoneal1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal1 )
                                {
                                    $imagenpr2 = $cascosoneal1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosoneal1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosoneal1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal1 )
                                {
                                    $imagenpr3 = $cascosoneal1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosoneal1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosoneal1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal1 )
                                {
                                    $imagenpr4 = $cascosoneal1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosoneal1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosoneal1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosoneal1 )
                            {
                                $descripcion = $cascosoneal1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
