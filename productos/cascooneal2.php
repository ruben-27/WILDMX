<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosoneal2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL 2-Series SLICK</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosoneal2 )
                    {
                        $titulo = $cascosoneal2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosoneal2 )
                            {
                                $portada = $cascosoneal2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosoneal2 )
                                        {
                                            $precio = $cascosoneal2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosoneal2 )
                                        {
                                            $valoracion = $cascosoneal2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-oneal-2-series-slick-blanco_pid-PM-0097501" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal2 )
                                {
                                    $imagenpr1 = $cascosoneal2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosoneal2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosoneal2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal2 )
                                {
                                    $imagenpr2 = $cascosoneal2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosoneal2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosoneal2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal2 )
                                {
                                    $imagenpr3 = $cascosoneal2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosoneal2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosoneal2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal2 )
                                {
                                    $imagenpr4 = $cascosoneal2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosoneal2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosoneal2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosoneal2 )
                            {
                                $descripcion = $cascosoneal2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
