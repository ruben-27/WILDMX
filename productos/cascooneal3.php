<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosoneal3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL 2-Series SLICK AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosoneal3 )
                    {
                        $titulo = $cascosoneal3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosoneal3 )
                            {
                                $portada = $cascosoneal3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosoneal3 )
                                        {
                                            $precio = $cascosoneal3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosoneal3 )
                                        {
                                            $valoracion = $cascosoneal3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/cascos-de-cross-nino_c295/casco-de-cross-oneal-2-series-slick-nino-negro-amarillo-neon_pid-PM-0097547" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal3 )
                                {
                                    $imagenpr1 = $cascosoneal3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosoneal3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosoneal3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal3 )
                                {
                                    $imagenpr2 = $cascosoneal3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosoneal3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosoneal3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal3 )
                                {
                                    $imagenpr3 = $cascosoneal3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosoneal3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosoneal3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal3 )
                                {
                                    $imagenpr4 = $cascosoneal3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosoneal3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosoneal3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosoneal3 )
                            {
                                $descripcion = $cascosoneal3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
