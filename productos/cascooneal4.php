<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosoneal4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL 3-Series FLAT 2.0</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosoneal4 )
                    {
                        $titulo = $cascosoneal4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosoneal4 )
                            {
                                $portada = $cascosoneal4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosoneal4 )
                                        {
                                            $precio = $cascosoneal4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosoneal4 )
                                        {
                                            $valoracion = $cascosoneal4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-oneal-3-series-flat-20-blanco_pid-PM-4822937" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal4 )
                                {
                                    $imagenpr1 = $cascosoneal4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosoneal4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosoneal4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal4 )
                                {
                                    $imagenpr2 = $cascosoneal4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosoneal4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosoneal4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal4 )
                                {
                                    $imagenpr3 = $cascosoneal4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosoneal4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosoneal4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal4 )
                                {
                                    $imagenpr4 = $cascosoneal4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosoneal4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosoneal4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosoneal4 )
                            {
                                $descripcion = $cascosoneal4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
