<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosoneal5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL 3-Series RIFF 2.0</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosoneal5 )
                    {
                        $titulo = $cascosoneal5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosoneal5 )
                            {
                                $portada = $cascosoneal5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosoneal5 )
                                        {
                                            $precio = $cascosoneal5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosoneal5 )
                                        {
                                            $valoracion = $cascosoneal5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/cascos_c293/cascos-de-cross_c192/casco-de-cross-oneal-3-series-riff-20-rojo-amarillo-neon_pid-PM-4822946" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal5 )
                                {
                                    $imagenpr1 = $cascosoneal5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosoneal5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosoneal5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal5 )
                                {
                                    $imagenpr2 = $cascosoneal5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosoneal5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosoneal5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal5 )
                                {
                                    $imagenpr3 = $cascosoneal5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosoneal5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosoneal5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosoneal5 )
                                {
                                    $imagenpr4 = $cascosoneal5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosoneal5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosoneal5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosoneal5 )
                            {
                                $descripcion = $cascosoneal5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
