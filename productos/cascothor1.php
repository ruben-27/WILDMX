<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosthor1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SECTOR BLADE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosthor1 )
                    {
                        $titulo = $cascosthor1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosthor1 )
                            {
                                $portada = $cascosthor1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosthor1 )
                                        {
                                            $precio = $cascosthor1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosthor1 )
                                        {
                                            $valoracion = $cascosthor1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/379320-casco-thor-sector-blade-offroad-2020-color-blanco-agua-thor01106240.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor1 )
                                {
                                    $imagenpr1 = $cascosthor1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosthor1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosthor1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor1 )
                                {
                                    $imagenpr2 = $cascosthor1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosthor1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosthor1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor1 )
                                {
                                    $imagenpr3 = $cascosthor1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosthor1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosthor1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor1 )
                                {
                                    $imagenpr4 = $cascosthor1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosthor1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosthor1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosthor1 )
                            {
                                $descripcion = $cascosthor1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
