<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosthor2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SECTOR SPLIT NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosthor2 )
                    {
                        $titulo = $cascosthor2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosthor2 )
                            {
                                $portada = $cascosthor2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosthor2 )
                                        {
                                            $precio = $cascosthor2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosthor2 )
                                        {
                                            $valoracion = $cascosthor2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/379820-casco-thor-sector-split-2020-color-naranja-azul-marino-thor01106228.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor2 )
                                {
                                    $imagenpr1 = $cascosthor2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosthor2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosthor2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor2 )
                                {
                                    $imagenpr2 = $cascosthor2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosthor2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosthor2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor2 )
                                {
                                    $imagenpr3 = $cascosthor2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosthor2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosthor2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor2 )
                                {
                                    $imagenpr4 = $cascosthor2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosthor2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosthor2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosthor2 )
                            {
                                $descripcion = $cascosthor2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
