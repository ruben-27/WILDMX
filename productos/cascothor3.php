<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosthor3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SECTOR WARP</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosthor3 )
                    {
                        $titulo = $cascosthor3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosthor3 )
                            {
                                $portada = $cascosthor3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosthor3 )
                                        {
                                            $precio = $cascosthor3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosthor3 )
                                        {
                                            $valoracion = $cascosthor3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/375234-casco-thor-sector-warp-2020-color-rojo-negro-thor01106056.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor3 )
                                {
                                    $imagenpr1 = $cascosthor3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosthor3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosthor3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor3 )
                                {
                                    $imagenpr2 = $cascosthor3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosthor3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosthor3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor3 )
                                {
                                    $imagenpr3 = $cascosthor3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosthor3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosthor3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor3 )
                                {
                                    $imagenpr4 = $cascosthor3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosthor3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosthor3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosthor3 )
                            {
                                $descripcion = $cascosthor3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
