<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosthor4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SECTOR BOMBER</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosthor4 )
                    {
                        $titulo = $cascosthor4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosthor4 )
                            {
                                $portada = $cascosthor4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosthor4 )
                                        {
                                            $precio = $cascosthor4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosthor4 )
                                        {
                                            $valoracion = $cascosthor4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/372294-casco-thor-sector-bomber-negro-menta-thor01105610.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor4 )
                                {
                                    $imagenpr1 = $cascosthor4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosthor4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosthor4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor4 )
                                {
                                    $imagenpr2 = $cascosthor4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosthor4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosthor4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor4 )
                                {
                                    $imagenpr3 = $cascosthor4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosthor4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosthor4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor4 )
                                {
                                    $imagenpr4 = $cascosthor4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosthor4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosthor4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosthor4 )
                            {
                                $descripcion = $cascosthor4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
