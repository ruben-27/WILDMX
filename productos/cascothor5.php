<?php
    ...
    $datos3 = $doc->getElementsByTagName("cascosthor5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SECTOR SPLIT AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $cascosthor5 )
                    {
                        $titulo = $cascosthor5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $cascosthor5 )
                            {
                                $portada = $cascosthor5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $cascosthor5 )
                                        {
                                            $precio = $cascosthor5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $cascosthor5 )
                                        {
                                            $valoracion = $cascosthor5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/cascos/379819-casco-thor-sector-split-2020-color-negro-acido-thor01106222.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor5 )
                                {
                                    $imagenpr1 = $cascosthor5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $cascosthor5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $cascosthor5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor5 )
                                {
                                    $imagenpr2 = $cascosthor5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $cascosthor5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $cascosthor5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor5 )
                                {
                                    $imagenpr3 = $cascosthor5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $cascosthor5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $cascosthor5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $cascosthor5 )
                                {
                                    $imagenpr4 = $cascosthor5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $cascosthor5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $cascosthor5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $cascosthor5 )
                            {
                                $descripcion = $cascosthor5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
