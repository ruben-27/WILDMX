<?php
    ...
    $datos = $doc->getElementsByTagName("collarinalpinestars1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $collarinalpinestars1 )
                    {
                        $titulo = $collarinalpinestars1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $collarinalpinestars1 )
                            {
                                $portada = $collarinalpinestars1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $collarinalpinestars1 )
                                        {
                                            $precio = $collarinalpinestars1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $collarinalpinestars1 )
                                        {
                                            $valoracion = $collarinalpinestars1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/collarines/386073-collarin-infantil-alpinestars-2020-color-negro-blanco-27070124.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars1 )
                                {
                                    $imagenpr1 = $collarinalpinestars1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinalpinestars1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinalpinestars1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars1 )
                                {
                                    $imagenpr2 = $collarinalpinestars1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinalpinestars1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinalpinestars1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars1 )
                                {
                                    $imagenpr3 = $collarinalpinestars1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinalpinestars1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinalpinestars1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars1 )
                                {
                                    $imagenpr4 = $collarinalpinestars1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinalpinestars1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinalpinestars1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $collarinalpinestars1 )
                            {
                                $descripcion = $collarinalpinestars1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
