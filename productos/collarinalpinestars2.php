<?php
    ...
    $datos = $doc->getElementsByTagName("collarinalpinestars2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $collarinalpinestars2 )
                    {
                        $titulo = $collarinalpinestars2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $collarinalpinestars2 )
                            {
                                $portada = $collarinalpinestars2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $collarinalpinestars2 )
                                        {
                                            $precio = $collarinalpinestars2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $collarinalpinestars2 )
                                        {
                                            $valoracion = $collarinalpinestars2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/collarines/268335-collarin-infantil-alpinestars-2020-color-negro-amarillo-fluor-27070113.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars2 )
                                {
                                    $imagenpr1 = $collarinalpinestars2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinalpinestars2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinalpinestars2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars2 )
                                {
                                    $imagenpr2 = $collarinalpinestars2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinalpinestars2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinalpinestars2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars2 )
                                {
                                    $imagenpr3 = $collarinalpinestars2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinalpinestars2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinalpinestars2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars2 )
                                {
                                    $imagenpr4 = $collarinalpinestars2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinalpinestars2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinalpinestars2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $collarinalpinestars2 )
                            {
                                $descripcion = $collarinalpinestars2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
