<?php
    ...
    $datos = $doc->getElementsByTagName("collarinalpinestars3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS BNS TECH</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $collarinalpinestars3 )
                    {
                        $titulo = $collarinalpinestars3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $collarinalpinestars3 )
                            {
                                $portada = $collarinalpinestars3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $collarinalpinestars3 )
                                        {
                                            $precio = $collarinalpinestars3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $collarinalpinestars3 )
                                        {
                                            $valoracion = $collarinalpinestars3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/collarines/388757-outlet-collarin-alpinestars-bns-tech-carbon-6500014-1430-lxl.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars3 )
                                {
                                    $imagenpr1 = $collarinalpinestars3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinalpinestars3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinalpinestars3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars3 )
                                {
                                    $imagenpr2 = $collarinalpinestars3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinalpinestars3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinalpinestars3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars3 )
                                {
                                    $imagenpr3 = $collarinalpinestars3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinalpinestars3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinalpinestars3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars3 )
                                {
                                    $imagenpr4 = $collarinalpinestars3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinalpinestars3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinalpinestars3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $collarinalpinestars3 )
                            {
                                $descripcion = $collarinalpinestars3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
