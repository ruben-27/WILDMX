<?php
    ...
    $datos = $doc->getElementsByTagName("collarinalpinestars4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS BNS TECH-2</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $collarinalpinestars4 )
                    {
                        $titulo = $collarinalpinestars4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $collarinalpinestars4 )
                            {
                                $portada = $collarinalpinestars4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $collarinalpinestars4 )
                                        {
                                            $precio = $collarinalpinestars4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $collarinalpinestars4 )
                                        {
                                            $valoracion = $collarinalpinestars4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/collarines/373052-collarin-alpinestars-bns-tech-2-2020-color-negro-amarillo-fluor-alp27070116.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars4 )
                                {
                                    $imagenpr1 = $collarinalpinestars4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinalpinestars4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinalpinestars4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars4 )
                                {
                                    $imagenpr2 = $collarinalpinestars4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinalpinestars4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinalpinestars4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars4 )
                                {
                                    $imagenpr3 = $collarinalpinestars4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinalpinestars4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinalpinestars4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars4 )
                                {
                                    $imagenpr4 = $collarinalpinestars4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinalpinestars4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinalpinestars4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $collarinalpinestars4 )
                            {
                                $descripcion = $collarinalpinestars4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
