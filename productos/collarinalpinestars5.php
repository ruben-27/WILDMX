<?php
    ...
    $datos = $doc->getElementsByTagName("collarinalpinestars5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $collarinalpinestars5 )
                    {
                        $titulo = $collarinalpinestars5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $collarinalpinestars5 )
                            {
                                $portada = $collarinalpinestars5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $collarinalpinestars5 )
                                        {
                                            $precio = $collarinalpinestars5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $collarinalpinestars5 )
                                        {
                                            $valoracion = $collarinalpinestars5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/collarines/386067-collarin-alpinestars-bns-tech-2-2020-color-negro-gris-alp27070122.html" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars5 )
                                {
                                    $imagenpr1 = $collarinalpinestars5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinalpinestars5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinalpinestars5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars5 )
                                {
                                    $imagenpr2 = $collarinalpinestars5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinalpinestars5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinalpinestars5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars5 )
                                {
                                    $imagenpr3 = $collarinalpinestars5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinalpinestars5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinalpinestars5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $collarinalpinestars5 )
                                {
                                    $imagenpr4 = $collarinalpinestars5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinalpinestars5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinalpinestars5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $collarinalpinestars5 )
                            {
                                $descripcion = $collarinalpinestars5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
