<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinatlas1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ATLAS TYKE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinatlas1 )
                    {
                        $titulo = $collarinatlas1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinatlas1 )
                            {
                                $portada = $collarinatlas1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinatlas1 )
                                        {
                                            $precio = $collarinatlas1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinatlas1 )
                                        {
                                            $valoracion = $collarinatlas1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/protecciones-de-cross-nino_c2621/collarin-atlas-tyke-nino-athletica_pid-PIA-123952" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas1 )
                                {
                                    $imagenpr1 = $collarinatlas1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinatlas1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinatlas1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas1 )
                                {
                                    $imagenpr2 = $collarinatlas1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinatlas1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinatlas1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas1 )
                                {
                                    $imagenpr3 = $collarinatlas1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinatlas1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinatlas1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas1 )
                                {
                                    $imagenpr4 = $collarinatlas1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinatlas1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinatlas1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinatlas1 )
                            {
                                $descripcion = $collarinatlas1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
