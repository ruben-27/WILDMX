<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinatlas2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ATLAS TYKE NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinatlas2 )
                    {
                        $titulo = $collarinatlas2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinatlas2 )
                            {
                                $portada = $collarinatlas2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinatlas2 )
                                        {
                                            $precio = $collarinatlas2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinatlas2 )
                                        {
                                            $valoracion = $collarinatlas2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/protecciones-de-cross-nino_c2621/collarin-atlas-tyke-nino-naranja_pid-PIA-123951" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas2 )
                                {
                                    $imagenpr1 = $collarinatlas2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinatlas2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinatlas2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas2 )
                                {
                                    $imagenpr2 = $collarinatlas2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinatlas2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinatlas2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas2 )
                                {
                                    $imagenpr3 = $collarinatlas2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinatlas2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinatlas2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas2 )
                                {
                                    $imagenpr4 = $collarinatlas2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinatlas2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinatlas2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinatlas2 )
                            {
                                $descripcion = $collarinatlas2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
