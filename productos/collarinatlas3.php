<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinatlas3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ATLAS TYKE CAMUFLAJE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinatlas3 )
                    {
                        $titulo = $collarinatlas3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinatlas3 )
                            {
                                $portada = $collarinatlas3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinatlas3 )
                                        {
                                            $precio = $collarinatlas3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinatlas3 )
                                        {
                                            $valoracion = $collarinatlas3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/protecciones-de-cross-nino_c2621/collarin-atlas-tyke-nino-camuflaje_pid-PIA-123950" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas3 )
                                {
                                    $imagenpr1 = $collarinatlas3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinatlas3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinatlas3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas3 )
                                {
                                    $imagenpr2 = $collarinatlas3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinatlas3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinatlas3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas3 )
                                {
                                    $imagenpr3 = $collarinatlas3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinatlas3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinatlas3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas3 )
                                {
                                    $imagenpr4 = $collarinatlas3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinatlas3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinatlas3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinatlas3 )
                            {
                                $descripcion = $collarinatlas3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
