<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinatlas4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ATLAS AIR GHOST</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinatlas4 )
                    {
                        $titulo = $collarinatlas4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinatlas4 )
                            {
                                $portada = $collarinatlas4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinatlas4 )
                                        {
                                            $precio = $collarinatlas4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinatlas4 )
                                        {
                                            $valoracion = $collarinatlas4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/protecciones-de-cross_c15/collarines_c30/collarin-atlas-air-ghost_pid-PM-3086743" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas4 )
                                {
                                    $imagenpr1 = $collarinatlas4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinatlas4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinatlas4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas4 )
                                {
                                    $imagenpr2 = $collarinatlas4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinatlas4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinatlas4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas4 )
                                {
                                    $imagenpr3 = $collarinatlas4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinatlas4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinatlas4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas4 )
                                {
                                    $imagenpr4 = $collarinatlas4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinatlas4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinatlas4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinatlas4 )
                            {
                                $descripcion = $collarinatlas4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
