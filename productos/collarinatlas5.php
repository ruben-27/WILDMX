<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinatlas5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ATLAS PRODIGY</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinatlas5 )
                    {
                        $titulo = $collarinatlas5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinatlas5 )
                            {
                                $portada = $collarinatlas5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinatlas5 )
                                        {
                                            $precio = $collarinatlas5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinatlas5 )
                                        {
                                            $valoracion = $collarinatlas5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/protecciones-de-cross-nino_c2621/collarin-atlas-prodigy-nino-nightshift_pid-PIA-49826" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas5 )
                                {
                                    $imagenpr1 = $collarinatlas5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinatlas5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinatlas5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas5 )
                                {
                                    $imagenpr2 = $collarinatlas5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinatlas5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinatlas5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas5 )
                                {
                                    $imagenpr3 = $collarinatlas5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinatlas5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinatlas5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinatlas5 )
                                {
                                    $imagenpr4 = $collarinatlas5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinatlas5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinatlas5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinatlas5 )
                            {
                                $descripcion = $collarinatlas5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
