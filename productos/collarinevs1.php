<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinevs1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinevs1 )
                    {
                        $titulo = $collarinevs1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinevs1 )
                            {
                                $portada = $collarinevs1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinevs1 )
                                        {
                                            $precio = $collarinevs1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinevs1 )
                                        {
                                            $valoracion = $collarinevs1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/protecciones-de-cross-nino_c2621/collarin-evs-r3-nino_pid-642-3019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs1 )
                                {
                                    $imagenpr1 = $collarinevs1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinevs1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinevs1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs1 )
                                {
                                    $imagenpr2 = $collarinevs1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinevs1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinevs1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs1 )
                                {
                                    $imagenpr3 = $collarinevs1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinevs1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinevs1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs1 )
                                {
                                    $imagenpr4 = $collarinevs1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinevs1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinevs1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinevs1 )
                            {
                                $descripcion = $collarinevs1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
