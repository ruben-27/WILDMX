<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinevs2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | EVS SPORTS R4K</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinevs2 )
                    {
                        $titulo = $collarinevs2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinevs2 )
                            {
                                $portada = $collarinevs2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinevs2 )
                                        {
                                            $precio = $collarinevs2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinevs2 )
                                        {
                                            $valoracion = $collarinevs2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/protecciones-de-cross_c15/collarines_c30/collarin-evs-sports-r4k-koroyd-nino_pid-R4K-W-Y" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs2 )
                                {
                                    $imagenpr1 = $collarinevs2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinevs2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinevs2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs2 )
                                {
                                    $imagenpr2 = $collarinevs2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinevs2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinevs2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs2 )
                                {
                                    $imagenpr3 = $collarinevs2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinevs2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinevs2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs2 )
                                {
                                    $imagenpr4 = $collarinevs2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinevs2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinevs2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinevs2 )
                            {
                                $descripcion = $collarinevs2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
