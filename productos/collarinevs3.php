<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinevs3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinevs3 )
                    {
                        $titulo = $collarinevs3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinevs3 )
                            {
                                $portada = $collarinevs3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinevs3 )
                                        {
                                            $precio = $collarinevs3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinevs3 )
                                        {
                                            $valoracion = $collarinevs3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/protecciones-de-cross_c15/collarines_c30/collarin-evs-r4_pid-R4WH" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs3 )
                                {
                                    $imagenpr1 = $collarinevs3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinevs3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinevs3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs3 )
                                {
                                    $imagenpr2 = $collarinevs3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinevs3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinevs3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs3 )
                                {
                                    $imagenpr3 = $collarinevs3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinevs3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinevs3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinevs3 )
                                {
                                    $imagenpr4 = $collarinevs3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinevs3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinevs3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinevs3 )
                            {
                                $descripcion = $collarinevs3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
