<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinleatt1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | LEATT GPX 3.5 BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinleatt1 )
                    {
                        $titulo = $collarinleatt1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinleatt1 )
                            {
                                $portada = $collarinleatt1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinleatt1 )
                                        {
                                            $precio = $collarinleatt1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinleatt1 )
                                        {
                                            $valoracion = $collarinleatt1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/protecciones-de-cross_c15/collarines_c30/collarin-leatt-gpx-35-blanco_pid-PM-4899217" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt1 )
                                {
                                    $imagenpr1 = $collarinleatt1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinleatt1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinleatt1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt1 )
                                {
                                    $imagenpr2 = $collarinleatt1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinleatt1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinleatt1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt1 )
                                {
                                    $imagenpr3 = $collarinleatt1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinleatt1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinleatt1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt1 )
                                {
                                    $imagenpr4 = $collarinleatt1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinleatt1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinleatt1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinleatt1 )
                            {
                                $descripcion = $collarinleatt1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
