<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinleatt3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | LEATT GPX 5.5 NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinleatt3 )
                    {
                        $titulo = $collarinleatt3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinleatt3 )
                            {
                                $portada = $collarinleatt3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinleatt3 )
                                        {
                                            $precio = $collarinleatt3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinleatt3 )
                                        {
                                            $valoracion = $collarinleatt3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/protecciones-de-cross_c15/collarines_c30/collarin-leatt-gpx-55-naranja_pid-PM-2403702" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt3 )
                                {
                                    $imagenpr1 = $collarinleatt3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinleatt3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinleatt3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt3 )
                                {
                                    $imagenpr2 = $collarinleatt3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinleatt3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinleatt3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt3 )
                                {
                                    $imagenpr3 = $collarinleatt3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinleatt3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinleatt3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt3 )
                                {
                                    $imagenpr4 = $collarinleatt3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinleatt3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinleatt3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinleatt3 )
                            {
                                $descripcion = $collarinleatt3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
