<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinleatt4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | LEATT GPX 5.5 AZUL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinleatt4 )
                    {
                        $titulo = $collarinleatt4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinleatt4 )
                            {
                                $portada = $collarinleatt4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinleatt4 )
                                        {
                                            $precio = $collarinleatt4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinleatt4 )
                                        {
                                            $valoracion = $collarinleatt4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/protecciones-de-cross_c15/collarines_c30/collarin-leatt-gpx-55-azul-royal_pid-PM-4899212" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt4 )
                                {
                                    $imagenpr1 = $collarinleatt4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinleatt4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinleatt4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt4 )
                                {
                                    $imagenpr2 = $collarinleatt4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinleatt4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinleatt4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt4 )
                                {
                                    $imagenpr3 = $collarinleatt4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinleatt4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinleatt4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt4 )
                                {
                                    $imagenpr4 = $collarinleatt4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinleatt4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinleatt4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinleatt4 )
                            {
                                $descripcion = $collarinleatt4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
