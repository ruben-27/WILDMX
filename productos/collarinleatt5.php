<?php
    ...
    $datos3 = $doc->getElementsByTagName("collarinleatt5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | LEATT GPX 5.5 LIMA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $collarinleatt5 )
                    {
                        $titulo = $collarinleatt5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $collarinleatt5 )
                            {
                                $portada = $collarinleatt5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $collarinleatt5 )
                                        {
                                            $precio = $collarinleatt5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $collarinleatt5 )
                                        {
                                            $valoracion = $collarinleatt5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/protecciones-de-cross_c15/collarines_c30/collarin-leatt-gpx-55-lima_pid-PM-2403700" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt5 )
                                {
                                    $imagenpr1 = $collarinleatt5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $collarinleatt5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $collarinleatt5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt5 )
                                {
                                    $imagenpr2 = $collarinleatt5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $collarinleatt5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $collarinleatt5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt5 )
                                {
                                    $imagenpr3 = $collarinleatt5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $collarinleatt5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $collarinleatt5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $collarinleatt5 )
                                {
                                    $imagenpr4 = $collarinleatt5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $collarinleatt5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $collarinleatt5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $collarinleatt5 )
                            {
                                $descripcion = $collarinleatt5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
