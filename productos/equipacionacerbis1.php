<?php
    ...
    $datos = $doc->getElementsByTagName("acerbis1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS START & FINISH</title>
            ...
            <tr>
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-acerbis-start--finish-blanco-negro_pid-PP-4905535" target="_blank">
                                    <div>
