<?php
    ...
    $datos = $doc->getElementsByTagName("acerbis2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS X-FLEX</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $acerbis2 )
                    {
                        $titulo = $acerbis2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $acerbis2 )
                            {
                                $portada = $acerbis2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $acerbis2 )
                                        {
                                            $precio = $acerbis2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $acerbis2 )
                                        {
                                            $valoracion = $acerbis2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-acerbis-x-flex-vega-rojo-blanco_pid-PP-4898112" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $acerbis2 )
                                {
                                    $imagenpr1 = $acerbis2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $acerbis2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $acerbis2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis2 )
                                {
                                    $imagenpr2 = $acerbis2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $acerbis2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $acerbis2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis2 )
                                {
                                    $imagenpr3 = $acerbis2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $acerbis2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $acerbis2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis2 )
                                {
                                    $imagenpr4 = $acerbis2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $acerbis2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $acerbis2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $acerbis2 )
                            {
                                $descripcion = $acerbis2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
