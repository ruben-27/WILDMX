<?php
    ...
    $datos = $doc->getElementsByTagName("acerbis3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS STARWAY X-FLEX</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $acerbis3 )
                    {
                        $titulo = $acerbis3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $acerbis3 )
                            {
                                $portada = $acerbis3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $acerbis3 )
                                        {
                                            $precio = $acerbis3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $acerbis3 )
                                        {
                                            $valoracion = $acerbis3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-acerbis-starway-x-flex_pid-PP-4905533" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $acerbis3 )
                                {
                                    $imagenpr1 = $acerbis3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $acerbis3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $acerbis3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis3 )
                                {
                                    $imagenpr2 = $acerbis3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $acerbis3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $acerbis3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis3 )
                                {
                                    $imagenpr3 = $acerbis3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $acerbis3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $acerbis3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis3 )
                                {
                                    $imagenpr4 = $acerbis3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $acerbis3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $acerbis3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $acerbis3 )
                            {
                                $descripcion = $acerbis3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
