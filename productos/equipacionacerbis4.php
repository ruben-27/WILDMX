<?php
    ...
    $datos = $doc->getElementsByTagName("acerbis4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS HELIOS VENTED</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $acerbis4 )
                    {
                        $titulo = $acerbis4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $acerbis4 )
                            {
                                $portada = $acerbis4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $acerbis4 )
                                        {
                                            $precio = $acerbis4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $acerbis4 )
                                        {
                                            $valoracion = $acerbis4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-acerbis-helios-vented_pid-PP-4905527" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $acerbis4 )
                                {
                                    $imagenpr1 = $acerbis4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $acerbis4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $acerbis4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis4 )
                                {
                                    $imagenpr2 = $acerbis4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $acerbis4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $acerbis4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis4 )
                                {
                                    $imagenpr3 = $acerbis4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $acerbis4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $acerbis4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis4 )
                                {
                                    $imagenpr4 = $acerbis4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $acerbis4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $acerbis4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $acerbis4 )
                            {
                                $descripcion = $acerbis4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
