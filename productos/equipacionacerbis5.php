<?php
    ...
    $datos = $doc->getElementsByTagName("acerbis5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ACERBIS ARCTURIAN SPECIAL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $acerbis5 )
                    {
                        $titulo = $acerbis5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $acerbis5 )
                            {
                                $portada = $acerbis5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $acerbis5 )
                                        {
                                            $precio = $acerbis5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $acerbis5 )
                                        {
                                            $valoracion = $acerbis5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-acerbis-arcturian-special-naranja-negro_pid-PP-4898113" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $acerbis5 )
                                {
                                    $imagenpr1 = $acerbis5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $acerbis5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $acerbis5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis5 )
                                {
                                    $imagenpr2 = $acerbis5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $acerbis5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $acerbis5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis5 )
                                {
                                    $imagenpr3 = $acerbis5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $acerbis5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $acerbis5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $acerbis5 )
                                {
                                    $imagenpr4 = $acerbis5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $acerbis5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $acerbis5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $acerbis5 )
                            {
                                $descripcion = $acerbis5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
