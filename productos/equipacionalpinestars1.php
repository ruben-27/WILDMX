<?php
    ...
    $datos = $doc->getElementsByTagName("alpi1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS RACER TACTICAL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $alpi1 )
                    {
                        $titulo = $alpi1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $alpi1 )
                            {
                                $portada = $alpi1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $alpi1 )
                                        {
                                            $precio = $alpi1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $alpi1 )
                                        {
                                            $valoracion = $alpi1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-alpinestars-racer-tactical-negro-gris-camo-amarillo-fluo_pid-PP-4901980" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $alpi1 )
                                {
                                    $imagenpr1 = $alpi1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $alpi1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $alpi1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi1 )
                                {
                                    $imagenpr2 = $alpi1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $alpi1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $alpi1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi1 )
                                {
                                    $imagenpr3 = $alpi1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $alpi1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $alpi1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi1 )
                                {
                                    $imagenpr4 = $alpi1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $alpi1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $alpi1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $alpi1 )
                            {
                                $descripcion = $alpi1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
