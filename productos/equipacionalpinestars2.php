<?php
    ...
    $datos = $doc->getElementsByTagName("alpi2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS RAPTOR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $alpi2 )
                    {
                        $titulo = $alpi2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $alpi2 )
                            {
                                $portada = $alpi2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $alpi2 )
                                        {
                                            $precio = $alpi2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $alpi2 )
                                        {
                                            $valoracion = $alpi2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-alpinestars-raptor-negro-gris-verde_pid-PP-4901929" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $alpi2 )
                                {
                                    $imagenpr1 = $alpi2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $alpi2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $alpi2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi2 )
                                {
                                    $imagenpr2 = $alpi2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $alpi2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $alpi2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi2 )
                                {
                                    $imagenpr3 = $alpi2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $alpi2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $alpi2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi2 )
                                {
                                    $imagenpr4 = $alpi2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $alpi2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $alpi2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $alpi2 )
                            {
                                $descripcion = $alpi2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
