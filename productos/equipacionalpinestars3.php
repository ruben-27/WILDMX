<?php
    ...
    $datos = $doc->getElementsByTagName("alpi3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS TECHSTAR</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $alpi3 )
                    {
                        $titulo = $alpi3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $alpi3 )
                            {
                                $portada = $alpi3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $alpi3 )
                                        {
                                            $precio = $alpi3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $alpi3 )
                                        {
                                            $valoracion = $alpi3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-alpinestars-techstar-venom-rojo-amarillo-antracita_pid-PP-085674" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $alpi3 )
                                {
                                    $imagenpr1 = $alpi3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $alpi3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $alpi3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi3 )
                                {
                                    $imagenpr2 = $alpi3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $alpi3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $alpi3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi3 )
                                {
                                    $imagenpr3 = $alpi3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $alpi3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $alpi3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi3 )
                                {
                                    $imagenpr4 = $alpi3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $alpi3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $alpi3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $alpi3 )
                            {
                                $descripcion = $alpi3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
