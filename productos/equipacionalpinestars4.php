<?php
    ...
    $datos = $doc->getElementsByTagName("alpi4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS TECHSTAR FACTORY</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $alpi4 )
                    {
                        $titulo = $alpi4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $alpi4 )
                            {
                                $portada = $alpi4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $alpi4 )
                                        {
                                            $precio = $alpi4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $alpi4 )
                                        {
                                            $valoracion = $alpi4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-alpinestars-techstar-factory-negro-amarillo-fluo-rojo_pid-PP-4901975" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $alpi4 )
                                {
                                    $imagenpr1 = $alpi4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $alpi4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $alpi4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi4 )
                                {
                                    $imagenpr2 = $alpi4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $alpi4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $alpi4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi4 )
                                {
                                    $imagenpr3 = $alpi4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $alpi4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $alpi4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi4 )
                                {
                                    $imagenpr4 = $alpi4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $alpi4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $alpi4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $alpi4 )
                            {
                                $descripcion = $alpi4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
