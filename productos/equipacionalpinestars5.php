<?php
    ...
    $datos = $doc->getElementsByTagName("alpi5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS TECHSTAR VENOM</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $alpi5 )
                    {
                        $titulo = $alpi5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $alpi5 )
                            {
                                $portada = $alpi5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $alpi5 )
                                        {
                                            $precio = $alpi5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $alpi5 )
                                        {
                                            $valoracion = $alpi5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-alpinestars-techstar-venom-rojo-blanco-azul_pid-PP-2700151" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $alpi5 )
                                {
                                    $imagenpr1 = $alpi5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $alpi5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $alpi5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi5 )
                                {
                                    $imagenpr2 = $alpi5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $alpi5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $alpi5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi5 )
                                {
                                    $imagenpr3 = $alpi5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $alpi5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $alpi5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $alpi5 )
                                {
                                    $imagenpr4 = $alpi5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $alpi5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $alpi5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $alpi5 )
                            {
                                $descripcion = $alpi5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
