<?php
    $doc = new DOMDocument();
    $doc->load("../XML/datos2.xml");
    $datos = $doc->getElementsByTagName("flyracing1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING F-16</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $flyracing1 )
                    {
                        $titulo = $flyracing1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $flyracing1 )
                            {
                                $portada = $flyracing1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $flyracing1 )
                                        {
                                            $precio = $flyracing1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $flyracing1 )
                                        {
                                            $valoracion = $flyracing1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fly-racing-f-16-rosa-negro-hivis_pid-PP-4898184" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $flyracing1 )
                                {
                                    $imagenpr1 = $flyracing1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $flyracing1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $flyracing1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing1 )
                                {
                                    $imagenpr2 = $flyracing1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $flyracing1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $flyracing1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing1 )
                                {
                                    $imagenpr3 = $flyracing1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $flyracing1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $flyracing1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing1 )
                                {
                                    $imagenpr4 = $flyracing1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $flyracing1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $flyracing1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $flyracing1 )
                            {
                                $descripcion = $flyracing1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
