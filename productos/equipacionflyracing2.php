<?php
    ...
    $datos = $doc->getElementsByTagName("flyracing2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING LITE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $flyracing2 )
                    {
                        $titulo = $flyracing2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $flyracing2 )
                            {
                                $portada = $flyracing2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $flyracing2 )
                                        {
                                            $precio = $flyracing2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $flyracing2 )
                                        {
                                            $valoracion = $flyracing2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fly-racing-lite-azul-negro-hivis_pid-PP-4898199" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $flyracing2 )
                                {
                                    $imagenpr1 = $flyracing2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $flyracing2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $flyracing2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing2 )
                                {
                                    $imagenpr2 = $flyracing2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $flyracing2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $flyracing2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing2 )
                                {
                                    $imagenpr3 = $flyracing2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $flyracing2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $flyracing2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing2 )
                                {
                                    $imagenpr4 = $flyracing2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $flyracing2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $flyracing2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $flyracing2 )
                            {
                                $descripcion = $flyracing2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
