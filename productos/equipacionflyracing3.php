<?php
    ...
    $datos = $doc->getElementsByTagName("flyracing3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $flyracing3 )
                    {
                        $titulo = $flyracing3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $flyracing3 )
                            {
                                $portada = $flyracing3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $flyracing3 )
                                        {
                                            $precio = $flyracing3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $flyracing3 )
                                        {
                                            $valoracion = $flyracing3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fly-racing-lite-negro-blanco_pid-PP-4898201" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $flyracing3 )
                                {
                                    $imagenpr1 = $flyracing3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $flyracing3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $flyracing3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing3 )
                                {
                                    $imagenpr2 = $flyracing3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $flyracing3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $flyracing3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing3 )
                                {
                                    $imagenpr3 = $flyracing3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $flyracing3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $flyracing3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing3 )
                                {
                                    $imagenpr4 = $flyracing3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $flyracing3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $flyracing3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $flyracing3 )
                            {
                                $descripcion = $flyracing3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
