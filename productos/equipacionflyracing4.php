<?php
    ...
    $datos = $doc->getElementsByTagName("flyracing4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FLY RACING EVO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $flyracing4 )
                    {
                        $titulo = $flyracing4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $flyracing4 )
                            {
                                $portada = $flyracing4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $flyracing4 )
                                        {
                                            $precio = $flyracing4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $flyracing4 )
                                        {
                                            $valoracion = $flyracing4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fly-evo-azul-marino-gris-naranja_pid-PP-4898162" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $flyracing4 )
                                {
                                    $imagenpr1 = $flyracing4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $flyracing4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $flyracing4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing4 )
                                {
                                    $imagenpr2 = $flyracing4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $flyracing4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $flyracing4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing4 )
                                {
                                    $imagenpr3 = $flyracing4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $flyracing4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $flyracing4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing4 )
                                {
                                    $imagenpr4 = $flyracing4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $flyracing4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $flyracing4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $flyracing4 )
                            {
                                $descripcion = $flyracing4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
