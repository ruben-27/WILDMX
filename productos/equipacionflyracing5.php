<?php
    ...
    $datos = $doc->getElementsByTagName("flyracing5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $flyracing5 )
                    {
                        $titulo = $flyracing5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $flyracing5 )
                            {
                                $portada = $flyracing5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $flyracing5 )
                                        {
                                            $precio = $flyracing5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $flyracing5 )
                                        {
                                            $valoracion = $flyracing5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fly-lite-seafom-violeta-blanco_pid-PP-4898175" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $flyracing5 )
                                {
                                    $imagenpr1 = $flyracing5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $flyracing5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $flyracing5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing5 )
                                {
                                    $imagenpr2 = $flyracing5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $flyracing5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $flyracing5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing5 )
                                {
                                    $imagenpr3 = $flyracing5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $flyracing5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $flyracing5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $flyracing5 )
                                {
                                    $imagenpr4 = $flyracing5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $flyracing5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $flyracing5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $flyracing5 )
                            {
                                $descripcion = $flyracing5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
