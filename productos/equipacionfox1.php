<?php
    ...
    $datos = $doc->getElementsByTagName("fox1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX 360 VIZA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $fox1 )
                    {
                        $titulo = $fox1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $fox1 )
                            {
                                $portada = $fox1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $fox1 )
                                        {
                                            $precio = $fox1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $fox1 )
                                        {
                                            $valoracion = $fox1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fox-360-viza-azul-mx-18_pid-PP-4470207" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $fox1 )
                                {
                                    $imagenpr1 = $fox1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $fox1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $fox1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox1 )
                                {
                                    $imagenpr2 = $fox1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $fox1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $fox1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox1 )
                                {
                                    $imagenpr3 = $fox1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $fox1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $fox1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox1 )
                                {
                                    $imagenpr4 = $fox1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $fox1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $fox1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $fox1 )
                            {
                                $descripcion = $fox1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
