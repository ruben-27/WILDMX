<?php
    ...
    $datos = $doc->getElementsByTagName("fox2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX FLEXAIR PREEST</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $fox2 )
                    {
                        $titulo = $fox2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $fox2 )
                            {
                                $portada = $fox2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $fox2 )
                                        {
                                            $precio = $fox2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $fox2 )
                                        {
                                            $valoracion = $fox2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fox-flexair-preest-negro-dorado-mx-18_pid-PP-4470221" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $fox2 )
                                {
                                    $imagenpr1 = $fox2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $fox2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $fox2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox2 )
                                {
                                    $imagenpr2 = $fox2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $fox2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $fox2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox2 )
                                {
                                    $imagenpr3 = $fox2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $fox2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $fox2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox2 )
                                {
                                    $imagenpr4 = $fox2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $fox2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $fox2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $fox2 )
                            {
                                $descripcion = $fox2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
