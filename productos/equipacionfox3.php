<?php
    ...
    $datos = $doc->getElementsByTagName("fox3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX FLEXAIR HIFEYE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $fox3 )
                    {
                        $titulo = $fox3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $fox3 )
                            {
                                $portada = $fox3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $fox3 )
                                        {
                                            $precio = $fox3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $fox3 )
                                        {
                                            $valoracion = $fox3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fox-flexair-hifeye-naranja-azul-mx-18_pid-PP-4470218" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $fox3 )
                                {
                                    $imagenpr1 = $fox3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $fox3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $fox3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox3 )
                                {
                                    $imagenpr2 = $fox3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $fox3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $fox3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox3 )
                                {
                                    $imagenpr3 = $fox3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $fox3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $fox3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox3 )
                                {
                                    $imagenpr4 = $fox3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $fox3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $fox3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $fox3 )
                            {
                                $descripcion = $fox3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
