<?php
    ...
    $datos = $doc->getElementsByTagName("fox5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX 180 MATA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $fox5 )
                    {
                        $titulo = $fox5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $fox5 )
                            {
                                $portada = $fox5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $fox5 )
                                        {
                                            $precio = $fox5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $fox5 )
                                        {
                                            $valoracion = $fox5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-fox-180-mata-mujer-negro-rosa_pid-PP-4906082" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $fox5 )
                                {
                                    $imagenpr1 = $fox5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $fox5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $fox5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox5 )
                                {
                                    $imagenpr2 = $fox5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $fox5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $fox5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox5 )
                                {
                                    $imagenpr3 = $fox5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $fox5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $fox5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $fox5 )
                                {
                                    $imagenpr4 = $fox5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $fox5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $fox5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $fox5 )
                            {
                                $descripcion = $fox5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
