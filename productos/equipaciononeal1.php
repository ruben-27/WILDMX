<?php
    ...
    $datos = $doc->getElementsByTagName("oneal1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL ELEMENT IMPACT</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $oneal1 )
                    {
                        $titulo = $oneal1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $oneal1 )
                            {
                                $portada = $oneal1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $oneal1 )
                                        {
                                            $precio = $oneal1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $oneal1 )
                                        {
                                            $valoracion = $oneal1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-oneal-element-impact-negro-amarillo-neon_pid-PP-4886717" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $oneal1 )
                                {
                                    $imagenpr1 = $oneal1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $oneal1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $oneal1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal1 )
                                {
                                    $imagenpr2 = $oneal1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $oneal1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $oneal1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal1 )
                                {
                                    $imagenpr3 = $oneal1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $oneal1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $oneal1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal1 )
                                {
                                    $imagenpr4 = $oneal1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $oneal1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $oneal1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $oneal1 )
                            {
                                $descripcion = $oneal1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
