<?php
    ...
    $datos = $doc->getElementsByTagName("oneal2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL ELEMENT VILLAIN</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $oneal2 )
                    {
                        $titulo = $oneal2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $oneal2 )
                            {
                                $portada = $oneal2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $oneal2 )
                                        {
                                            $precio = $oneal2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $oneal2 )
                                        {
                                            $valoracion = $oneal2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-oneal-element-villain-amarillo-fluo_pid-PP-4886740" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $oneal2 )
                                {
                                    $imagenpr1 = $oneal2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $oneal2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $oneal2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal2 )
                                {
                                    $imagenpr2 = $oneal2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $oneal2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $oneal2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal2 )
                                {
                                    $imagenpr3 = $oneal2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $oneal2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $oneal2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal2 )
                                {
                                    $imagenpr4 = $oneal2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $oneal2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $oneal2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $oneal2 )
                            {
                                $descripcion = $oneal2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
