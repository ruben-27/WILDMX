<?php
    ...
    $datos = $doc->getElementsByTagName("oneal3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL MAYHEM CRACKLE 91</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $oneal3 )
                    {
                        $titulo = $oneal3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $oneal3 )
                            {
                                $portada = $oneal3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $oneal3 )
                                        {
                                            $precio = $oneal3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $oneal3 )
                                        {
                                            $valoracion = $oneal3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-oneal-mayhem-crackle-91-amarillo-blanco-azul_pid-PP-4886751" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $oneal3 )
                                {
                                    $imagenpr1 = $oneal3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $oneal3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $oneal3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal3 )
                                {
                                    $imagenpr2 = $oneal3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $oneal3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $oneal3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal3 )
                                {
                                    $imagenpr3 = $oneal3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $oneal3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $oneal3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal3 )
                                {
                                    $imagenpr4 = $oneal3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $oneal3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $oneal3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $oneal3 )
                            {
                                $descripcion = $oneal3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
