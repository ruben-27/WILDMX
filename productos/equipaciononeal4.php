<?php
    ...
    $datos = $doc->getElementsByTagName("oneal4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL MAYHEM RESEDA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $oneal4 )
                    {
                        $titulo = $oneal4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $oneal4 )
                            {
                                $portada = $oneal4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $oneal4 )
                                        {
                                            $precio = $oneal4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $oneal4 )
                                        {
                                            $valoracion = $oneal4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-oneal-mayhem-reseda-negro-beige_pid-PP-4886757" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $oneal4 )
                                {
                                    $imagenpr1 = $oneal4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $oneal4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $oneal4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal4 )
                                {
                                    $imagenpr2 = $oneal4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $oneal4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $oneal4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal4 )
                                {
                                    $imagenpr3 = $oneal4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $oneal4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $oneal4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal4 )
                                {
                                    $imagenpr4 = $oneal4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $oneal4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $oneal4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $oneal4 )
                            {
                                $descripcion = $oneal4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
