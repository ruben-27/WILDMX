<?php
    ...
    $datos = $doc->getElementsByTagName("oneal5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ONEAL ELEMENT WARHAWK</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $oneal5 )
                    {
                        $titulo = $oneal5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $oneal5 )
                            {
                                $portada = $oneal5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $oneal5 )
                                        {
                                            $precio = $oneal5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $oneal5 )
                                        {
                                            $valoracion = $oneal5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-oneal-element-warhawk-azul-rojo_pid-PP-4886734" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $oneal5 )
                                {
                                    $imagenpr1 = $oneal5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $oneal5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $oneal5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal5 )
                                {
                                    $imagenpr2 = $oneal5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $oneal5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $oneal5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal5 )
                                {
                                    $imagenpr3 = $oneal5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $oneal5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $oneal5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $oneal5 )
                                {
                                    $imagenpr4 = $oneal5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $oneal5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $oneal5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $oneal5 )
                            {
                                $descripcion = $oneal5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
