<?php
    ...
    $datos = $doc->getElementsByTagName("shot1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT ROCKSTAR 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $shot1 )
                    {
                        $titulo = $shot1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $shot1 )
                            {
                                $portada = $shot1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $shot1 )
                                        {
                                            $precio = $shot1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $shot1 )
                                        {
                                            $valoracion = $shot1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-shot-rockstar-2020_pid-PP-4905555" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $shot1 )
                                {
                                    $imagenpr1 = $shot1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $shot1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $shot1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot1 )
                                {
                                    $imagenpr2 = $shot1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $shot1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $shot1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot1 )
                                {
                                    $imagenpr3 = $shot1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $shot1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $shot1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot1 )
                                {
                                    $imagenpr4 = $shot1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $shot1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $shot1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $shot1 )
                            {
                                $descripcion = $shot1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
