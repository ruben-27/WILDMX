<?php
    ...
    $datos = $doc->getElementsByTagName("shot2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT DEVO VENTURY</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $shot2 )
                    {
                        $titulo = $shot2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $shot2 )
                            {
                                $portada = $shot2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $shot2 )
                                        {
                                            $precio = $shot2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $shot2 )
                                        {
                                            $valoracion = $shot2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-shot-devo-ventury-amarillo-fluo-cian_pid-PP-4905544" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $shot2 )
                                {
                                    $imagenpr1 = $shot2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $shot2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $shot2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot2 )
                                {
                                    $imagenpr2 = $shot2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $shot2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $shot2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot2 )
                                {
                                    $imagenpr3 = $shot2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $shot2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $shot2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot2 )
                                {
                                    $imagenpr4 = $shot2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $shot2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $shot2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $shot2 )
                            {
                                $descripcion = $shot2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
