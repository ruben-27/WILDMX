<?php
    ...
    $datos = $doc->getElementsByTagName("shot3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT DEVO SQUAD</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $shot3 )
                    {
                        $titulo = $shot3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $shot3 )
                            {
                                $portada = $shot3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $shot3 )
                                        {
                                            $precio = $shot3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $shot3 )
                                        {
                                            $valoracion = $shot3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-shot-devo-squad-lima-rosa_pid-PP-081445" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $shot3 )
                                {
                                    $imagenpr1 = $shot3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $shot3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $shot3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot3 )
                                {
                                    $imagenpr2 = $shot3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $shot3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $shot3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot3 )
                                {
                                    $imagenpr3 = $shot3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $shot3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $shot3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot3 )
                                {
                                    $imagenpr4 = $shot3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $shot3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $shot3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $shot3 )
                            {
                                $descripcion = $shot3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
