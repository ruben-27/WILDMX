<?php
    ...
    $datos = $doc->getElementsByTagName("shot4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT AEROLITE ALPHA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $shot4 )
                    {
                        $titulo = $shot4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $shot4 )
                            {
                                $portada = $shot4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $shot4 )
                                        {
                                            $precio = $shot4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $shot4 )
                                        {
                                            $valoracion = $shot4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-shot-aerolite-alpha-negro-dorado_pid-PP-4905562" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $shot4 )
                                {
                                    $imagenpr1 = $shot4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $shot4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $shot4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot4 )
                                {
                                    $imagenpr2 = $shot4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $shot4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $shot4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot4 )
                                {
                                    $imagenpr3 = $shot4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $shot4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $shot4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot4 )
                                {
                                    $imagenpr4 = $shot4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $shot4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $shot4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $shot4 )
                            {
                                $descripcion = $shot4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
