<?php
    ...
    $datos = $doc->getElementsByTagName("shot5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SHOT CONTACT SHADOW</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $shot5 )
                    {
                        $titulo = $shot5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $shot5 )
                            {
                                $portada = $shot5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $shot5 )
                                        {
                                            $precio = $shot5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $shot5 )
                                        {
                                            $valoracion = $shot5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/ropa-de-cross_c299/trajes-de-cross_c304/traje-de-cross-shot-contact-shadow-rojo-blanco_pid-PP-4905553" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $shot5 )
                                {
                                    $imagenpr1 = $shot5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $shot5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $shot5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot5 )
                                {
                                    $imagenpr2 = $shot5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $shot5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $shot5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot5 )
                                {
                                    $imagenpr3 = $shot5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $shot5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $shot5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $shot5 )
                                {
                                    $imagenpr4 = $shot5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $shot5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $shot5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $shot5 )
                            {
                                $descripcion = $shot5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
