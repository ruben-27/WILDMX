<?php
    ...
    $datos = $doc->getElementsByTagName("gafas1001");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% RACECRAFT TANAKA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafas1001 )
                    {
                        $titulo = $gafas1001->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafas1001 )
                            {
                                $portada = $gafas1001->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafas1001 )
                                        {
                                            $precio = $gafas1001->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafas1001 )
                                        {
                                            $valoracion = $gafas1001->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/246945-gafas-100-racecraft-tanaka-lente-espejo-dorado-26012138.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafas1001 )
                                {
                                    $imagenpr1 = $gafas1001->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafas1001->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafas1001->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1001 )
                                {
                                    $imagenpr2 = $gafas1001->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafas1001->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafas1001->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1001 )
                                {
                                    $imagenpr3 = $gafas1001->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafas1001->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafas1001->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1001 )
                                {
                                    $imagenpr4 = $gafas1001->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafas1001->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafas1001->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafas1001 )
                            {
                                $descripcion = $gafas1001->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
