<?php
    ...
    $datos = $doc->getElementsByTagName("gafas1002");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% STRATA OUTLAW</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafas1002 )
                    {
                        $titulo = $gafas1002->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafas1002 )
                            {
                                $portada = $gafas1002->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafas1002 )
                                        {
                                            $precio = $gafas1002->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafas1002 )
                                        {
                                            $valoracion = $gafas1002->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/372450-gafas-100-strata-furnace-lente-espejo-rojo-26012418.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafas1002 )
                                {
                                    $imagenpr1 = $gafas1002->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafas1002->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafas1002->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1002 )
                                {
                                    $imagenpr2 = $gafas1002->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafas1002->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafas1002->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1002 )
                                {
                                    $imagenpr3 = $gafas1002->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafas1002->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafas1002->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1002 )
                                {
                                    $imagenpr4 = $gafas1002->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafas1002->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafas1002->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafas1002 )
                            {
                                $descripcion = $gafas1002->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
