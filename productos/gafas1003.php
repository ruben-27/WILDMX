<?php
    ...
    $datos = $doc->getElementsByTagName("gafas1003");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% ACCURI GASPARD</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafas1003 )
                    {
                        $titulo = $gafas1003->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafas1003 )
                            {
                                $portada = $gafas1003->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafas1003 )
                                        {
                                            $precio = $gafas1003->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafas1003 )
                                        {
                                            $valoracion = $gafas1003->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/365397-gafas-100-accuri-gaspard-lente-transparente-26012485.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafas1003 )
                                {
                                    $imagenpr1 = $gafas1003->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafas1003->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafas1003->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1003 )
                                {
                                    $imagenpr2 = $gafas1003->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafas1003->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafas1003->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1003 )
                                {
                                    $imagenpr3 = $gafas1003->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafas1003->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafas1003->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1003 )
                                {
                                    $imagenpr4 = $gafas1003->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafas1003->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafas1003->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafas1003 )
                            {
                                $descripcion = $gafas1003->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
