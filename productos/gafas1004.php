<?php
    ...
    $datos = $doc->getElementsByTagName("gafas1004");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% RACECRAFT PINACLES</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafas1004 )
                    {
                        $titulo = $gafas1004->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafas1004 )
                            {
                                $portada = $gafas1004->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafas1004 )
                                        {
                                            $precio = $gafas1004->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafas1004 )
                                        {
                                            $valoracion = $gafas1004->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/388001-gafas-100-racecraft-pinacles-lente-transparente-26012733.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafas1004 )
                                {
                                    $imagenpr1 = $gafas1004->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafas1004->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafas1004->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1004 )
                                {
                                    $imagenpr2 = $gafas1004->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafas1004->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafas1004->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1004 )
                                {
                                    $imagenpr3 = $gafas1004->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafas1004->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafas1004->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1004 )
                                {
                                    $imagenpr4 = $gafas1004->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafas1004->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafas1004->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafas1004 )
                            {
                                $descripcion = $gafas1004->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
