<?php
    ...
    $datos = $doc->getElementsByTagName("gafas1005");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% STRATA SLASH</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafas1005 )
                    {
                        $titulo = $gafas1005->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafas1005 )
                            {
                                $portada = $gafas1005->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafas1005 )
                                        {
                                            $precio = $gafas1005->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafas1005 )
                                        {
                                            $valoracion = $gafas1005->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/192425-gafas-100-strata-slash-26011744.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafas1005 )
                                {
                                    $imagenpr1 = $gafas1005->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafas1005->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafas1005->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1005 )
                                {
                                    $imagenpr2 = $gafas1005->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafas1005->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafas1005->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1005 )
                                {
                                    $imagenpr3 = $gafas1005->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafas1005->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafas1005->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafas1005 )
                                {
                                    $imagenpr4 = $gafas1005->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafas1005->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafas1005->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafas1005 )
                            {
                                $descripcion = $gafas1005->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
