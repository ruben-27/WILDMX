<?php
    ...
    $datos = $doc->getElementsByTagName("gafasfox2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX MAIN II RACE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasfox2 )
                    {
                        $titulo = $gafasfox2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasfox2 )
                            {
                                $portada = $gafasfox2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasfox2 )
                                        {
                                            $precio = $gafasfox2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasfox2 )
                                        {
                                            $valoracion = $gafasfox2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/380483-gafas-fox-main-ii-gain-2020-color-gris-lente-espejo-spark-23996-006-os.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasfox2 )
                                {
                                    $imagenpr1 = $gafasfox2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfox2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfox2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox2 )
                                {
                                    $imagenpr2 = $gafasfox2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfox2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfox2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox2 )
                                {
                                    $imagenpr3 = $gafasfox2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfox2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfox2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox2 )
                                {
                                    $imagenpr4 = $gafasfox2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfox2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfox2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasfox2 )
                            {
                                $descripcion = $gafasfox2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
