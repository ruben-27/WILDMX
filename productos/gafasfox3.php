<?php
    ...
    $datos = $doc->getElementsByTagName("gafasfox3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX MAIN BNKZ</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasfox3 )
                    {
                        $titulo = $gafasfox3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasfox3 )
                            {
                                $portada = $gafasfox3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasfox3 )
                                        {
                                            $precio = $gafasfox3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasfox3 )
                                        {
                                            $valoracion = $gafasfox3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/391731-gafas-fox-main-edicion-especial-bnkz-2020-24876-006-os.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasfox3 )
                                {
                                    $imagenpr1 = $gafasfox3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfox3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfox3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox3 )
                                {
                                    $imagenpr2 = $gafasfox3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfox3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfox3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox3 )
                                {
                                    $imagenpr3 = $gafasfox3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfox3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfox3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox3 )
                                {
                                    $imagenpr4 = $gafasfox3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfox3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfox3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasfox3 )
                            {
                                $descripcion = $gafasfox3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
