<?php
    ...
    $datos = $doc->getElementsByTagName("gafasfox4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasfox4 )
                    {
                        $titulo = $gafasfox4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasfox4 )
                            {
                                $portada = $gafasfox4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasfox4 )
                                        {
                                            $precio = $gafasfox4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasfox4 )
                                        {
                                            $valoracion = $gafasfox4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/380477-gafas-fox-vue-dusc-2020-color-azul-marino-23987-007-os.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasfox4 )
                                {
                                    $imagenpr1 = $gafasfox4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfox4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfox4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox4 )
                                {
                                    $imagenpr2 = $gafasfox4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfox4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfox4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox4 )
                                {
                                    $imagenpr3 = $gafasfox4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfox4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfox4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox4 )
                                {
                                    $imagenpr4 = $gafasfox4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfox4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfox4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasfox4 )
                            {
                                $descripcion = $gafasfox4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
