<?php
    ...
    $datos = $doc->getElementsByTagName("gafasfox5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX MAIN II GAIN</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasfox5 )
                    {
                        $titulo = $gafasfox5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasfox5 )
                            {
                                $portada = $gafasfox5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasfox5 )
                                        {
                                            $precio = $gafasfox5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasfox5 )
                                        {
                                            $valoracion = $gafasfox5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/380497-gafas-fox-main-ii-race-2020-color-rosa-24001-170-os.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasfox5 )
                                {
                                    $imagenpr1 = $gafasfox5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfox5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfox5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox5 )
                                {
                                    $imagenpr2 = $gafasfox5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfox5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfox5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox5 )
                                {
                                    $imagenpr3 = $gafasfox5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfox5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfox5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasfox5 )
                                {
                                    $imagenpr4 = $gafasfox5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfox5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfox5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasfox5 )
                            {
                                $descripcion = $gafasfox5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
