<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasfxr1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FXR MAVERICK NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasfxr1 )
                    {
                        $titulo = $gafasfxr1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasfxr1 )
                            {
                                $portada = $gafasfxr1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasfxr1 )
                                        {
                                            $precio = $gafasfxr1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasfxr1 )
                                        {
                                            $valoracion = $gafasfxr1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-fxr-maverick-naranjas_pid-PIA-124051" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr1 )
                                {
                                    $imagenpr1 = $gafasfxr1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfxr1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfxr1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr1 )
                                {
                                    $imagenpr2 = $gafasfxr1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfxr1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfxr1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr1 )
                                {
                                    $imagenpr3 = $gafasfxr1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfxr1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfxr1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr1 )
                                {
                                    $imagenpr4 = $gafasfxr1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfxr1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfxr1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasfxr1 )
                            {
                                $descripcion = $gafasfxr1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
