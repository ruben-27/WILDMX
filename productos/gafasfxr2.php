<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasfxr2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FXR MAVERICK AZUL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasfxr2 )
                    {
                        $titulo = $gafasfxr2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasfxr2 )
                            {
                                $portada = $gafasfxr2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasfxr2 )
                                        {
                                            $precio = $gafasfxr2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasfxr2 )
                                        {
                                            $valoracion = $gafasfxr2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-fxr-maverick-azul-claro-azul-oscuro_pid-PIA-124053" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr2 )
                                {
                                    $imagenpr1 = $gafasfxr2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfxr2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfxr2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr2 )
                                {
                                    $imagenpr2 = $gafasfxr2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfxr2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfxr2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr2 )
                                {
                                    $imagenpr3 = $gafasfxr2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfxr2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfxr2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr2 )
                                {
                                    $imagenpr4 = $gafasfxr2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfxr2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfxr2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasfxr2 )
                            {
                                $descripcion = $gafasfxr2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
