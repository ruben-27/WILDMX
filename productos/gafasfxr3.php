<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasfxr3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FXR THROTTLE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasfxr3 )
                    {
                        $titulo = $gafasfxr3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasfxr3 )
                            {
                                $portada = $gafasfxr3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasfxr3 )
                                        {
                                            $precio = $gafasfxr3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasfxr3 )
                                        {
                                            $valoracion = $gafasfxr3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-fxr-throttle-black-ops_pid-PIA-124059" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr3 )
                                {
                                    $imagenpr1 = $gafasfxr3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfxr3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfxr3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr3 )
                                {
                                    $imagenpr2 = $gafasfxr3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfxr3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfxr3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr3 )
                                {
                                    $imagenpr3 = $gafasfxr3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfxr3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfxr3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr3 )
                                {
                                    $imagenpr4 = $gafasfxr3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfxr3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfxr3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasfxr3 )
                            {
                                $descripcion = $gafasfxr3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
