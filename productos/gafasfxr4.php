<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasfxr4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FXR MAVERICK ROJAS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasfxr4 )
                    {
                        $titulo = $gafasfxr4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasfxr4 )
                            {
                                $portada = $gafasfxr4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasfxr4 )
                                        {
                                            $precio = $gafasfxr4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasfxr4 )
                                        {
                                            $valoracion = $gafasfxr4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-fxr-maverick-rojas_pid-PIA-124052" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr4 )
                                {
                                    $imagenpr1 = $gafasfxr4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfxr4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfxr4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr4 )
                                {
                                    $imagenpr2 = $gafasfxr4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfxr4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfxr4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr4 )
                                {
                                    $imagenpr3 = $gafasfxr4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfxr4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfxr4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr4 )
                                {
                                    $imagenpr4 = $gafasfxr4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfxr4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfxr4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasfxr4 )
                            {
                                $descripcion = $gafasfxr4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
