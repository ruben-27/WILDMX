<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasfxr5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasfxr5 )
                    {
                        $titulo = $gafasfxr5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasfxr5 )
                            {
                                $portada = $gafasfxr5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasfxr5 )
                                        {
                                            $precio = $gafasfxr5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasfxr5 )
                                        {
                                            $valoracion = $gafasfxr5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-fxr-core-negro-amarillo_pid-PIA-124046" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr5 )
                                {
                                    $imagenpr1 = $gafasfxr5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasfxr5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasfxr5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr5 )
                                {
                                    $imagenpr2 = $gafasfxr5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasfxr5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasfxr5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr5 )
                                {
                                    $imagenpr3 = $gafasfxr5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasfxr5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasfxr5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasfxr5 )
                                {
                                    $imagenpr4 = $gafasfxr5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasfxr5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasfxr5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasfxr5 )
                            {
                                $descripcion = $gafasfxr5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
