<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasjust11");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | JUST1 IRIS VERDE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasjust11 )
                    {
                        $titulo = $gafasjust11->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasjust11 )
                            {
                                $portada = $gafasjust11->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasjust11 )
                                        {
                                            $precio = $gafasjust11->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasjust11 )
                                        {
                                            $valoracion = $gafasjust11->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-just1-iris-verdes_pid-PIA-91204" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust11 )
                                {
                                    $imagenpr1 = $gafasjust11->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasjust11->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasjust11->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust11 )
                                {
                                    $imagenpr2 = $gafasjust11->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasjust11->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasjust11->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust11 )
                                {
                                    $imagenpr3 = $gafasjust11->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasjust11->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasjust11->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust11 )
                                {
                                    $imagenpr4 = $gafasjust11->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasjust11->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasjust11->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasjust11 )
                            {
                                $descripcion = $gafasjust11->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
