<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasjust13");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | JUST1 IRIS AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasjust13 )
                    {
                        $titulo = $gafasjust13->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasjust13 )
                            {
                                $portada = $gafasjust13->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasjust13 )
                                        {
                                            $precio = $gafasjust13->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasjust13 )
                                        {
                                            $valoracion = $gafasjust13->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-just1-iris-amarillo-neon_pid-PIA-91211" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust13 )
                                {
                                    $imagenpr1 = $gafasjust13->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasjust13->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasjust13->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust13 )
                                {
                                    $imagenpr2 = $gafasjust13->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasjust13->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasjust13->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust13 )
                                {
                                    $imagenpr3 = $gafasjust13->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasjust13->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasjust13->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust13 )
                                {
                                    $imagenpr4 = $gafasjust13->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasjust13->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasjust13->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasjust13 )
                            {
                                $descripcion = $gafasjust13->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
