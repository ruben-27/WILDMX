<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasjust14");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | JUST1 IRIS M2</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasjust14 )
                    {
                        $titulo = $gafasjust14->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasjust14 )
                            {
                                $portada = $gafasjust14->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasjust14 )
                                        {
                                            $precio = $gafasjust14->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasjust14 )
                                        {
                                            $valoracion = $gafasjust14->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-just1-iris-m2_pid-PIA-91209" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust14 )
                                {
                                    $imagenpr1 = $gafasjust14->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasjust14->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasjust14->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust14 )
                                {
                                    $imagenpr2 = $gafasjust14->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasjust14->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasjust14->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust14 )
                                {
                                    $imagenpr3 = $gafasjust14->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasjust14->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasjust14->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasjust14 )
                                {
                                    $imagenpr4 = $gafasjust14->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasjust14->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasjust14->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasjust14 )
                            {
                                $descripcion = $gafasjust14->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
