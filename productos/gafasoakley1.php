<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasoakley1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | OAKLEY FRONT LINE MX</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasoakley1 )
                    {
                        $titulo = $gafasoakley1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasoakley1 )
                            {
                                $portada = $gafasoakley1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasoakley1 )
                                        {
                                            $precio = $gafasoakley1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasoakley1 )
                                        {
                                            $valoracion = $gafasoakley1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-oakley-front-line-mx-blanco-mate-speed-roll-off_pid-670-7087-08" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley1 )
                                {
                                    $imagenpr1 = $gafasoakley1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasoakley1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasoakley1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley1 )
                                {
                                    $imagenpr2 = $gafasoakley1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasoakley1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasoakley1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley1 )
                                {
                                    $imagenpr3 = $gafasoakley1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasoakley1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasoakley1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley1 )
                                {
                                    $imagenpr4 = $gafasoakley1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasoakley1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasoakley1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasoakley1 )
                            {
                                $descripcion = $gafasoakley1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
