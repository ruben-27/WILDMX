<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasoakley2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasoakley2 )
                    {
                        $titulo = $gafasoakley2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasoakley2 )
                            {
                                $portada = $gafasoakley2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasoakley2 )
                                        {
                                            $precio = $gafasoakley2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasoakley2 )
                                        {
                                            $valoracion = $gafasoakley2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-oakley-o-frame-20-dissolve-naranja-azul_pid-PIA-78312" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley2 )
                                {
                                    $imagenpr1 = $gafasoakley2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasoakley2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasoakley2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley2 )
                                {
                                    $imagenpr2 = $gafasoakley2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasoakley2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasoakley2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley2 )
                                {
                                    $imagenpr3 = $gafasoakley2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasoakley2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasoakley2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley2 )
                                {
                                    $imagenpr4 = $gafasoakley2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasoakley2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasoakley2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasoakley2 )
                            {
                                $descripcion = $gafasoakley2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
