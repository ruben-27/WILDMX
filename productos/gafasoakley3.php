<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasoakley3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | OAKLEY O-FRAME CIRCUIT</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasoakley3 )
                    {
                        $titulo = $gafasoakley3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasoakley3 )
                            {
                                $portada = $gafasoakley3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasoakley3 )
                                        {
                                            $precio = $gafasoakley3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasoakley3 )
                                        {
                                            $valoracion = $gafasoakley3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-oakley-o-frame-circuit-amarillo-azul-negro_pid-PIA-78183" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley3 )
                                {
                                    $imagenpr1 = $gafasoakley3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasoakley3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasoakley3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley3 )
                                {
                                    $imagenpr2 = $gafasoakley3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasoakley3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasoakley3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley3 )
                                {
                                    $imagenpr3 = $gafasoakley3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasoakley3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasoakley3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley3 )
                                {
                                    $imagenpr4 = $gafasoakley3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasoakley3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasoakley3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasoakley3 )
                            {
                                $descripcion = $gafasoakley3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
