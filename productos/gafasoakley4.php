<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasoakley4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | OAKLEY O-FRAME 2.0</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasoakley4 )
                    {
                        $titulo = $gafasoakley4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasoakley4 )
                            {
                                $portada = $gafasoakley4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasoakley4 )
                                        {
                                            $precio = $gafasoakley4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasoakley4 )
                                        {
                                            $valoracion = $gafasoakley4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-oakley-o-frame-20-dissolve-rosa-amarillo_pid-PIA-78311" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley4 )
                                {
                                    $imagenpr1 = $gafasoakley4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasoakley4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasoakley4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley4 )
                                {
                                    $imagenpr2 = $gafasoakley4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasoakley4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasoakley4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley4 )
                                {
                                    $imagenpr3 = $gafasoakley4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasoakley4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasoakley4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley4 )
                                {
                                    $imagenpr4 = $gafasoakley4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasoakley4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasoakley4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasoakley4 )
                            {
                                $descripcion = $gafasoakley4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
