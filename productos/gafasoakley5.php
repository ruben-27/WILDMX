<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasoakley5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | OAKLEY O2 RACE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasoakley5 )
                    {
                        $titulo = $gafasoakley5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasoakley5 )
                            {
                                $portada = $gafasoakley5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasoakley5 )
                                        {
                                            $precio = $gafasoakley5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasoakley5 )
                                        {
                                            $valoracion = $gafasoakley5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-oakley-o2-race-ready-roll-off-blanco-mate_pid-670-0046" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley5 )
                                {
                                    $imagenpr1 = $gafasoakley5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasoakley5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasoakley5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley5 )
                                {
                                    $imagenpr2 = $gafasoakley5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasoakley5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasoakley5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley5 )
                                {
                                    $imagenpr3 = $gafasoakley5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasoakley5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasoakley5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasoakley5 )
                                {
                                    $imagenpr4 = $gafasoakley5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasoakley5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasoakley5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasoakley5 )
                            {
                                $descripcion = $gafasoakley5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
