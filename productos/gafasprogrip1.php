<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasprogrip1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | PROGRIP 3318 VISTA BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasprogrip1 )
                    {
                        $titulo = $gafasprogrip1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasprogrip1 )
                            {
                                $portada = $gafasprogrip1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasprogrip1 )
                                        {
                                            $precio = $gafasprogrip1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasprogrip1 )
                                        {
                                            $valoracion = $gafasprogrip1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-progrip-3318-vista-roll-off-xl-blancas_pid-PZ3318BI18" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip1 )
                                {
                                    $imagenpr1 = $gafasprogrip1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasprogrip1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasprogrip1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip1 )
                                {
                                    $imagenpr2 = $gafasprogrip1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasprogrip1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasprogrip1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip1 )
                                {
                                    $imagenpr3 = $gafasprogrip1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasprogrip1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasprogrip1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip1 )
                                {
                                    $imagenpr4 = $gafasprogrip1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasprogrip1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasprogrip1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasprogrip1 )
                            {
                                $descripcion = $gafasprogrip1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
