<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasprogrip4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | PROGRIP 3101</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $acerbis1 )
                    {
                        $titulo = $acerbis1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $acerbis1 )
                            {
                                $portada = $acerbis1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $acerbis1 )
                                        {
                                            $precio = $acerbis1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $acerbis1 )
                                        {
                                            $valoracion = $acerbis1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/equipamiento-de-cross-nino_c474/gafas-de-cross-nino_c320/gafas-de-cross-progrip-3101-naranja-fluorescente-nino-lente-doble_pid-PZ3101AF18" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $acerbis1 )
                                {
                                    $imagenpr1 = $acerbis1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $acerbis1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $acerbis1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $acerbis1 )
                                {
                                    $imagenpr2 = $acerbis1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $acerbis1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $acerbis1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $acerbis1 )
                                {
                                    $imagenpr3 = $acerbis1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $acerbis1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $acerbis1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $acerbis1 )
                                {
                                    $imagenpr4 = $acerbis1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $acerbis1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $acerbis1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $acerbis1 )
                            {
                                $descripcion = $acerbis1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
