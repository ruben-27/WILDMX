<?php
    ...
    $datos3 = $doc->getElementsByTagName("gafasprogrip5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | PROGRIP 3450FL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos3 as $gafasprogrip5 )
                    {
                        $titulo = $gafasprogrip5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos3 as $gafasprogrip5 )
                            {
                                $portada = $gafasprogrip5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos3 as $gafasprogrip5 )
                                        {
                                            $precio = $gafasprogrip5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos3 as $gafasprogrip5 )
                                        {
                                            $valoracion = $gafasprogrip5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.24mx.es/equipamiento-de-cross/gafas-de-cross_c318/gafas-de-cross_c319/gafas-de-cross-progrip-3450fl-fucsia-negro_pid-PZ3450FXFL16" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip5 )
                                {
                                    $imagenpr1 = $gafasprogrip5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasprogrip5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasprogrip5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip5 )
                                {
                                    $imagenpr2 = $gafasprogrip5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasprogrip5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasprogrip5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip5 )
                                {
                                    $imagenpr3 = $gafasprogrip5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasprogrip5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasprogrip5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos3 as $gafasprogrip5 )
                                {
                                    $imagenpr4 = $gafasprogrip5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasprogrip5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasprogrip5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos3 as $gafasprogrip5 )
                            {
                                $descripcion = $gafasprogrip5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
