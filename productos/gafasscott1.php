<?php
    ...
    $datos = $doc->getElementsByTagName("gafasscott1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SCOTT HUSTLE X</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasscott1 )
                    {
                        $titulo = $gafasscott1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasscott1 )
                            {
                                $portada = $gafasscott1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasscott1 )
                                        {
                                            $precio = $gafasscott1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasscott1 )
                                        {
                                            $valoracion = $gafasscott1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/373939-outlet-gafas-scott-hustle-x-mx-2019-color-amarillo-negro-lente-dorada-chrome-works-2681831017324.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasscott1 )
                                {
                                    $imagenpr1 = $gafasscott1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasscott1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasscott1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott1 )
                                {
                                    $imagenpr2 = $gafasscott1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasscott1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasscott1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott1 )
                                {
                                    $imagenpr3 = $gafasscott1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasscott1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasscott1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott1 )
                                {
                                    $imagenpr4 = $gafasscott1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasscott1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasscott1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasscott1 )
                            {
                                $descripcion = $gafasscott1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
