<?php
    ...
    $datos = $doc->getElementsByTagName("gafasscott2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SCOTT RECOIL XI WFS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasscott2 )
                    {
                        $titulo = $gafasscott2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasscott2 )
                            {
                                $portada = $gafasscott2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasscott2 )
                                        {
                                            $precio = $gafasscott2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasscott2 )
                                        {
                                            $valoracion = $gafasscott2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/377791-outlet-gafas-scott-recoil-xi-wfs-color-negro-blanco-lente-transparente-works-2625971007113.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasscott2 )
                                {
                                    $imagenpr1 = $gafasscott2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasscott2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasscott2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott2 )
                                {
                                    $imagenpr2 = $gafasscott2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasscott2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasscott2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott2 )
                                {
                                    $imagenpr3 = $gafasscott2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasscott2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasscott2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott2 )
                                {
                                    $imagenpr4 = $gafasscott2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasscott2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasscott2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasscott2 )
                            {
                                $descripcion = $gafasscott2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
