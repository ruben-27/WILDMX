<?php
    ...
    $datos = $doc->getElementsByTagName("gafasscott3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasscott3 )
                    {
                        $titulo = $gafasscott3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasscott3 )
                            {
                                $portada = $gafasscott3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasscott3 )
                                        {
                                            $precio = $gafasscott3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasscott3 )
                                        {
                                            $valoracion = $gafasscott3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/373938-outlet-gafas-scott-hustle-x-mx-2019-color-azul-blanco-lente-morada-chrome-works-2681831006281.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasscott3 )
                                {
                                    $imagenpr1 = $gafasscott3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasscott3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasscott3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott3 )
                                {
                                    $imagenpr2 = $gafasscott3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasscott3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasscott3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott3 )
                                {
                                    $imagenpr3 = $gafasscott3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasscott3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasscott3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott3 )
                                {
                                    $imagenpr4 = $gafasscott3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasscott3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasscott3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasscott3 )
                            {
                                $descripcion = $gafasscott3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
