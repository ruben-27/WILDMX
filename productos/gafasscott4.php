<?php
    ...
    $datos = $doc->getElementsByTagName("gafasscott4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SCOTT PROSPECT</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasscott4 )
                    {
                        $titulo = $gafasscott4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasscott4 )
                            {
                                $portada = $gafasscott4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasscott4 )
                                        {
                                            $precio = $gafasscott4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasscott4 )
                                        {
                                            $valoracion = $gafasscott4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/378761-gafas-scott-prospect-2020-color-blanco-rojo-lente-naranja-chrome-works-2728211030280.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasscott4 )
                                {
                                    $imagenpr1 = $gafasscott4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasscott4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasscott4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott4 )
                                {
                                    $imagenpr2 = $gafasscott4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasscott4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasscott4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott4 )
                                {
                                    $imagenpr3 = $gafasscott4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasscott4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasscott4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott4 )
                                {
                                    $imagenpr4 = $gafasscott4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasscott4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasscott4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasscott4 )
                            {
                                $descripcion = $gafasscott4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
