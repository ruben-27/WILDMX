<?php
    ...
    $datos = $doc->getElementsByTagName("gafasscott5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SCOTT PROSPECT EDICIÓN ESPECIAL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasscott5 )
                    {
                        $titulo = $gafasscott5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasscott5 )
                            {
                                $portada = $gafasscott5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasscott5 )
                                        {
                                            $precio = $gafasscott5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasscott5 )
                                        {
                                            $valoracion = $gafasscott5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/385811-gafas-scott-prospect-edicion-especial-brendan-fairclough-2020-color-verde-kaki-lente-amarillo-chrome-works-2760846312289.html#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasscott5 )
                                {
                                    $imagenpr1 = $gafasscott5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasscott5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasscott5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott5 )
                                {
                                    $imagenpr2 = $gafasscott5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasscott5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasscott5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott5 )
                                {
                                    $imagenpr3 = $gafasscott5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasscott5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasscott5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasscott5 )
                                {
                                    $imagenpr4 = $gafasscott5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasscott5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasscott5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasscott5 )
                            {
                                $descripcion = $gafasscott5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
