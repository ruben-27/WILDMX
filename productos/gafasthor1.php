<?php
    ...
    $datos = $doc->getElementsByTagName("gafasthor1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SPRING COMBAT SAND BLANCO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasthor1 )
                    {
                        $titulo = $gafasthor1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasthor1 )
                            {
                                $portada = $gafasthor1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasthor1 )
                                        {
                                            $precio = $gafasthor1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasthor1 )
                                        {
                                            $valoracion = $gafasthor1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/264085-gafas-thor-spring-combat-sand-2020-blanco-negro-26012085.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasthor1 )
                                {
                                    $imagenpr1 = $gafasthor1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasthor1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasthor1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor1 )
                                {
                                    $imagenpr2 = $gafasthor1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasthor1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasthor1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor1 )
                                {
                                    $imagenpr3 = $gafasthor1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasthor1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasthor1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor1 )
                                {
                                    $imagenpr4 = $gafasthor1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasthor1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasthor1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasthor1 )
                            {
                                $descripcion = $gafasthor1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
