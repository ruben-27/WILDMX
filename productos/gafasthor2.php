<?php
    ...
    $datos = $doc->getElementsByTagName("gafasthor2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SPRING COMBAT SAND ROJO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasthor2 )
                    {
                        $titulo = $gafasthor2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasthor2 )
                            {
                                $portada = $gafasthor2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasthor2 )
                                        {
                                            $precio = $gafasthor2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasthor2 )
                                        {
                                            $valoracion = $gafasthor2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/264084-gafas-thor-spring-combat-sand-2020-rojo-negro-26012084.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasthor2 )
                                {
                                    $imagenpr1 = $gafasthor2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasthor2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasthor2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor2 )
                                {
                                    $imagenpr2 = $gafasthor2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasthor2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasthor2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor2 )
                                {
                                    $imagenpr3 = $gafasthor2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasthor2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasthor2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor2 )
                                {
                                    $imagenpr4 = $gafasthor2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasthor2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasthor2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasthor2 )
                            {
                                $descripcion = $gafasthor2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
