<?php
    ...
    $datos = $doc->getElementsByTagName("gafasthor3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SPRING COMBAT VERDE</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasthor3 )
                    {
                        $titulo = $gafasthor3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasthor3 )
                            {
                                $portada = $gafasthor3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasthor3 )
                                        {
                                            $precio = $gafasthor3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasthor3 )
                                        {
                                            $valoracion = $gafasthor3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/264082-gafas-thor-spring-combat-2020-verde-fluor-negro-26012080.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasthor3 )
                                {
                                    $imagenpr1 = $gafasthor3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasthor3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasthor3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor3 )
                                {
                                    $imagenpr2 = $gafasthor3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasthor3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasthor3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor3 )
                                {
                                    $imagenpr3 = $gafasthor3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasthor3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasthor3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor3 )
                                {
                                    $imagenpr4 = $gafasthor3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasthor3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasthor3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasthor3 )
                            {
                                $descripcion = $gafasthor3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
