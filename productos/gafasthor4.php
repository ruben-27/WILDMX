<?php
    ...
    $datos = $doc->getElementsByTagName("gafasthor4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR CONQUER OFFROAD</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasthor4 )
                    {
                        $titulo = $gafasthor4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasthor4 )
                            {
                                $portada = $gafasthor4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasthor4 )
                                        {
                                            $precio = $gafasthor4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasthor4 )
                                        {
                                            $valoracion = $gafasthor4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/372309-outlet-gafas-thor-conquer-offroad-2019-rosa-blanco-26011926.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasthor4 )
                                {
                                    $imagenpr1 = $gafasthor4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasthor4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasthor4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor4 )
                                {
                                    $imagenpr2 = $gafasthor4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasthor4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasthor4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor4 )
                                {
                                    $imagenpr3 = $gafasthor4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasthor4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasthor4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor4 )
                                {
                                    $imagenpr4 = $gafasthor4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasthor4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasthor4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasthor4 )
                            {
                                $descripcion = $gafasthor4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
