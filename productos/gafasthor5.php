<?php
    ...
    $datos = $doc->getElementsByTagName("gafasthor5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SNIPER PRO FADER</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gafasthor5 )
                    {
                        $titulo = $gafasthor5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gafasthor5 )
                            {
                                $portada = $gafasthor5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gafasthor5 )
                                        {
                                            $precio = $gafasthor5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gafasthor5 )
                                        {
                                            $valoracion = $gafasthor5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/gafas/391970-gafas-thor-sniper-pro-fader-2020-color-rojo-lente-azul-26012575.html?extraParams=[object%20Object]#" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gafasthor5 )
                                {
                                    $imagenpr1 = $gafasthor5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gafasthor5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gafasthor5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor5 )
                                {
                                    $imagenpr2 = $gafasthor5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gafasthor5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gafasthor5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor5 )
                                {
                                    $imagenpr3 = $gafasthor5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gafasthor5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gafasthor5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gafasthor5 )
                                {
                                    $imagenpr4 = $gafasthor5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gafasthor5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gafasthor5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gafasthor5 )
                            {
                                $descripcion = $gafasthor5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
