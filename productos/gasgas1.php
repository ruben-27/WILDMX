<?php
    ...
    $datos = $doc->getElementsByTagName("gasgas1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAS GAS EC/XC 250 2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gasgas1 )
                    {
                        $titulo = $gasgas1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gasgas1 )
                            {
                                $portada = $gasgas1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gasgas1 )
                                        {
                                            $precio = $gasgas1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gasgas1 )
                                        {
                                            $valoracion = $gasgas1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/gas-gas/ec-250-2019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gasgas1 )
                                {
                                    $imagenpr1 = $gasgas1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gasgas1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gasgas1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas1 )
                                {
                                    $imagenpr2 = $gasgas1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gasgas1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gasgas1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas1 )
                                {
                                    $imagenpr3 = $gasgas1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gasgas1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gasgas1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas1 )
                                {
                                    $imagenpr4 = $gasgas1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gasgas1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gasgas1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gasgas1 )
                            {
                                $descripcion = $gasgas1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
