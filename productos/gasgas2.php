<?php
    ...
    $datos = $doc->getElementsByTagName("gasgas2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAS GAS EC/XC 300 2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gasgas2 )
                    {
                        $titulo = $gasgas2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gasgas2 )
                            {
                                $portada = $gasgas2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gasgas2 )
                                        {
                                            $precio = $gasgas2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gasgas2 )
                                        {
                                            $valoracion = $gasgas2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/gas-gas/ec-xc-300-2019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gasgas2 )
                                {
                                    $imagenpr1 = $gasgas2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gasgas2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gasgas2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas2 )
                                {
                                    $imagenpr2 = $gasgas2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gasgas2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gasgas2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas2 )
                                {
                                    $imagenpr3 = $gasgas2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gasgas2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gasgas2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas2 )
                                {
                                    $imagenpr4 = $gasgas2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gasgas2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gasgas2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gasgas2 )
                            {
                                $descripcion = $gasgas2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
