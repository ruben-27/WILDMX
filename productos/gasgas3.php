<?php
    ...
    $datos = $doc->getElementsByTagName("gasgas3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAS GAS EC/XC 200 2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gasgas3 )
                    {
                        $titulo = $gasgas3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gasgas3 )
                            {
                                $portada = $gasgas3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gasgas3 )
                                        {
                                            $precio = $gasgas3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gasgas3 )
                                        {
                                            $valoracion = $gasgas3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/gas-gas/ec-xc-200-2019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gasgas3 )
                                {
                                    $imagenpr1 = $gasgas3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gasgas3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gasgas3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas3 )
                                {
                                    $imagenpr2 = $gasgas3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gasgas3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gasgas3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas3 )
                                {
                                    $imagenpr3 = $gasgas3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gasgas3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gasgas3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas3 )
                                {
                                    $imagenpr4 = $gasgas3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gasgas3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gasgas3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gasgas3 )
                            {
                                $descripcion = $gasgas3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
