<?php
    ...
    $datos = $doc->getElementsByTagName("gasgas4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAS GAS ECRANGER 300 2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gasgas4 )
                    {
                        $titulo = $gasgas4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gasgas4 )
                            {
                                $portada = $gasgas4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gasgas4 )
                                        {
                                            $precio = $gasgas4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gasgas4 )
                                        {
                                            $valoracion = $gasgas4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/gas-gas/ecranger-300-2019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gasgas4 )
                                {
                                    $imagenpr1 = $gasgas4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gasgas4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gasgas4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas4 )
                                {
                                    $imagenpr2 = $gasgas4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gasgas4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gasgas4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas4 )
                                {
                                    $imagenpr3 = $gasgas4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gasgas4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gasgas4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas4 )
                                {
                                    $imagenpr4 = $gasgas4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gasgas4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gasgas4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gasgas4 )
                            {
                                $descripcion = $gasgas4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
