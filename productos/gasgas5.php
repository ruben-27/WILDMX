<?php
    ...
    $datos = $doc->getElementsByTagName("gasgas5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | GAS GAS ECRANGER 200 2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $gasgas5 )
                    {
                        $titulo = $gasgas5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $gasgas5 )
                            {
                                $portada = $gasgas5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $gasgas5 )
                                        {
                                            $precio = $gasgas5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $gasgas5 )
                                        {
                                            $valoracion = $gasgas5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/gas-gas/ecranger-200-2019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $gasgas5 )
                                {
                                    $imagenpr1 = $gasgas5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $gasgas5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $gasgas5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas5 )
                                {
                                    $imagenpr2 = $gasgas5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $gasgas5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $gasgas5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas5 )
                                {
                                    $imagenpr3 = $gasgas5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $gasgas5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $gasgas5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $gasgas5 )
                                {
                                    $imagenpr4 = $gasgas5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $gasgas5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $gasgas5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $gasgas5 )
                            {
                                $descripcion = $gasgas5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
