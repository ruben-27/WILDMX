<?php
    ...
    $datos = $doc->getElementsByTagName("guantes1001");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% COGNITO AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantes1001 )
                    {
                        $titulo = $guantes1001->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantes1001 )
                            {
                                $portada = $guantes1001->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantes1001 )
                                        {
                                            $precio = $guantes1001->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantes1001 )
                                        {
                                            $valoracion = $guantes1001->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/372875-guantes-100-brisker-neopreno-color-amarillo-fluor-3330570xy.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantes1001 )
                                {
                                    $imagenpr1 = $guantes1001->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantes1001->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantes1001->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1001 )
                                {
                                    $imagenpr2 = $guantes1001->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantes1001->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantes1001->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1001 )
                                {
                                    $imagenpr3 = $guantes1001->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantes1001->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantes1001->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1001 )
                                {
                                    $imagenpr4 = $guantes1001->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantes1001->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantes1001->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantes1001 )
                            {
                                $descripcion = $guantes1001->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
