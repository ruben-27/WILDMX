<?php
    ...
    $datos = $doc->getElementsByTagName("guantes1002");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% BRISKER NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantes1002 )
                    {
                        $titulo = $guantes1002->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantes1002 )
                            {
                                $portada = $guantes1002->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantes1002 )
                                        {
                                            $precio = $guantes1002->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantes1002 )
                                        {
                                            $valoracion = $guantes1002->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/372876-guantes-100-brisker-neopreno-color-naranja-fluor-3330572xo.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantes1002 )
                                {
                                    $imagenpr1 = $guantes1002->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantes1002->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantes1002->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1002 )
                                {
                                    $imagenpr2 = $guantes1002->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantes1002->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantes1002->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1002 )
                                {
                                    $imagenpr3 = $guantes1002->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantes1002->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantes1002->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1002 )
                                {
                                    $imagenpr4 = $guantes1002->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantes1002->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantes1002->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantes1002 )
                            {
                                $descripcion = $guantes1002->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
