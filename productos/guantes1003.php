<?php
    ...
    $datos = $doc->getElementsByTagName("guantes1003");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% COGNITO ROJO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantes1003 )
                    {
                        $titulo = $guantes1003->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantes1003 )
                            {
                                $portada = $guantes1003->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantes1003 )
                                        {
                                            $precio = $guantes1003->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantes1003 )
                                        {
                                            $valoracion = $guantes1003->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/389837-guantes-100-cognito-negro-carbon-10013-013.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantes1003 )
                                {
                                    $imagenpr1 = $guantes1003->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantes1003->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantes1003->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1003 )
                                {
                                    $imagenpr2 = $guantes1003->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantes1003->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantes1003->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1003 )
                                {
                                    $imagenpr3 = $guantes1003->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantes1003->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantes1003->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1003 )
                                {
                                    $imagenpr4 = $guantes1003->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantes1003->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantes1003->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantes1003 )
                            {
                                $descripcion = $guantes1003->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
