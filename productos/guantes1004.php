<?php
    ...
    $datos = $doc->getElementsByTagName("guantes1004");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% BRISKER GRIS</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantes1004 )
                    {
                        $titulo = $guantes1004->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantes1004 )
                            {
                                $portada = $guantes1004->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantes1004 )
                                        {
                                            $precio = $guantes1004->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantes1004 )
                                        {
                                            $valoracion = $guantes1004->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/373715-guantes-100-brisker-neopreno-color-gris-jaspeado-3330570xhg.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantes1004 )
                                {
                                    $imagenpr1 = $guantes1004->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantes1004->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantes1004->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1004 )
                                {
                                    $imagenpr2 = $guantes1004->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantes1004->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantes1004->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1004 )
                                {
                                    $imagenpr3 = $guantes1004->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantes1004->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantes1004->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1004 )
                                {
                                    $imagenpr4 = $guantes1004->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantes1004->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantes1004->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantes1004 )
                            {
                                $descripcion = $guantes1004->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
