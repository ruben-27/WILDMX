<?php
    ...
    $datos = $doc->getElementsByTagName("guantes1005");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | 100% BRISKER ROSA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantes1005 )
                    {
                        $titulo = $guantes1005->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantes1005 )
                            {
                                $portada = $guantes1005->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantes1005 )
                                        {
                                            $precio = $guantes1005->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantes1005 )
                                        {
                                            $valoracion = $guantes1005->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/373717-guantes-mujer-100-brisker-neopreno-color-rosa-neon-negro-3330573wp.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantes1005 )
                                {
                                    $imagenpr1 = $guantes1005->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantes1005->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantes1005->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1005 )
                                {
                                    $imagenpr2 = $guantes1005->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantes1005->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantes1005->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1005 )
                                {
                                    $imagenpr3 = $guantes1005->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantes1005->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantes1005->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantes1005 )
                                {
                                    $imagenpr4 = $guantes1005->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantes1005->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantes1005->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantes1005 )
                            {
                                $descripcion = $guantes1005->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
