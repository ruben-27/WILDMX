<?php
    ...
    $datos = $doc->getElementsByTagName("guantesalpinestars1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS RACEFEND NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesalpinestars1 )
                    {
                        $titulo = $guantesalpinestars1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesalpinestars1 )
                            {
                                $portada = $guantesalpinestars1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesalpinestars1 )
                                        {
                                            $precio = $guantesalpinestars1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesalpinestars1 )
                                        {
                                            $valoracion = $guantesalpinestars1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/379068-guantes-alpinestars-racefend-2020-color-negro-blanco-alp33305913.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars1 )
                                {
                                    $imagenpr1 = $guantesalpinestars1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesalpinestars1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesalpinestars1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars1 )
                                {
                                    $imagenpr2 = $guantesalpinestars1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesalpinestars1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesalpinestars1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars1 )
                                {
                                    $imagenpr3 = $guantesalpinestars1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesalpinestars1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesalpinestars1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars1 )
                                {
                                    $imagenpr4 = $guantesalpinestars1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesalpinestars1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesalpinestars1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesalpinestars1 )
                            {
                                $descripcion = $guantesalpinestars1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
