<?php
    ...
    $datos = $doc->getElementsByTagName("guantesalpinestars2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS RADAR AZUL</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesalpinestars2 )
                    {
                        $titulo = $guantesalpinestars2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesalpinestars2 )
                            {
                                $portada = $guantesalpinestars2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesalpinestars2 )
                                        {
                                            $precio = $guantesalpinestars2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesalpinestars2 )
                                        {
                                            $valoracion = $guantesalpinestars2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/385989-guantes-alpinestars-radar-2020-color-azul-agua-alp33305968.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars2 )
                                {
                                    $imagenpr1 = $guantesalpinestars2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesalpinestars2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesalpinestars2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars2 )
                                {
                                    $imagenpr2 = $guantesalpinestars2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesalpinestars2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesalpinestars2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars2 )
                                {
                                    $imagenpr3 = $guantesalpinestars2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesalpinestars2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesalpinestars2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars2 )
                                {
                                    $imagenpr4 = $guantesalpinestars2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesalpinestars2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesalpinestars2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesalpinestars2 )
                            {
                                $descripcion = $guantesalpinestars2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
