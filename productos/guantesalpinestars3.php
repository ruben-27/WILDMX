<?php
    ...
    $datos = $doc->getElementsByTagName("guantesalpinestars3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS RADAR PETROLEO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesalpinestars3 )
                    {
                        $titulo = $guantesalpinestars3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesalpinestars3 )
                            {
                                $portada = $guantesalpinestars3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesalpinestars3 )
                                        {
                                            $precio = $guantesalpinestars3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesalpinestars3 )
                                        {
                                            $valoracion = $guantesalpinestars3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/liquidacion-guantes/266236-liquidacion-guantes-alpinestars-2017-radar-tracker-petroleo-agua-naranja-fluor-infantiles-3332112x.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars3 )
                                {
                                    $imagenpr1 = $guantesalpinestars3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesalpinestars3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesalpinestars3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars3 )
                                {
                                    $imagenpr2 = $guantesalpinestars3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesalpinestars3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesalpinestars3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars3 )
                                {
                                    $imagenpr3 = $guantesalpinestars3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesalpinestars3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesalpinestars3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars3 )
                                {
                                    $imagenpr4 = $guantesalpinestars3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesalpinestars3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesalpinestars3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesalpinestars3 )
                            {
                                $descripcion = $guantesalpinestars3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
