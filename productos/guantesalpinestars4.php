<?php
    ...
    $datos = $doc->getElementsByTagName("guantesalpinestars4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS RACEFEND AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesalpinestars4 )
                    {
                        $titulo = $guantesalpinestars4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesalpinestars4 )
                            {
                                $portada = $guantesalpinestars4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesalpinestars4 )
                                        {
                                            $precio = $guantesalpinestars4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesalpinestars4 )
                                        {
                                            $valoracion = $guantesalpinestars4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/379070-guantes-alpinestars-racefend-2020-color-amarillo-fluor-negro-alp33305933.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars4 )
                                {
                                    $imagenpr1 = $guantesalpinestars4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesalpinestars4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesalpinestars4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars4 )
                                {
                                    $imagenpr2 = $guantesalpinestars4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesalpinestars4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesalpinestars4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars4 )
                                {
                                    $imagenpr3 = $guantesalpinestars4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesalpinestars4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesalpinestars4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars4 )
                                {
                                    $imagenpr4 = $guantesalpinestars4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesalpinestars4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesalpinestars4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesalpinestars4 )
                            {
                                $descripcion = $guantesalpinestars4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
