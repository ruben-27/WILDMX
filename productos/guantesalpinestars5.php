<?php
    ...
    $datos = $doc->getElementsByTagName("guantesalpinestars5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | ALPINESTARS RACEFEND NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesalpinestars5 )
                    {
                        $titulo = $guantesalpinestars5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesalpinestars5 )
                            {
                                $portada = $guantesalpinestars5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesalpinestars5 )
                                        {
                                            $precio = $guantesalpinestars5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesalpinestars5 )
                                        {
                                            $valoracion = $guantesalpinestars5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/379069-guantes-alpinestars-racefend-2020-color-naranja-fluor-negro-alp33305928.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars5 )
                                {
                                    $imagenpr1 = $guantesalpinestars5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesalpinestars5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesalpinestars5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars5 )
                                {
                                    $imagenpr2 = $guantesalpinestars5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesalpinestars5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesalpinestars5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars5 )
                                {
                                    $imagenpr3 = $guantesalpinestars5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesalpinestars5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesalpinestars5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesalpinestars5 )
                                {
                                    $imagenpr4 = $guantesalpinestars5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesalpinestars5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesalpinestars5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesalpinestars5 )
                            {
                                $descripcion = $guantesalpinestars5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
