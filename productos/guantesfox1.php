<?php
    ...
    $datos = $doc->getElementsByTagName("guantesfox1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX DIRTPAW NARANJA</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesfox1 )
                    {
                        $titulo = $guantesfox1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesfox1 )
                            {
                                $portada = $guantesfox1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesfox1 )
                                        {
                                            $precio = $guantesfox1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesfox1 )
                                        {
                                            $valoracion = $guantesfox1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/380380-guantes-fox-dirtpaw-race-2020-color-naranja-fluor-22751-824.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesfox1 )
                                {
                                    $imagenpr1 = $guantesfox1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesfox1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesfox1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox1 )
                                {
                                    $imagenpr2 = $guantesfox1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesfox1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesfox1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox1 )
                                {
                                    $imagenpr3 = $guantesfox1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesfox1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesfox1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox1 )
                                {
                                    $imagenpr4 = $guantesfox1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesfox1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesfox1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesfox1 )
                            {
                                $descripcion = $guantesfox1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
