<?php
    ...
    $datos = $doc->getElementsByTagName("guantesfox2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX DIRTPAW AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesfox2 )
                    {
                        $titulo = $guantesfox2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesfox2 )
                            {
                                $portada = $guantesfox2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesfox2 )
                                        {
                                            $precio = $guantesfox2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesfox2 )
                                        {
                                            $valoracion = $guantesfox2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/380460-guantes-infantiles-fox-dirtpaw-race-2020-color-amarillo-fluor-23959-130.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesfox2 )
                                {
                                    $imagenpr1 = $guantesfox2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesfox2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesfox2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox2 )
                                {
                                    $imagenpr2 = $guantesfox2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesfox2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesfox2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox2 )
                                {
                                    $imagenpr3 = $guantesfox2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesfox2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesfox2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox2 )
                                {
                                    $imagenpr4 = $guantesfox2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesfox2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesfox2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesfox2 )
                            {
                                $descripcion = $guantesfox2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
