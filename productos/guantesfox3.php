<?php
    ...
    $datos = $doc->getElementsByTagName("guantesfox3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX DIRTPAW NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesfox3 )
                    {
                        $titulo = $guantesfox3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesfox3 )
                            {
                                $portada = $guantesfox3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesfox3 )
                                        {
                                            $precio = $guantesfox3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesfox3 )
                                        {
                                            $valoracion = $guantesfox3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/380457-guantes-infantiles-fox-dirtpaw-race-2020-color-negro-23959-001.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesfox3 )
                                {
                                    $imagenpr1 = $guantesfox3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesfox3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesfox3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox3 )
                                {
                                    $imagenpr2 = $guantesfox3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesfox3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesfox3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox3 )
                                {
                                    $imagenpr3 = $guantesfox3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesfox3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesfox3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox3 )
                                {
                                    $imagenpr4 = $guantesfox3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesfox3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesfox3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesfox3 )
                            {
                                $descripcion = $guantesfox3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
