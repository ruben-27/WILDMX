<?php
    ...
    $datos = $doc->getElementsByTagName("guantesfox4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | FOX PAWTECTOR AMARILLO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesfox4 )
                    {
                        $titulo = $guantesfox4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesfox4 )
                            {
                                $portada = $guantesfox4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesfox4 )
                                        {
                                            $precio = $guantesfox4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesfox4 )
                                        {
                                            $valoracion = $guantesfox4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/274575-liquidacion-guantes-fox-pawtector-color-amarillo-oscuro-17286-547.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesfox4 )
                                {
                                    $imagenpr1 = $guantesfox4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesfox4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesfox4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox4 )
                                {
                                    $imagenpr2 = $guantesfox4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesfox4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesfox4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox4 )
                                {
                                    $imagenpr3 = $guantesfox4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesfox4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesfox4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesfox4 )
                                {
                                    $imagenpr4 = $guantesfox4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesfox4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesfox4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesfox4 )
                            {
                                $descripcion = $guantesfox4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
