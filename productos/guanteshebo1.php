<?php
    ...
    $datos = $doc->getElementsByTagName("guanteshebo1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HEBO NEOPRENO NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guanteshebo1 )
                    {
                        $titulo = $guanteshebo1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guanteshebo1 )
                            {
                                $portada = $guanteshebo1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guanteshebo1 )
                                        {
                                            $precio = $guanteshebo1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guanteshebo1 )
                                        {
                                            $valoracion = $guanteshebo1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes/266028-guantes-hebo-neopreno-negro-rojo-he1213nr.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo1 )
                                {
                                    $imagenpr1 = $guanteshebo1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guanteshebo1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guanteshebo1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo1 )
                                {
                                    $imagenpr2 = $guanteshebo1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guanteshebo1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guanteshebo1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo1 )
                                {
                                    $imagenpr3 = $guanteshebo1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guanteshebo1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guanteshebo1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo1 )
                                {
                                    $imagenpr4 = $guanteshebo1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guanteshebo1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guanteshebo1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guanteshebo1 )
                            {
                                $descripcion = $guanteshebo1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
