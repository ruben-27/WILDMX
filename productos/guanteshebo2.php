<?php
    ...
    $datos = $doc->getElementsByTagName("guanteshebo2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HEBO TRIAL ROJO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guanteshebo2 )
                    {
                        $titulo = $guanteshebo2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guanteshebo2 )
                            {
                                $portada = $guanteshebo2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guanteshebo2 )
                                        {
                                            $precio = $guanteshebo2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guanteshebo2 )
                                        {
                                            $valoracion = $guanteshebo2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes/276130-guantes-hebo-trial-nano-pro-ii-2018-color-rojo-he1159r.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo2 )
                                {
                                    $imagenpr1 = $guanteshebo2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guanteshebo2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guanteshebo2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo2 )
                                {
                                    $imagenpr2 = $guanteshebo2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guanteshebo2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guanteshebo2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo2 )
                                {
                                    $imagenpr3 = $guanteshebo2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guanteshebo2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guanteshebo2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo2 )
                                {
                                    $imagenpr4 = $guanteshebo2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guanteshebo2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guanteshebo2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guanteshebo2 )
                            {
                                $descripcion = $guanteshebo2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
