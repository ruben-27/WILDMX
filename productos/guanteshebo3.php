<?php
    ...
    $datos = $doc->getElementsByTagName("guanteshebo3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HEBO BAGGY NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guanteshebo3 )
                    {
                        $titulo = $guanteshebo3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guanteshebo3 )
                            {
                                $portada = $guanteshebo3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guanteshebo3 )
                                        {
                                            $precio = $guanteshebo3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guanteshebo3 )
                                        {
                                            $valoracion = $guanteshebo3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/276133-guantes-hebo-enduro-baggy-color-lima-he1128lm.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo3 )
                                {
                                    $imagenpr1 = $guanteshebo3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guanteshebo3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guanteshebo3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo3 )
                                {
                                    $imagenpr2 = $guanteshebo3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guanteshebo3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guanteshebo3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo3 )
                                {
                                    $imagenpr3 = $guanteshebo3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guanteshebo3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guanteshebo3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo3 )
                                {
                                    $imagenpr4 = $guanteshebo3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guanteshebo3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guanteshebo3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guanteshebo3 )
                            {
                                $descripcion = $guanteshebo3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
