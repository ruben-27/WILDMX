<?php
    ...
    $datos = $doc->getElementsByTagName("guanteshebo5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HEBO TRIAL NEGRO</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guanteshebo5 )
                    {
                        $titulo = $guanteshebo5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guanteshebo5 )
                            {
                                $portada = $guanteshebo5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guanteshebo5 )
                                        {
                                            $precio = $guanteshebo5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guanteshebo5 )
                                        {
                                            $valoracion = $guanteshebo5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes/393685-outlet-guantes-hebo-trial-toni-bou-ii-color-negro-talla-2xl-he1158xxln.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo5 )
                                {
                                    $imagenpr1 = $guanteshebo5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guanteshebo5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guanteshebo5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo5 )
                                {
                                    $imagenpr2 = $guanteshebo5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guanteshebo5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guanteshebo5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo5 )
                                {
                                    $imagenpr3 = $guanteshebo5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guanteshebo5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guanteshebo5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guanteshebo5 )
                                {
                                    $imagenpr4 = $guanteshebo5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guanteshebo5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guanteshebo5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guanteshebo5 )
                            {
                                $descripcion = $guanteshebo5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
