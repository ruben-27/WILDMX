<?php
    ...
    $datos = $doc->getElementsByTagName("guantesthor1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SPECTRUM OFFROAD</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesthor1 )
                    {
                        $titulo = $guantesthor1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesthor1 )
                            {
                                $portada = $guantesthor1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesthor1 )
                                        {
                                            $precio = $guantesthor1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesthor1 )
                                        {
                                            $valoracion = $guantesthor1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/268488-outlet-guantes-infantiles-thor-spectrum-offroad-2019-azul-negro-thor33321197.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesthor1 )
                                {
                                    $imagenpr1 = $guantesthor1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesthor1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesthor1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor1 )
                                {
                                    $imagenpr2 = $guantesthor1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesthor1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesthor1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor1 )
                                {
                                    $imagenpr3 = $guantesthor1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesthor1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesthor1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor1 )
                                {
                                    $imagenpr4 = $guantesthor1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesthor1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesthor1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesthor1 )
                            {
                                $descripcion = $guantesthor1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
