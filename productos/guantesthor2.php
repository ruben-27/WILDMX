<?php
    ...
    $datos = $doc->getElementsByTagName("guantesthor2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR SECTOR 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesthor2 )
                    {
                        $titulo = $guantesthor2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesthor2 )
                            {
                                $portada = $guantesthor2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesthor2 )
                                        {
                                            $precio = $guantesthor2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesthor2 )
                                        {
                                            $valoracion = $guantesthor2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/379885-guantes-infantiles-thor-sector-2020-color-acido-thor33321531.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesthor2 )
                                {
                                    $imagenpr1 = $guantesthor2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesthor2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesthor2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor2 )
                                {
                                    $imagenpr2 = $guantesthor2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesthor2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesthor2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor2 )
                                {
                                    $imagenpr3 = $guantesthor2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesthor2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesthor2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor2 )
                                {
                                    $imagenpr4 = $guantesthor2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesthor2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesthor2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesthor2 )
                            {
                                $descripcion = $guantesthor2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
