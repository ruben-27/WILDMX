<?php
    ...
    $datos = $doc->getElementsByTagName("guantesthor3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesthor3 )
                    {
                        $titulo = $guantesthor3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesthor3 )
                            {
                                $portada = $guantesthor3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesthor3 )
                                        {
                                            $precio = $guantesthor3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesthor3 )
                                        {
                                            $valoracion = $guantesthor3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/liquidacion-guantes/193554-liquidacion-oferta-guantes-thor-void-verde-amarillo-mujer-2016-333101xx.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesthor3 )
                                {
                                    $imagenpr1 = $guantesthor3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesthor3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesthor3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor3 )
                                {
                                    $imagenpr2 = $guantesthor3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesthor3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesthor3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor3 )
                                {
                                    $imagenpr3 = $guantesthor3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesthor3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesthor3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor3 )
                                {
                                    $imagenpr4 = $guantesthor3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesthor3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesthor3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesthor3 )
                            {
                                $descripcion = $guantesthor3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
