<?php
    ...
    $datos = $doc->getElementsByTagName("guantesthor4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesthor4 )
                    {
                        $titulo = $guantesthor4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesthor4 )
                            {
                                $portada = $guantesthor4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesthor4 )
                                        {
                                            $precio = $guantesthor4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesthor4 )
                                        {
                                            $valoracion = $guantesthor4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/379807-guantes-thor-sector-2020-color-negro-thor33305853.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesthor4 )
                                {
                                    $imagenpr1 = $guantesthor4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesthor4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesthor4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor4 )
                                {
                                    $imagenpr2 = $guantesthor4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesthor4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesthor4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor4 )
                                {
                                    $imagenpr3 = $guantesthor4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesthor4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesthor4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor4 )
                                {
                                    $imagenpr4 = $guantesthor4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesthor4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesthor4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesthor4 )
                            {
                                $descripcion = $guantesthor4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
