<?php
    ...
    $datos = $doc->getElementsByTagName("guantesthor5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | THOR REBOUND 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $guantesthor5 )
                    {
                        $titulo = $guantesthor5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $guantesthor5 )
                            {
                                $portada = $guantesthor5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $guantesthor5 )
                                        {
                                            $precio = $guantesthor5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $guantesthor5 )
                                        {
                                            $valoracion = $guantesthor5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprarcenter">
                                <a href="https://www.motocrosscenter.com/shop/es/guantes-motocross-enduro/379796-guantes-thor-rebound-2020-color-camuflaje-thor33305823.html?extraParams=[object%20Object]" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $guantesthor5 )
                                {
                                    $imagenpr1 = $guantesthor5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $guantesthor5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $guantesthor5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor5 )
                                {
                                    $imagenpr2 = $guantesthor5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $guantesthor5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $guantesthor5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor5 )
                                {
                                    $imagenpr3 = $guantesthor5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $guantesthor5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $guantesthor5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $guantesthor5 )
                                {
                                    $imagenpr4 = $guantesthor5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $guantesthor5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $guantesthor5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $guantesthor5 )
                            {
                                $descripcion = $guantesthor5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
