<?php
    ...
    $datos = $doc->getElementsByTagName("honda1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HONDA CRF250R 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $honda1 )
                    {
                        $titulo = $honda1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $honda1 )
                            {
                                $portada = $honda1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $honda1 )
                                        {
                                            $precio = $honda1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $honda1 )
                                        {
                                            $valoracion = $honda1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/honda/crf250r-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $honda1 )
                                {
                                    $imagenpr1 = $honda1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $honda1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $honda1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda1 )
                                {
                                    $imagenpr2 = $honda1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $honda1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $honda1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda1 )
                                {
                                    $imagenpr3 = $honda1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $honda1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $honda1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda1 )
                                {
                                    $imagenpr4 = $honda1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $honda1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $honda1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $honda1 )
                            {
                                $descripcion = $honda1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
