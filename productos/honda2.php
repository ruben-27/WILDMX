<?php
    ...
    $datos = $doc->getElementsByTagName("honda2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HONDA CRF450R 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $honda2 )
                    {
                        $titulo = $honda2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $honda2 )
                            {
                                $portada = $honda2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $honda2 )
                                        {
                                            $precio = $honda2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $honda2 )
                                        {
                                            $valoracion = $honda2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/honda/crf450r-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $honda2 )
                                {
                                    $imagenpr1 = $honda2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $honda2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $honda2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda2 )
                                {
                                    $imagenpr2 = $honda2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $honda2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $honda2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda2 )
                                {
                                    $imagenpr3 = $honda2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $honda2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $honda2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda2 )
                                {
                                    $imagenpr4 = $honda2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $honda2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $honda2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $honda2 )
                            {
                                $descripcion = $honda2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
