<?php
    ...
    $datos = $doc->getElementsByTagName("honda3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HONDA CRF125F 2018</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $honda3 )
                    {
                        $titulo = $honda3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $honda3 )
                            {
                                $portada = $honda3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $honda3 )
                                        {
                                            $precio = $honda3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $honda3 )
                                        {
                                            $valoracion = $honda3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/honda/crf125f" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $honda3 )
                                {
                                    $imagenpr1 = $honda3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $honda3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $honda3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda3 )
                                {
                                    $imagenpr2 = $honda3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $honda3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $honda3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda3 )
                                {
                                    $imagenpr3 = $honda3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $honda3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $honda3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda3 )
                                {
                                    $imagenpr4 = $honda3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $honda3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $honda3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $honda3 )
                            {
                                $descripcion = $honda3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
