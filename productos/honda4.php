<?php
    ...
    $datos = $doc->getElementsByTagName("honda4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HONDA CRF110F</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $honda4 )
                    {
                        $titulo = $honda4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $honda4 )
                            {
                                $portada = $honda4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $honda4 )
                                        {
                                            $precio = $honda4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $honda4 )
                                        {
                                            $valoracion = $honda4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/honda/crf110f" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $honda4 )
                                {
                                    $imagenpr1 = $honda4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $honda4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $honda4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda4 )
                                {
                                    $imagenpr2 = $honda4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $honda4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $honda4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda4 )
                                {
                                    $imagenpr3 = $honda4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $honda4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $honda4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $honda4 )
                                {
                                    $imagenpr4 = $honda4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $honda4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $honda4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $honda4 )
                            {
                                $descripcion = $honda4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
