<?php
    ...
    $datos = $doc->getElementsByTagName("husaberg1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSABERG FE 250 ´14</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husaberg1 )
                    {
                        $titulo = $husaberg1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husaberg1 )
                            {
                                $portada = $husaberg1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husaberg1 )
                                        {
                                            $precio = $husaberg1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husaberg1 )
                                        {
                                            $valoracion = $husaberg1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husaberg/fe-250-14" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husaberg1 )
                                {
                                    $imagenpr1 = $husaberg1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husaberg1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husaberg1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg1 )
                                {
                                    $imagenpr2 = $husaberg1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husaberg1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husaberg1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg1 )
                                {
                                    $imagenpr3 = $husaberg1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husaberg1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husaberg1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg1 )
                                {
                                    $imagenpr4 = $husaberg1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husaberg1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husaberg1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husaberg1 )
                            {
                                $descripcion = $husaberg1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
