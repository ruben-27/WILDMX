<?php
    ...
    $datos = $doc->getElementsByTagName("husaberg2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSABERG FE 390</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husaberg2 )
                    {
                        $titulo = $husaberg2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husaberg2 )
                            {
                                $portada = $husaberg2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husaberg2 )
                                        {
                                            $precio = $husaberg2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husaberg2 )
                                        {
                                            $valoracion = $husaberg2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husaberg/fe-390" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husaberg2 )
                                {
                                    $imagenpr1 = $husaberg2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husaberg2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husaberg2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg2 )
                                {
                                    $imagenpr2 = $husaberg2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husaberg2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husaberg2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg2 )
                                {
                                    $imagenpr3 = $husaberg2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husaberg2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husaberg2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg2 )
                                {
                                    $imagenpr4 = $husaberg2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husaberg2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husaberg2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husaberg2 )
                            {
                                $descripcion = $husaberg2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
