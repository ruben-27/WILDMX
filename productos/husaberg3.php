<?php
    ...
    $datos = $doc->getElementsByTagName("husaberg3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSABERG FE 390 ´12</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husaberg3 )
                    {
                        $titulo = $husaberg3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husaberg3 )
                            {
                                $portada = $husaberg3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husaberg3 )
                                        {
                                            $precio = $husaberg3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husaberg3 )
                                        {
                                            $valoracion = $husaberg3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husaberg/fe-390-12" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husaberg3 )
                                {
                                    $imagenpr1 = $husaberg3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husaberg3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husaberg3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg3 )
                                {
                                    $imagenpr2 = $husaberg3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husaberg3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husaberg3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg3 )
                                {
                                    $imagenpr3 = $husaberg3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husaberg3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husaberg3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg3 )
                                {
                                    $imagenpr4 = $husaberg3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husaberg3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husaberg3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husaberg3 )
                            {
                                $descripcion = $husaberg3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
