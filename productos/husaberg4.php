<?php
    ...
    $datos = $doc->getElementsByTagName("husaberg4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husaberg4 )
                    {
                        $titulo = $husaberg4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husaberg4 )
                            {
                                $portada = $husaberg4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husaberg4 )
                                        {
                                            $precio = $husaberg4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husaberg4 )
                                        {
                                            $valoracion = $husaberg4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husaberg/fe-450" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husaberg4 )
                                {
                                    $imagenpr1 = $husaberg4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husaberg4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husaberg4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg4 )
                                {
                                    $imagenpr2 = $husaberg4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husaberg4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husaberg4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg4 )
                                {
                                    $imagenpr3 = $husaberg4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husaberg4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husaberg4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg4 )
                                {
                                    $imagenpr4 = $husaberg4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husaberg4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husaberg4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husaberg4 )
                            {
                                $descripcion = $husaberg4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
