<?php
    ...
    $datos = $doc->getElementsByTagName("husaberg5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSABERG FE 501 ´14</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husaberg5 )
                    {
                        $titulo = $husaberg5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husaberg5 )
                            {
                                $portada = $husaberg5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husaberg5 )
                                        {
                                            $precio = $husaberg5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husaberg5 )
                                        {
                                            $valoracion = $husaberg5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husaberg/fe-501-14" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husaberg5 )
                                {
                                    $imagenpr1 = $husaberg5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husaberg5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husaberg5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg5 )
                                {
                                    $imagenpr2 = $husaberg5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husaberg5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husaberg5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg5 )
                                {
                                    $imagenpr3 = $husaberg5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husaberg5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husaberg5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husaberg5 )
                                {
                                    $imagenpr4 = $husaberg5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husaberg5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husaberg5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husaberg5 )
                            {
                                $descripcion = $husaberg5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
