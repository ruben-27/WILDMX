<?php
    ...
    $datos = $doc->getElementsByTagName("husqvarna1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSQVARNA TC 125 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husqvarna1 )
                    {
                        $titulo = $husqvarna1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husqvarna1 )
                            {
                                $portada = $husqvarna1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husqvarna1 )
                                        {
                                            $precio = $husqvarna1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husqvarna1 )
                                        {
                                            $valoracion = $husqvarna1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husqvarna/tc-125-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husqvarna1 )
                                {
                                    $imagenpr1 = $husqvarna1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husqvarna1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husqvarna1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna1 )
                                {
                                    $imagenpr2 = $husqvarna1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husqvarna1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husqvarna1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna1 )
                                {
                                    $imagenpr3 = $husqvarna1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husqvarna1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husqvarna1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna1 )
                                {
                                    $imagenpr4 = $husqvarna1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husqvarna1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husqvarna1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husqvarna1 )
                            {
                                $descripcion = $husqvarna1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
