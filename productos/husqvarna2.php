<?php
    ...
    $datos = $doc->getElementsByTagName("husqvarna2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSQVARNA FC 250 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husqvarna2 )
                    {
                        $titulo = $husqvarna2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husqvarna2 )
                            {
                                $portada = $husqvarna2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husqvarna2 )
                                        {
                                            $precio = $husqvarna2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husqvarna2 )
                                        {
                                            $valoracion = $husqvarna2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husqvarna/fc-250-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husqvarna2 )
                                {
                                    $imagenpr1 = $husqvarna2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husqvarna2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husqvarna2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna2 )
                                {
                                    $imagenpr2 = $husqvarna2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husqvarna2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husqvarna2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna2 )
                                {
                                    $imagenpr3 = $husqvarna2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husqvarna2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husqvarna2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna2 )
                                {
                                    $imagenpr4 = $husqvarna2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husqvarna2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husqvarna2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husqvarna2 )
                            {
                                $descripcion = $husqvarna2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
