<?php
    ...
    $datos = $doc->getElementsByTagName("husqvarna3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSQVARNA TC 85 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husqvarna3 )
                    {
                        $titulo = $husqvarna3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husqvarna3 )
                            {
                                $portada = $husqvarna3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husqvarna3 )
                                        {
                                            $precio = $husqvarna3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husqvarna3 )
                                        {
                                            $valoracion = $husqvarna3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husqvarna/tc-85-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husqvarna3 )
                                {
                                    $imagenpr1 = $husqvarna3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husqvarna3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husqvarna3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna3 )
                                {
                                    $imagenpr2 = $husqvarna3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husqvarna3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husqvarna3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna3 )
                                {
                                    $imagenpr3 = $husqvarna3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husqvarna3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husqvarna3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna3 )
                                {
                                    $imagenpr4 = $husqvarna3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husqvarna3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husqvarna3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husqvarna3 )
                            {
                                $descripcion = $husqvarna3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
