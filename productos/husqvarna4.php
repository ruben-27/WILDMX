<?php
    ...
    $datos = $doc->getElementsByTagName("husqvarna4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSQVARNA FC 450 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husqvarna4 )
                    {
                        $titulo = $husqvarna4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husqvarna4 )
                            {
                                $portada = $husqvarna4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husqvarna4 )
                                        {
                                            $precio = $husqvarna4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husqvarna4 )
                                        {
                                            $valoracion = $husqvarna4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husqvarna/fc-450-2020" target="_blank">
                                    <div>
                                        <img src="../imagenes/logo/motofichas.png" alt="" />
                                        <span>Ver en Motofichas</span>
                                    </div>
                                </a>
                            </td>
                        </tr>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husqvarna4 )
                                {
                                    $imagenpr1 = $husqvarna4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husqvarna4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husqvarna4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna4 )
                                {
                                    $imagenpr2 = $husqvarna4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husqvarna4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husqvarna4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna4 )
                                {
                                    $imagenpr3 = $husqvarna4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husqvarna4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husqvarna4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna4 )
                                {
                                    $imagenpr4 = $husqvarna4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husqvarna4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husqvarna4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husqvarna4 )
                            {
                                $descripcion = $husqvarna4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
