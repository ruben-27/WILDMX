<?php
    ...
    $datos = $doc->getElementsByTagName("husqvarna5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | HUSQVARNA TC 50 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $husqvarna5 )
                    {
                        $titulo = $husqvarna5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $husqvarna5 )
                            {
                                $portada = $husqvarna5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $husqvarna5 )
                                        {
                                            $precio = $husqvarna5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $husqvarna5 )
                                        {
                                            $valoracion = $husqvarna5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/husqvarna/tc-50-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $husqvarna5 )
                                {
                                    $imagenpr1 = $husqvarna5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $husqvarna5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $husqvarna5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna5 )
                                {
                                    $imagenpr2 = $husqvarna5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $husqvarna5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $husqvarna5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna5 )
                                {
                                    $imagenpr3 = $husqvarna5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $husqvarna5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $husqvarna5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $husqvarna5 )
                                {
                                    $imagenpr4 = $husqvarna5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $husqvarna5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $husqvarna5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $husqvarna5 )
                            {
                                $descripcion = $husqvarna5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
