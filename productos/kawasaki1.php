<?php
    ...
    $datos = $doc->getElementsByTagName("kawasaki1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KAWASAKI KX250F 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $kawasaki1 )
                    {
                        $titulo = $kawasaki1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $kawasaki1 )
                            {
                                $portada = $kawasaki1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $kawasaki1 )
                                        {
                                            $precio = $kawasaki1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $kawasaki1 )
                                        {
                                            $valoracion = $kawasaki1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/kawasaki/kx250f-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $kawasaki1 )
                                {
                                    $imagenpr1 = $kawasaki1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $kawasaki1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $kawasaki1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki1 )
                                {
                                    $imagenpr2 = $kawasaki1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $kawasaki1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $kawasaki1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki1 )
                                {
                                    $imagenpr3 = $kawasaki1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $kawasaki1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $kawasaki1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki1 )
                                {
                                    $imagenpr4 = $kawasaki1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $kawasaki1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $kawasaki1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $kawasaki1 )
                            {
                                $descripcion = $kawasaki1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
