<?php
    ...
    $datos = $doc->getElementsByTagName("kawasaki2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KAWASAKI KX450F 2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $kawasaki2 )
                    {
                        $titulo = $kawasaki2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $kawasaki2 )
                            {
                                $portada = $kawasaki2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $kawasaki2 )
                                        {
                                            $precio = $kawasaki2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $kawasaki2 )
                                        {
                                            $valoracion = $kawasaki2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/kawasaki/kx450f-2019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $kawasaki2 )
                                {
                                    $imagenpr1 = $kawasaki2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $kawasaki2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $kawasaki2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki2 )
                                {
                                    $imagenpr2 = $kawasaki2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $kawasaki2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $kawasaki2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki2 )
                                {
                                    $imagenpr3 = $kawasaki2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $kawasaki2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $kawasaki2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki2 )
                                {
                                    $imagenpr4 = $kawasaki2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $kawasaki2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $kawasaki2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $kawasaki2 )
                            {
                                $descripcion = $kawasaki2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
