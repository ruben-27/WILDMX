<?php
    ...
    $datos = $doc->getElementsByTagName("kawasaki5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KAWASAKI KX450F</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $kawasaki5 )
                    {
                        $titulo = $kawasaki5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $kawasaki5 )
                            {
                                $portada = $kawasaki5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $kawasaki5 )
                                        {
                                            $precio = $kawasaki5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $kawasaki5 )
                                        {
                                            $valoracion = $kawasaki5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/kawasaki/kx450f" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $kawasaki5 )
                                {
                                    $imagenpr1 = $kawasaki5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $kawasaki5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $kawasaki5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki5 )
                                {
                                    $imagenpr2 = $kawasaki5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $kawasaki5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $kawasaki5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki5 )
                                {
                                    $imagenpr3 = $kawasaki5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $kawasaki5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $kawasaki5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $kawasaki5 )
                                {
                                    $imagenpr4 = $kawasaki5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $kawasaki5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $kawasaki5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $kawasaki5 )
                            {
                                $descripcion = $kawasaki5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
