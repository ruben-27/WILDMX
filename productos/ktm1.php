<?php
    ...
    $datos = $doc->getElementsByTagName("ktm1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KTM 125 SX 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $ktm1 )
                    {
                        $titulo = $ktm1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $ktm1 )
                            {
                                $portada = $ktm1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $ktm1 )
                                        {
                                            $precio = $ktm1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $ktm1 )
                                        {
                                            $valoracion = $ktm1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/ktm/125-sx-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $ktm1 )
                                {
                                    $imagenpr1 = $ktm1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $ktm1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $ktm1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm1 )
                                {
                                    $imagenpr2 = $ktm1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $ktm1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $ktm1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm1 )
                                {
                                    $imagenpr3 = $ktm1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $ktm1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $ktm1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm1 )
                                {
                                    $imagenpr4 = $ktm1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $ktm1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $ktm1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $ktm1 )
                            {
                                $descripcion = $ktm1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
