<?php
    ...
    $datos = $doc->getElementsByTagName("ktm2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KTM 85 SX 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $ktm2 )
                    {
                        $titulo = $ktm2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $ktm2 )
                            {
                                $portada = $ktm2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $ktm2 )
                                        {
                                            $precio = $ktm2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $ktm2 )
                                        {
                                            $valoracion = $ktm2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/ktm/85-sx-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $ktm2 )
                                {
                                    $imagenpr1 = $ktm2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $ktm2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $ktm2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm2 )
                                {
                                    $imagenpr2 = $ktm2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $ktm2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $ktm2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm2 )
                                {
                                    $imagenpr3 = $ktm2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $ktm2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $ktm2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm2 )
                                {
                                    $imagenpr4 = $ktm2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $ktm2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $ktm2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $ktm2 )
                            {
                                $descripcion = $ktm2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
