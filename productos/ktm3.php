<?php
    ...
    $datos = $doc->getElementsByTagName("ktm3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KTM 50 SX 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $ktm3 )
                    {
                        $titulo = $ktm3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $ktm3 )
                            {
                                $portada = $ktm3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $ktm3 )
                                        {
                                            $precio = $ktm3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $ktm3 )
                                        {
                                            $valoracion = $ktm3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/ktm/50-sx-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $ktm3 )
                                {
                                    $imagenpr1 = $ktm3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $ktm3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $ktm3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm3 )
                                {
                                    $imagenpr2 = $ktm3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $ktm3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $ktm3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm3 )
                                {
                                    $imagenpr3 = $ktm3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $ktm3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $ktm3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm3 )
                                {
                                    $imagenpr4 = $ktm3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $ktm3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $ktm3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $ktm3 )
                            {
                                $descripcion = $ktm3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
