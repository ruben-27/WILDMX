<?php
    ...
    $datos = $doc->getElementsByTagName("ktm4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KTM 65 SX 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $ktm4 )
                    {
                        $titulo = $ktm4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $ktm4 )
                            {
                                $portada = $ktm4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $ktm4 )
                                        {
                                            $precio = $ktm4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $ktm4 )
                                        {
                                            $valoracion = $ktm4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/ktm/65-sx-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $ktm4 )
                                {
                                    $imagenpr1 = $ktm4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $ktm4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $ktm4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm4 )
                                {
                                    $imagenpr2 = $ktm4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $ktm4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $ktm4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm4 )
                                {
                                    $imagenpr3 = $ktm4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $ktm4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $ktm4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm4 )
                                {
                                    $imagenpr4 = $ktm4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $ktm4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $ktm4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $ktm4 )
                            {
                                $descripcion = $ktm4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
