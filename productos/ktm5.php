<?php
    ...
    $datos = $doc->getElementsByTagName("ktm5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | KTM 450 SX-F 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $ktm5 )
                    {
                        $titulo = $ktm5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $ktm5 )
                            {
                                $portada = $ktm5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $ktm5 )
                                        {
                                            $precio = $ktm5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $ktm5 )
                                        {
                                            $valoracion = $ktm5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/ktm/450-sx-f-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $ktm5 )
                                {
                                    $imagenpr1 = $ktm5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $ktm5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $ktm5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm5 )
                                {
                                    $imagenpr2 = $ktm5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $ktm5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $ktm5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm5 )
                                {
                                    $imagenpr3 = $ktm5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $ktm5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $ktm5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $ktm5 )
                                {
                                    $imagenpr4 = $ktm5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $ktm5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $ktm5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $ktm5 )
                            {
                                $descripcion = $ktm5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
