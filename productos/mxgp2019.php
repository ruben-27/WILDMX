<?php
    ...
    $datos = $doc->getElementsByTagName("mxgp2019");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $mxgp2019 )
                    {
                        $titulo = $mxgp2019->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $mxgp2019 )
                            {
                                $portada = $mxgp2019->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $mxgp2019 )
                                        {
                                            $precio = $mxgp2019->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $mxgp2019 )
                                        {
                                            $valoracion = $mxgp2019->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.game.es/mxgp-2019-playstation-4-166239" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagenpr1 = $mxgp2019->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $mxgp2019->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $mxgp2019->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagenpr2 = $mxgp2019->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $mxgp2019->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $mxgp2019->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagenpr3 = $mxgp2019->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $mxgp2019->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $mxgp2019->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagenpr4 = $mxgp2019->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $mxgp2019->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $mxgp2019->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $mxgp2019 )
                            {
                                $descripcion = $mxgp2019->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagen1 = $mxgp2019->getElementsByTagName( 'imagen1' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagen2 = $mxgp2019->getElementsByTagName( 'imagen2' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagen3 = $mxgp2019->getElementsByTagName( 'imagen3' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagen4 = $mxgp2019->getElementsByTagName( 'imagen4' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxgp2019 )
                                {
                                    $imagen5 = $mxgp2019->getElementsByTagName( 'imagen5' )->item(0)->nodeValue;
