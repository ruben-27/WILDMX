<?php
    ...
    $datos = $doc->getElementsByTagName("mxvsatv");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $mxvsatv )
                    {
                        $titulo = $mxvsatv->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $mxvsatv )
                            {
                                $portada = $mxvsatv->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $mxvsatv )
                                        {
                                            $precio = $mxvsatv->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $mxvsatv )
                                        {
                                            $valoracion = $mxvsatv->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.game.es/VIDEOJUEGOS/CONDUCCION/PC/MX-VS-ATV-ALL-OUT/144683" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagenpr1 = $mxvsatv->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $mxvsatv->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $mxvsatv->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagenpr2 = $mxvsatv->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $mxvsatv->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $mxvsatv->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagenpr3 = $mxvsatv->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $mxvsatv->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $mxvsatv->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagenpr4 = $mxvsatv->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $mxvsatv->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $mxvsatv->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $mxvsatv )
                            {
                                $descripcion = $mxvsatv->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagen1 = $mxvsatv->getElementsByTagName( 'imagen1' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagen2 = $mxvsatv->getElementsByTagName( 'imagen2' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagen3 = $mxvsatv->getElementsByTagName( 'imagen3' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagen4 = $mxvsatv->getElementsByTagName( 'imagen4' )->item(0)->nodeValue;
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $mxvsatv )
                                {
                                    $imagen5 = $mxvsatv->getElementsByTagName( 'imagen5' )->item(0)->nodeValue;
