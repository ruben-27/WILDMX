<?php
    ...
    $datos = $doc->getElementsByTagName("suzuki1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SUZUKI RM-Z250 2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $suzuki1 )
                    {
                        $titulo = $suzuki1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $suzuki1 )
                            {
                                $portada = $suzuki1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $suzuki1 )
                                        {
                                            $precio = $suzuki1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $suzuki1 )
                                        {
                                            $valoracion = $suzuki1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/suzuki/rm-z-250-2019" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $suzuki1 )
                                {
                                    $imagenpr1 = $suzuki1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $suzuki1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $suzuki1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki1 )
                                {
                                    $imagenpr2 = $suzuki1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $suzuki1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $suzuki1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki1 )
                                {
                                    $imagenpr3 = $suzuki1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $suzuki1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $suzuki1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki1 )
                                {
                                    $imagenpr4 = $suzuki1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $suzuki1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $suzuki1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $suzuki1 )
                            {
                                $descripcion = $suzuki1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
