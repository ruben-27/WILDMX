<?php
    ...
    $datos = $doc->getElementsByTagName("suzuki2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SUZUKI DR-Z125 2018-2019</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $suzuki2 )
                    {
                        $titulo = $suzuki2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $suzuki2 )
                            {
                                $portada = $suzuki2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $suzuki2 )
                                        {
                                            $precio = $suzuki2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $suzuki2 )
                                        {
                                            $valoracion = $suzuki2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/suzuki/dr-z125" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $suzuki2 )
                                {
                                    $imagenpr1 = $suzuki2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $suzuki2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $suzuki2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki2 )
                                {
                                    $imagenpr2 = $suzuki2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $suzuki2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $suzuki2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki2 )
                                {
                                    $imagenpr3 = $suzuki2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $suzuki2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $suzuki2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki2 )
                                {
                                    $imagenpr4 = $suzuki2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $suzuki2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $suzuki2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $suzuki2 )
                            {
                                $descripcion = $suzuki2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
