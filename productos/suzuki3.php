<?php
    ...
    $datos = $doc->getElementsByTagName("suzuki3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SUZUKI RM-Z 250 2017</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $suzuki3 )
                    {
                        $titulo = $suzuki3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $suzuki3 )
                            {
                                $portada = $suzuki3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $suzuki3 )
                                        {
                                            $precio = $suzuki3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $suzuki3 )
                                        {
                                            $valoracion = $suzuki3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/suzuki/rm-z-250-2017" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $suzuki3 )
                                {
                                    $imagenpr1 = $suzuki3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $suzuki3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $suzuki3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki3 )
                                {
                                    $imagenpr2 = $suzuki3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $suzuki3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $suzuki3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki3 )
                                {
                                    $imagenpr3 = $suzuki3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $suzuki3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $suzuki3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki3 )
                                {
                                    $imagenpr4 = $suzuki3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $suzuki3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $suzuki3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $suzuki3 )
                            {
                                $descripcion = $suzuki3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
