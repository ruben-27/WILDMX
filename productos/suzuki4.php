<?php
    ...
    $datos = $doc->getElementsByTagName("suzuki4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SUZUKI RM-Z450 2018</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $suzuki4 )
                    {
                        $titulo = $suzuki4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $suzuki4 )
                            {
                                $portada = $suzuki4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $suzuki4 )
                                        {
                                            $precio = $suzuki4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $suzuki4 )
                                        {
                                            $valoracion = $suzuki4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/suzuki/rm-z450-2018" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $suzuki4 )
                                {
                                    $imagenpr1 = $suzuki4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $suzuki4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $suzuki4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki4 )
                                {
                                    $imagenpr2 = $suzuki4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $suzuki4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $suzuki4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki4 )
                                {
                                    $imagenpr3 = $suzuki4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $suzuki4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $suzuki4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki4 )
                                {
                                    $imagenpr4 = $suzuki4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $suzuki4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $suzuki4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $suzuki4 )
                            {
                                $descripcion = $suzuki4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
