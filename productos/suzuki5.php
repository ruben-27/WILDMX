<?php
    ...
    $datos = $doc->getElementsByTagName("suzuki5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | SUZUKI RM-Z 450 ´11</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $suzuki5 )
                    {
                        $titulo = $suzuki5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $suzuki5 )
                            {
                                $portada = $suzuki5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $suzuki5 )
                                        {
                                            $precio = $suzuki5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $suzuki5 )
                                        {
                                            $valoracion = $suzuki5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/suzuki/rm-z-450-11" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $suzuki5 )
                                {
                                    $imagenpr1 = $suzuki5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $suzuki5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $suzuki5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki5 )
                                {
                                    $imagenpr2 = $suzuki5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $suzuki5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $suzuki5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki5 )
                                {
                                    $imagenpr3 = $suzuki5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $suzuki5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $suzuki5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $suzuki5 )
                                {
                                    $imagenpr4 = $suzuki5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $suzuki5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $suzuki5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $suzuki5 )
                            {
                                $descripcion = $suzuki5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
