<?php
    ...
    $datos = $doc->getElementsByTagName("yamaha1");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | YAMAHA YZ125 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $yamaha1 )
                    {
                        $titulo = $yamaha1->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $yamaha1 )
                            {
                                $portada = $yamaha1->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $yamaha1 )
                                        {
                                            $precio = $yamaha1->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $yamaha1 )
                                        {
                                            $valoracion = $yamaha1->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/yamaha/yz125-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $yamaha1 )
                                {
                                    $imagenpr1 = $yamaha1->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $yamaha1->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $yamaha1->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha1 )
                                {
                                    $imagenpr2 = $yamaha1->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $yamaha1->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $yamaha1->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha1 )
                                {
                                    $imagenpr3 = $yamaha1->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $yamaha1->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $yamaha1->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha1 )
                                {
                                    $imagenpr4 = $yamaha1->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $yamaha1->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $yamaha1->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $yamaha1 )
                            {
                                $descripcion = $yamaha1->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
