<?php
    ...
    $datos = $doc->getElementsByTagName("yamaha2");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | YAMAHA TT-R125LW/E 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $yamaha2 )
                    {
                        $titulo = $yamaha2->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $yamaha2 )
                            {
                                $portada = $yamaha2->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $yamaha2 )
                                        {
                                            $precio = $yamaha2->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $yamaha2 )
                                        {
                                            $valoracion = $yamaha2->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/yamaha/tt-r125lw-e-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $yamaha2 )
                                {
                                    $imagenpr1 = $yamaha2->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $yamaha2->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $yamaha2->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha2 )
                                {
                                    $imagenpr2 = $yamaha2->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $yamaha2->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $yamaha2->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha2 )
                                {
                                    $imagenpr3 = $yamaha2->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $yamaha2->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $yamaha2->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha2 )
                                {
                                    $imagenpr4 = $yamaha2->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $yamaha2->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $yamaha2->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $yamaha2 )
                            {
                                $descripcion = $yamaha2->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
