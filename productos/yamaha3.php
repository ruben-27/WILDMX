<?php
    ...
    $datos = $doc->getElementsByTagName("yamaha3");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | YAMAHA PW50 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $yamaha3 )
                    {
                        $titulo = $yamaha3->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $yamaha3 )
                            {
                                $portada = $yamaha3->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $yamaha3 )
                                        {
                                            $precio = $yamaha3->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $yamaha3 )
                                        {
                                            $valoracion = $yamaha3->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/yamaha/pw50-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $yamaha3 )
                                {
                                    $imagenpr1 = $yamaha3->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $yamaha3->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $yamaha3->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha3 )
                                {
                                    $imagenpr2 = $yamaha3->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $yamaha3->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $yamaha3->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha3 )
                                {
                                    $imagenpr3 = $yamaha3->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $yamaha3->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $yamaha3->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha3 )
                                {
                                    $imagenpr4 = $yamaha3->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $yamaha3->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $yamaha3->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $yamaha3 )
                            {
                                $descripcion = $yamaha3->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
