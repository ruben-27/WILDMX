<?php
    ...
    $datos = $doc->getElementsByTagName("yamaha4");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | YAMAHA YZ85 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $yamaha4 )
                    {
                        $titulo = $yamaha4->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $yamaha4 )
                            {
                                $portada = $yamaha4->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $yamaha4 )
                                        {
                                            $precio = $yamaha4->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $yamaha4 )
                                        {
                                            $valoracion = $yamaha4->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/yamaha/yz85-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $yamaha4 )
                                {
                                    $imagenpr1 = $yamaha4->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $yamaha4->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $yamaha4->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha4 )
                                {
                                    $imagenpr2 = $yamaha4->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $yamaha4->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $yamaha4->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha4 )
                                {
                                    $imagenpr3 = $yamaha4->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $yamaha4->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $yamaha4->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha4 )
                                {
                                    $imagenpr4 = $yamaha4->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $yamaha4->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $yamaha4->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $yamaha4 )
                            {
                                $descripcion = $yamaha4->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
