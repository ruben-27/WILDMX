<?php
    ...
    $datos = $doc->getElementsByTagName("yamaha5");
?>
<!DOCTYPE>
<!--Rubén Torres-->
<html>
    ...
    <title>WILD MX® | YAMAHA YZ250 2020</title>
...
<body>
    ...
    <div id="principal">
        <table id="tabla1">
            <?php
                foreach( $datos as $yamaha5 )
                    {
                        $titulo = $yamaha5->getElementsByTagName( "titulo" )->item(0)->nodeValue;
            ...
            <tr>
                <td id="imagentabla">
                    <?php
                        foreach( $datos as $yamaha5 )
                            {
                                $portada = $yamaha5->getElementsByTagName( "portada" )->item(0)->nodeValue;
                ...
                <td>
                    <table id="subtabla">
                        ...
                        <tr>
                            <td id="precio2" class="precio">
                                <?php
                                    foreach( $datos as $yamaha5 )
                                        {
                                            $precio = $yamaha5->getElementsByTagName( "precio" )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td class="valoracion">
                                <?php
                                     foreach( $datos as $yamaha5 )
                                        {
                                            $valoracion = $yamaha5->getElementsByTagName( 'valoracion' )->item(0)->nodeValue;
                        ...
                        <tr>
                            <td id="comprar">
                                <a href="https://www.motofichas.com/marcas/yamaha/yz250-2020" target="_blank">
                                    <div>
                ...
                <tr>
                    <td>
                        <?php
                             foreach( $datos as $yamaha5 )
                                {
                                    $imagenpr1 = $yamaha5->getElementsByTagName( 'imagenpr1' )->item(0)->nodeValue;
                                    $titulo1 = $yamaha5->getElementsByTagName( 'titulo1' )->item(0)->nodeValue;
                                    $link1 = $yamaha5->getElementsByTagName( 'link1' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha5 )
                                {
                                    $imagenpr2 = $yamaha5->getElementsByTagName( 'imagenpr2' )->item(0)->nodeValue;
                                    $titulo2 = $yamaha5->getElementsByTagName( 'titulo2' )->item(0)->nodeValue;
                                    $link2 = $yamaha5->getElementsByTagName( 'link2' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha5 )
                                {
                                    $imagenpr3 = $yamaha5->getElementsByTagName( 'imagenpr3' )->item(0)->nodeValue;
                                    $titulo3 = $yamaha5->getElementsByTagName( 'titulo3' )->item(0)->nodeValue;
                                    $link3 = $yamaha5->getElementsByTagName( 'link3' )->item(0)->nodeValue;
                    ...
                    <td>
                        <?php
                             foreach( $datos as $yamaha5 )
                                {
                                    $imagenpr4 = $yamaha5->getElementsByTagName( 'imagenpr4' )->item(0)->nodeValue;
                                    $titulo4 = $yamaha5->getElementsByTagName( 'titulo4' )->item(0)->nodeValue;
                                    $link4 = $yamaha5->getElementsByTagName( 'link4' )->item(0)->nodeValue;
            ...
            <table id="tabla3">
                <tr>
                    <td>
                        ...
                        foreach( $datos as $yamaha5 )
                            {
                                $descripcion = $yamaha5->getElementsByTagName( "descripcion" )->item(0)->nodeValue;
